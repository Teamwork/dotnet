...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1currencyResponseCurrencyDeletedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// V1currencyResponseCurrencyDeletedBy class.
        /// </summary>
        public V1currencyResponseCurrencyDeletedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1currencyResponseCurrencyDeletedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
