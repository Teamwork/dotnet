...
namespace Teamwork.CRM.Models
{
    ...
    /// dealResponse
    /// </summary>
    public partial class DealsjsonCreatedResponse
    {
        /// <summary>
        /// Initializes a new instance of the DealsjsonCreatedResponse class.
        /// </summary>
        public DealsjsonCreatedResponse()
        {
            CustomInit();
        }
        ...
        public DealsjsonCreatedResponse(DealsjsonCreatedResponseDeal deal = default(DealsjsonCreatedResponseDeal), object included = default(object))
        {
            Deal = deal;
            Included = included;
            CustomInit();
        ...
        public DealsjsonCreatedResponseDeal Deal { get; set; }
