...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class CrmcoreUserCreatedBy
    {
        /// <summary>
        /// Initializes a new instance of the CrmcoreUserCreatedBy class.
        /// </summary>
        public CrmcoreUserCreatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public CrmcoreUserCreatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
