...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1exportResponseExportUpdatedBy
    {
        /// <summary>
        /// Initializes a new instance of the V1exportResponseExportUpdatedBy
        /// class.
        /// </summary>
        public V1exportResponseExportUpdatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1exportResponseExportUpdatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
