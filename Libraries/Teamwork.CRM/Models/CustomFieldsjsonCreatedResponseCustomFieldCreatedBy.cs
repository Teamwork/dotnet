...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class CustomFieldsjsonCreatedResponseCustomFieldCreatedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// CustomFieldsjsonCreatedResponseCustomFieldCreatedBy class.
        /// </summary>
        public CustomFieldsjsonCreatedResponseCustomFieldCreatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public CustomFieldsjsonCreatedResponseCustomFieldCreatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
