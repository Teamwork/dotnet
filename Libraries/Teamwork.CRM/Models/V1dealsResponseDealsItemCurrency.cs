...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1dealsResponseDealsItemCurrency
    {
        /// <summary>
        /// Initializes a new instance of the V1dealsResponseDealsItemCurrency
        /// class.
        /// </summary>
        public V1dealsResponseDealsItemCurrency()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1dealsResponseDealsItemCurrency(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
