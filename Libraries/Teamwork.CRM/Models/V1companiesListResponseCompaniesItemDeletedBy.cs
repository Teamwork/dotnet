...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1companiesListResponseCompaniesItemDeletedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// V1companiesListResponseCompaniesItemDeletedBy class.
        /// </summary>
        public V1companiesListResponseCompaniesItemDeletedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1companiesListResponseCompaniesItemDeletedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
