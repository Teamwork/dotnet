...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1customFieldResponseCustomFieldCreatedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// V1customFieldResponseCustomFieldCreatedBy class.
        /// </summary>
        public V1customFieldResponseCustomFieldCreatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1customFieldResponseCustomFieldCreatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
