...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class CompaniesjsonOKResponseCompaniesItemCreatedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// CompaniesjsonOKResponseCompaniesItemCreatedBy class.
        /// </summary>
        public CompaniesjsonOKResponseCompaniesItemCreatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public CompaniesjsonOKResponseCompaniesItemCreatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
