...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1patchCompanyRequestCompanyCountry
    {
        /// <summary>
        /// Initializes a new instance of the
        /// V1patchCompanyRequestCompanyCountry class.
        /// </summary>
        public V1patchCompanyRequestCompanyCountry()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1patchCompanyRequestCompanyCountry(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
