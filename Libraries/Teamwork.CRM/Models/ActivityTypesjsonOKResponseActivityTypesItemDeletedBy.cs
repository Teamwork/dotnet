...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class ActivityTypesjsonOKResponseActivityTypesItemDeletedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// ActivityTypesjsonOKResponseActivityTypesItemDeletedBy class.
        /// </summary>
        public ActivityTypesjsonOKResponseActivityTypesItemDeletedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public ActivityTypesjsonOKResponseActivityTypesItemDeletedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
