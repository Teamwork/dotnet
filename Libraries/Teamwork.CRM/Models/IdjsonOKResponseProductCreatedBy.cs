...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class IdjsonOKResponseProductCreatedBy
    {
        /// <summary>
        /// Initializes a new instance of the IdjsonOKResponseProductCreatedBy
        /// class.
        /// </summary>
        public IdjsonOKResponseProductCreatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public IdjsonOKResponseProductCreatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
