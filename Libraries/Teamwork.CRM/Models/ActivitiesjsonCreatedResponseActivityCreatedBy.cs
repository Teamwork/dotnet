...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class ActivitiesjsonCreatedResponseActivityCreatedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// ActivitiesjsonCreatedResponseActivityCreatedBy class.
        /// </summary>
        public ActivitiesjsonCreatedResponseActivityCreatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public ActivitiesjsonCreatedResponseActivityCreatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
