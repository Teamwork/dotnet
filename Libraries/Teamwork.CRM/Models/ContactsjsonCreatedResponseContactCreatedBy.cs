...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class ContactsjsonCreatedResponseContactCreatedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// ContactsjsonCreatedResponseContactCreatedBy class.
        /// </summary>
        public ContactsjsonCreatedResponseContactCreatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public ContactsjsonCreatedResponseContactCreatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
