...
namespace Teamwork.CRM.Models
{
    ...
    public partial class StagesjsonForbiddenResponseErrorsItem
    {
        /// <summary>
        /// Initializes a new instance of the
        /// StagesjsonForbiddenResponseErrorsItem class.
        /// </summary>
        public StagesjsonForbiddenResponseErrorsItem()
        {
            CustomInit();
        }
        ...
        public StagesjsonForbiddenResponseErrorsItem(string code = default(string), string detail = default(string), string id = default(string), string title = default(string))
        {
            Code = code;
            Detail = detail;
            Id = id;
