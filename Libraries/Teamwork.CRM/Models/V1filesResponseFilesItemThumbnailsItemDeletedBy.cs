...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1filesResponseFilesItemThumbnailsItemDeletedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// V1filesResponseFilesItemThumbnailsItemDeletedBy class.
        /// </summary>
        public V1filesResponseFilesItemThumbnailsItemDeletedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1filesResponseFilesItemThumbnailsItemDeletedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
