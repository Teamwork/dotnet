...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1currencyResponseCurrencyUpdatedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// V1currencyResponseCurrencyUpdatedBy class.
        /// </summary>
        public V1currencyResponseCurrencyUpdatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1currencyResponseCurrencyUpdatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
