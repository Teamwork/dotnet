...
namespace Teamwork.CRM.Models
{
    ...
    public partial class IdjsonForbiddenResponseErrorsItem
    {
        /// <summary>
        /// Initializes a new instance of the IdjsonForbiddenResponseErrorsItem
        /// class.
        /// </summary>
        public IdjsonForbiddenResponseErrorsItem()
        {
            CustomInit();
        }
        ...
        public IdjsonForbiddenResponseErrorsItem(string code = default(string), string detail = default(string), string id = default(string), string title = default(string))
        {
            Code = code;
            Detail = detail;
            Id = id;
