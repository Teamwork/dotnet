...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1companyResponseCompanyOwner
    {
        /// <summary>
        /// Initializes a new instance of the V1companyResponseCompanyOwner
        /// class.
        /// </summary>
        public V1companyResponseCompanyOwner()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1companyResponseCompanyOwner(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
