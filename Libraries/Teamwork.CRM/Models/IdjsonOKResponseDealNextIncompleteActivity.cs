...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class IdjsonOKResponseDealNextIncompleteActivity
    {
        /// <summary>
        /// Initializes a new instance of the
        /// IdjsonOKResponseDealNextIncompleteActivity class.
        /// </summary>
        public IdjsonOKResponseDealNextIncompleteActivity()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public IdjsonOKResponseDealNextIncompleteActivity(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
