...
namespace Teamwork.CRM.Models
{
    ...
    /// </remarks>
    public partial class ActivityTypesjsonCreatedResponseActivityType
    {
        /// <summary>
        /// Initializes a new instance of the
        /// ActivityTypesjsonCreatedResponseActivityType class.
        /// </summary>
        public ActivityTypesjsonCreatedResponseActivityType()
        {
            CustomInit();
        }
        ...
        /// object](https://crmdev-teamwork.docs.stoplight.io/documentation/general/entity-models#relationships)
        /// which describes a relationship to another entity.</param>
        public ActivityTypesjsonCreatedResponseActivityType(System.DateTime? createdAt = default(System.DateTime?), ActivityTypesjsonCreatedResponseActivityTypeCreatedBy createdBy = default(ActivityTypesjsonCreatedResponseActivityTypeCreatedBy), System.DateTime? deletedAt = default(System.DateTime?), ActivityTypesjsonCreatedResponseActivityTypeDeletedBy deletedBy = default(ActivityTypesjsonCreatedResponseActivityTypeDeletedBy), string icon = default(string), int? id = default(int?), bool? isEnabled = default(bool?), string name = default(string), int? orderIndex = default(int?), System.DateTime? updatedAt = default(System.DateTime?), ActivityTypesjsonCreatedResponseActivityTypeUpdatedBy updatedBy = default(ActivityTypesjsonCreatedResponseActivityTypeUpdatedBy), int? updatedSourceId = default(int?))
        {
            CreatedAt = createdAt;
            CreatedBy = createdBy;
            DeletedAt = deletedAt;
        ...
        public ActivityTypesjsonCreatedResponseActivityTypeCreatedBy CreatedBy { get; set; }
        ...
        public ActivityTypesjsonCreatedResponseActivityTypeDeletedBy DeletedBy { get; set; }
        ...
        public ActivityTypesjsonCreatedResponseActivityTypeUpdatedBy UpdatedBy { get; set; }
