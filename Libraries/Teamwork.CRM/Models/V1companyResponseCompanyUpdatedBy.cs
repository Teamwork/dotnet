...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1companyResponseCompanyUpdatedBy
    {
        /// <summary>
        /// Initializes a new instance of the V1companyResponseCompanyUpdatedBy
        /// class.
        /// </summary>
        public V1companyResponseCompanyUpdatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1companyResponseCompanyUpdatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
