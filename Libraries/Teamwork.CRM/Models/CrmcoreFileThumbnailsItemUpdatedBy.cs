...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class CrmcoreFileThumbnailsItemUpdatedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// CrmcoreFileThumbnailsItemUpdatedBy class.
        /// </summary>
        public CrmcoreFileThumbnailsItemUpdatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public CrmcoreFileThumbnailsItemUpdatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
