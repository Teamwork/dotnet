...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class IdjsonOKResponseCompanyAvatar
    {
        /// <summary>
        /// Initializes a new instance of the IdjsonOKResponseCompanyAvatar
        /// class.
        /// </summary>
        public IdjsonOKResponseCompanyAvatar()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public IdjsonOKResponseCompanyAvatar(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
