...
namespace Teamwork.CRM.Models
{
    ...
    public partial class ActivitiesjsonNotFoundResponseErrorsItem
    {
        /// <summary>
        /// Initializes a new instance of the
        /// ActivitiesjsonNotFoundResponseErrorsItem class.
        /// </summary>
        public ActivitiesjsonNotFoundResponseErrorsItem()
        {
            CustomInit();
        }
        ...
        public ActivitiesjsonNotFoundResponseErrorsItem(string code = default(string), string detail = default(string), string id = default(string), string title = default(string))
        {
            Code = code;
            Detail = detail;
            Id = id;
