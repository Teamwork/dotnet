...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class CrmcoreFileDeletedBy
    {
        /// <summary>
        /// Initializes a new instance of the CrmcoreFileDeletedBy class.
        /// </summary>
        public CrmcoreFileDeletedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public CrmcoreFileDeletedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
