...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class IdjsonOKResponseContactUpdatedBy
    {
        /// <summary>
        /// Initializes a new instance of the IdjsonOKResponseContactUpdatedBy
        /// class.
        /// </summary>
        public IdjsonOKResponseContactUpdatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public IdjsonOKResponseContactUpdatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
