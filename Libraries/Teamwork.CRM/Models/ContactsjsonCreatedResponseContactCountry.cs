...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class ContactsjsonCreatedResponseContactCountry
    {
        /// <summary>
        /// Initializes a new instance of the
        /// ContactsjsonCreatedResponseContactCountry class.
        /// </summary>
        public ContactsjsonCreatedResponseContactCountry()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public ContactsjsonCreatedResponseContactCountry(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
