...
namespace Teamwork.CRM.Models
{
    ...
    public partial class CrmcoreProductPricesItemMeta
    {
        /// <summary>
        /// Initializes a new instance of the CrmcoreProductPricesItemMeta
        /// class.
        /// </summary>
        public CrmcoreProductPricesItemMeta()
        {
            CustomInit();
        }
        ...
        /// cents.</param>
        public CrmcoreProductPricesItemMeta(int price)
        {
            Price = price;
            CustomInit();
        }
