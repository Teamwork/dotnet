...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class DealsjsonOKResponseDealsItemCompany
    {
        /// <summary>
        /// Initializes a new instance of the
        /// DealsjsonOKResponseDealsItemCompany class.
        /// </summary>
        public DealsjsonOKResponseDealsItemCompany()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public DealsjsonOKResponseDealsItemCompany(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
