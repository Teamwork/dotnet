...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class CompaniesjsonCreatedResponseCompanyCustomItemDeletedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// CompaniesjsonCreatedResponseCompanyCustomItemDeletedBy class.
        /// </summary>
        public CompaniesjsonCreatedResponseCompanyCustomItemDeletedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public CompaniesjsonCreatedResponseCompanyCustomItemDeletedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
