...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1companiesResponseCompaniesItemAvatar
    {
        /// <summary>
        /// Initializes a new instance of the
        /// V1companiesResponseCompaniesItemAvatar class.
        /// </summary>
        public V1companiesResponseCompaniesItemAvatar()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1companiesResponseCompaniesItemAvatar(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
