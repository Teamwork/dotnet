...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class CrmcoreContactCountry
    {
        /// <summary>
        /// Initializes a new instance of the CrmcoreContactCountry class.
        /// </summary>
        public CrmcoreContactCountry()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public CrmcoreContactCountry(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
