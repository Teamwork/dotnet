...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1contactsListResponseContactsItemOwner
    {
        /// <summary>
        /// Initializes a new instance of the
        /// V1contactsListResponseContactsItemOwner class.
        /// </summary>
        public V1contactsListResponseContactsItemOwner()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1contactsListResponseContactsItemOwner(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
