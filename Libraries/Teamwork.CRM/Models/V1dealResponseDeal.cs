...
namespace Teamwork.CRM.Models
{
    ...
    /// </remarks>
    public partial class V1dealResponseDeal
    {
        /// <summary>
        /// Initializes a new instance of the V1dealResponseDeal class.
        /// </summary>
        public V1dealResponseDeal()
        {
            CustomInit();
        }
        ...
        /// object](https://crmdev-teamwork.docs.stoplight.io/documentation/general/entity-models#relationships)
        /// which describes a relationship to another entity.</param>
        public V1dealResponseDeal(System.DateTime? closedAt = default(System.DateTime?), V1dealResponseDealCompany company = default(V1dealResponseDealCompany), IList<V1dealResponseDealContactsItem> contacts = default(IList<V1dealResponseDealContactsItem>), int? contactsCount = default(int?), System.DateTime? createdAt = default(System.DateTime?), V1dealResponseDealCreatedBy createdBy = default(V1dealResponseDealCreatedBy), V1dealResponseDealCurrency currency = default(V1dealResponseDealCurrency), object custom = default(object), int? customValue = default(int?), System.DateTime? deletedAt = default(System.DateTime?), V1dealResponseDealDeletedBy deletedBy = default(V1dealResponseDealDeletedBy), System.DateTime? expectedCloseDate = default(System.DateTime?), int? id = default(int?), bool? isQualified = default(bool?), V1dealResponseDealLostReason lostReason = default(V1dealResponseDealLostReason), V1dealResponseDealNextIncompleteActivity nextIncompleteActivity = default(V1dealResponseDealNextIncompleteActivity), V1dealResponseDealOwner owner = default(V1dealResponseDealOwner), IList<V1dealResponseDealProductsItem> products = default(IList<V1dealResponseDealProductsItem>), System.DateTime? qualifiedAt = default(System.DateTime?), V1dealResponseDealQualifiedBy qualifiedBy = default(V1dealResponseDealQualifiedBy), V1dealResponseDealStage stage = default(V1dealResponseDealStage), string state = default(string), object teamworkProjects = default(object), string title = default(string), int? totalValue = default(int?), System.DateTime? updatedAt = default(System.DateTime?), V1dealResponseDealUpdatedBy updatedBy = default(V1dealResponseDealUpdatedBy), int? updatedSourceId = default(int?))
        {
            ClosedAt = closedAt;
            Company = company;
            Contacts = contacts;
        ...
        public V1dealResponseDealCompany Company { get; set; }
        ...
        public IList<V1dealResponseDealContactsItem> Contacts { get; set; }
        ...
        public V1dealResponseDealCreatedBy CreatedBy { get; set; }
        ...
        public V1dealResponseDealCurrency Currency { get; set; }
        ...
        public V1dealResponseDealDeletedBy DeletedBy { get; set; }
        ...
        public V1dealResponseDealLostReason LostReason { get; set; }
        ...
        public V1dealResponseDealNextIncompleteActivity NextIncompleteActivity { get; set; }
        ...
        public V1dealResponseDealOwner Owner { get; set; }
        ...
        public IList<V1dealResponseDealProductsItem> Products { get; set; }
        ...
        public V1dealResponseDealQualifiedBy QualifiedBy { get; set; }
        ...
        public V1dealResponseDealStage Stage { get; set; }
        ...
        public V1dealResponseDealUpdatedBy UpdatedBy { get; set; }
