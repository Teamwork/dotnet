...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class StagesjsonCreatedResponseStagePipeline
    {
        /// <summary>
        /// Initializes a new instance of the
        /// StagesjsonCreatedResponseStagePipeline class.
        /// </summary>
        public StagesjsonCreatedResponseStagePipeline()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public StagesjsonCreatedResponseStagePipeline(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
