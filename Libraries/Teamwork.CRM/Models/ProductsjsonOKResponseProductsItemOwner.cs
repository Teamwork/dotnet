...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class ProductsjsonOKResponseProductsItemOwner
    {
        /// <summary>
        /// Initializes a new instance of the
        /// ProductsjsonOKResponseProductsItemOwner class.
        /// </summary>
        public ProductsjsonOKResponseProductsItemOwner()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public ProductsjsonOKResponseProductsItemOwner(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
