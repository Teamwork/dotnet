...
namespace Teamwork.CRM.Models
{
    ...
    public partial class IdjsonOKResponseContactPhoneNumbers
    {
        /// <summary>
        /// Initializes a new instance of the
        /// IdjsonOKResponseContactPhoneNumbers class.
        /// </summary>
        public IdjsonOKResponseContactPhoneNumbers()
        {
            CustomInit();
        }
        ...
        public IdjsonOKResponseContactPhoneNumbers(IdjsonOKResponseContactPhoneNumbersCode code = default(IdjsonOKResponseContactPhoneNumbersCode), string number = default(string))
        {
            Code = code;
            Number = number;
            CustomInit();
        ...
        public IdjsonOKResponseContactPhoneNumbersCode Code { get; set; }
