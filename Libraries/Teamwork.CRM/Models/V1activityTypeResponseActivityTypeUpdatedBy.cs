...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1activityTypeResponseActivityTypeUpdatedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// V1activityTypeResponseActivityTypeUpdatedBy class.
        /// </summary>
        public V1activityTypeResponseActivityTypeUpdatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1activityTypeResponseActivityTypeUpdatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
