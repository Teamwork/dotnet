...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class CustomFieldsjsonCreatedResponseCustomFieldDeletedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// CustomFieldsjsonCreatedResponseCustomFieldDeletedBy class.
        /// </summary>
        public CustomFieldsjsonCreatedResponseCustomFieldDeletedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public CustomFieldsjsonCreatedResponseCustomFieldDeletedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
