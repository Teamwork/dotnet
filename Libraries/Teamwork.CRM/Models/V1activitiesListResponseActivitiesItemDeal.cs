...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1activitiesListResponseActivitiesItemDeal
    {
        /// <summary>
        /// Initializes a new instance of the
        /// V1activitiesListResponseActivitiesItemDeal class.
        /// </summary>
        public V1activitiesListResponseActivitiesItemDeal()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1activitiesListResponseActivitiesItemDeal(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
