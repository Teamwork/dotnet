...
namespace Teamwork.CRM.Models
{
    ...
    /// </remarks>
    public partial class V1activityTypeResponseActivityType
    {
        /// <summary>
        /// Initializes a new instance of the
        /// V1activityTypeResponseActivityType class.
        /// </summary>
        public V1activityTypeResponseActivityType()
        {
            CustomInit();
        }
        ...
        /// object](https://crmdev-teamwork.docs.stoplight.io/documentation/general/entity-models#relationships)
        /// which describes a relationship to another entity.</param>
        public V1activityTypeResponseActivityType(System.DateTime? createdAt = default(System.DateTime?), V1activityTypeResponseActivityTypeCreatedBy createdBy = default(V1activityTypeResponseActivityTypeCreatedBy), System.DateTime? deletedAt = default(System.DateTime?), V1activityTypeResponseActivityTypeDeletedBy deletedBy = default(V1activityTypeResponseActivityTypeDeletedBy), string icon = default(string), int? id = default(int?), bool? isEnabled = default(bool?), string name = default(string), int? orderIndex = default(int?), System.DateTime? updatedAt = default(System.DateTime?), V1activityTypeResponseActivityTypeUpdatedBy updatedBy = default(V1activityTypeResponseActivityTypeUpdatedBy), int? updatedSourceId = default(int?))
        {
            CreatedAt = createdAt;
            CreatedBy = createdBy;
            DeletedAt = deletedAt;
        ...
        public V1activityTypeResponseActivityTypeCreatedBy CreatedBy { get; set; }
        ...
        public V1activityTypeResponseActivityTypeDeletedBy DeletedBy { get; set; }
        ...
        public V1activityTypeResponseActivityTypeUpdatedBy UpdatedBy { get; set; }
