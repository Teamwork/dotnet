...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class CompaniesjsonCreatedResponseCompanyCustomItemUpdatedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// CompaniesjsonCreatedResponseCompanyCustomItemUpdatedBy class.
        /// </summary>
        public CompaniesjsonCreatedResponseCompanyCustomItemUpdatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public CompaniesjsonCreatedResponseCompanyCustomItemUpdatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
