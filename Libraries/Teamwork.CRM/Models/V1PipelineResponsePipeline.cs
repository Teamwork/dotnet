...
namespace Teamwork.CRM.Models
{
    ...
    /// </remarks>
    public partial class V1PipelineResponsePipeline
    {
        /// <summary>
        /// Initializes a new instance of the V1PipelineResponsePipeline class.
        /// </summary>
        public V1PipelineResponsePipeline()
        {
            CustomInit();
        }
        ...
        /// object](https://crmdev-teamwork.docs.stoplight.io/documentation/general/entity-models#relationships)
        /// which describes a relationship to another entity.</param>
        public V1PipelineResponsePipeline(System.DateTime? createdAt = default(System.DateTime?), V1PipelineResponsePipelineCreatedBy createdBy = default(V1PipelineResponsePipelineCreatedBy), System.DateTime? deletedAt = default(System.DateTime?), V1PipelineResponsePipelineDeletedBy deletedBy = default(V1PipelineResponsePipelineDeletedBy), int? id = default(int?), bool? isQualified = default(bool?), string name = default(string), int? orderIndex = default(int?), IList<V1PipelineResponsePipelineStagesItem> stages = default(IList<V1PipelineResponsePipelineStagesItem>), int? stagesCount = default(int?), double? totalValue = default(double?), System.DateTime? updatedAt = default(System.DateTime?), V1PipelineResponsePipelineUpdatedBy updatedBy = default(V1PipelineResponsePipelineUpdatedBy), int? updatedSourceId = default(int?))
        {
            CreatedAt = createdAt;
            CreatedBy = createdBy;
            DeletedAt = deletedAt;
        ...
        public V1PipelineResponsePipelineCreatedBy CreatedBy { get; set; }
        ...
        public V1PipelineResponsePipelineDeletedBy DeletedBy { get; set; }
        ...
        public IList<V1PipelineResponsePipelineStagesItem> Stages { get; set; }
        ...
        public V1PipelineResponsePipelineUpdatedBy UpdatedBy { get; set; }
