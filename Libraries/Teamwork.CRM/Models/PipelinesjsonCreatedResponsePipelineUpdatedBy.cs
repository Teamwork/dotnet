...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class PipelinesjsonCreatedResponsePipelineUpdatedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// PipelinesjsonCreatedResponsePipelineUpdatedBy class.
        /// </summary>
        public PipelinesjsonCreatedResponsePipelineUpdatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public PipelinesjsonCreatedResponsePipelineUpdatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
