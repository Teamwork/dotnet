...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1companyResponseCompanyCustomItemUpdatedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// V1companyResponseCompanyCustomItemUpdatedBy class.
        /// </summary>
        public V1companyResponseCompanyCustomItemUpdatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1companyResponseCompanyCustomItemUpdatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
