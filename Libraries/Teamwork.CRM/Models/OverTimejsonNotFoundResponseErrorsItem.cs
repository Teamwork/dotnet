...
namespace Teamwork.CRM.Models
{
    ...
    public partial class OverTimejsonNotFoundResponseErrorsItem
    {
        /// <summary>
        /// Initializes a new instance of the
        /// OverTimejsonNotFoundResponseErrorsItem class.
        /// </summary>
        public OverTimejsonNotFoundResponseErrorsItem()
        {
            CustomInit();
        }
        ...
        public OverTimejsonNotFoundResponseErrorsItem(string code = default(string), string detail = default(string), string id = default(string), string title = default(string))
        {
            Code = code;
            Detail = detail;
            Id = id;
