...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class CrmcoreLostReasonCreatedBy
    {
        /// <summary>
        /// Initializes a new instance of the CrmcoreLostReasonCreatedBy class.
        /// </summary>
        public CrmcoreLostReasonCreatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public CrmcoreLostReasonCreatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
