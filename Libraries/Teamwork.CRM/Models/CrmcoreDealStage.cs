...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class CrmcoreDealStage
    {
        /// <summary>
        /// Initializes a new instance of the CrmcoreDealStage class.
        /// </summary>
        public CrmcoreDealStage()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public CrmcoreDealStage(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
