...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class IdjsonOKResponseContactCompany
    {
        /// <summary>
        /// Initializes a new instance of the IdjsonOKResponseContactCompany
        /// class.
        /// </summary>
        public IdjsonOKResponseContactCompany()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public IdjsonOKResponseContactCompany(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
