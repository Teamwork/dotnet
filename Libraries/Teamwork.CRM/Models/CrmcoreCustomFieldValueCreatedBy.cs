...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class CrmcoreCustomFieldValueCreatedBy
    {
        /// <summary>
        /// Initializes a new instance of the CrmcoreCustomFieldValueCreatedBy
        /// class.
        /// </summary>
        public CrmcoreCustomFieldValueCreatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public CrmcoreCustomFieldValueCreatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
