...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class CrmcoreCompanyOwner
    {
        /// <summary>
        /// Initializes a new instance of the CrmcoreCompanyOwner class.
        /// </summary>
        public CrmcoreCompanyOwner()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public CrmcoreCompanyOwner(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
