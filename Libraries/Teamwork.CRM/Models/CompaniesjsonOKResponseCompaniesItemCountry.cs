...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class CompaniesjsonOKResponseCompaniesItemCountry
    {
        /// <summary>
        /// Initializes a new instance of the
        /// CompaniesjsonOKResponseCompaniesItemCountry class.
        /// </summary>
        public CompaniesjsonOKResponseCompaniesItemCountry()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public CompaniesjsonOKResponseCompaniesItemCountry(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
