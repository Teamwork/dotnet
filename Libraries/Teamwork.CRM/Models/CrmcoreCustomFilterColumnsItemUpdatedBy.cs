...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class CrmcoreCustomFilterColumnsItemUpdatedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// CrmcoreCustomFilterColumnsItemUpdatedBy class.
        /// </summary>
        public CrmcoreCustomFilterColumnsItemUpdatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public CrmcoreCustomFilterColumnsItemUpdatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
