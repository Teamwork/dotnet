...
namespace Teamwork.CRM.Models
{
    ...
    public partial class LostReasonsjsonNotFoundResponseErrorsItem
    {
        /// <summary>
        /// Initializes a new instance of the
        /// LostReasonsjsonNotFoundResponseErrorsItem class.
        /// </summary>
        public LostReasonsjsonNotFoundResponseErrorsItem()
        {
            CustomInit();
        }
        ...
        public LostReasonsjsonNotFoundResponseErrorsItem(string code = default(string), string detail = default(string), string id = default(string), string title = default(string))
        {
            Code = code;
            Detail = detail;
            Id = id;
