...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1customFieldsResponseCustomFieldsItemDeletedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// V1customFieldsResponseCustomFieldsItemDeletedBy class.
        /// </summary>
        public V1customFieldsResponseCustomFieldsItemDeletedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1customFieldsResponseCustomFieldsItemDeletedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
