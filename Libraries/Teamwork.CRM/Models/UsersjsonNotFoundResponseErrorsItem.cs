...
namespace Teamwork.CRM.Models
{
    ...
    public partial class UsersjsonNotFoundResponseErrorsItem
    {
        /// <summary>
        /// Initializes a new instance of the
        /// UsersjsonNotFoundResponseErrorsItem class.
        /// </summary>
        public UsersjsonNotFoundResponseErrorsItem()
        {
            CustomInit();
        }
        ...
        public UsersjsonNotFoundResponseErrorsItem(string code = default(string), string detail = default(string), string id = default(string), string title = default(string))
        {
            Code = code;
            Detail = detail;
            Id = id;
