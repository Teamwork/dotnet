...
namespace Teamwork.CRM.Models
{
    ...
    public partial class OpportunitiesWonjsonNotFoundResponseErrorsItem
    {
        /// <summary>
        /// Initializes a new instance of the
        /// OpportunitiesWonjsonNotFoundResponseErrorsItem class.
        /// </summary>
        public OpportunitiesWonjsonNotFoundResponseErrorsItem()
        {
            CustomInit();
        }
        ...
        public OpportunitiesWonjsonNotFoundResponseErrorsItem(string code = default(string), string detail = default(string), string id = default(string), string title = default(string))
        {
            Code = code;
            Detail = detail;
            Id = id;
