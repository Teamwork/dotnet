...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1exportsResponseExportsItemUpdatedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// V1exportsResponseExportsItemUpdatedBy class.
        /// </summary>
        public V1exportsResponseExportsItemUpdatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1exportsResponseExportsItemUpdatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
