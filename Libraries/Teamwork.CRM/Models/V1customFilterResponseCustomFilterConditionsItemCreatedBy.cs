...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1customFilterResponseCustomFilterConditionsItemCreatedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// V1customFilterResponseCustomFilterConditionsItemCreatedBy class.
        /// </summary>
        public V1customFilterResponseCustomFilterConditionsItemCreatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1customFilterResponseCustomFilterConditionsItemCreatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
