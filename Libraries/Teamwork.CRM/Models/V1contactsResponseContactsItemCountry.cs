...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1contactsResponseContactsItemCountry
    {
        /// <summary>
        /// Initializes a new instance of the
        /// V1contactsResponseContactsItemCountry class.
        /// </summary>
        public V1contactsResponseContactsItemCountry()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1contactsResponseContactsItemCountry(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
