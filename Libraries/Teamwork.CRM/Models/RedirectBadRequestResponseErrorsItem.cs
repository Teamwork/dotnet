...
namespace Teamwork.CRM.Models
{
    ...
    public partial class RedirectBadRequestResponseErrorsItem
    {
        /// <summary>
        /// Initializes a new instance of the
        /// RedirectBadRequestResponseErrorsItem class.
        /// </summary>
        public RedirectBadRequestResponseErrorsItem()
        {
            CustomInit();
        }
        ...
        public RedirectBadRequestResponseErrorsItem(string code = default(string), string detail = default(string), string id = default(string), string title = default(string))
        {
            Code = code;
            Detail = detail;
            Id = id;
