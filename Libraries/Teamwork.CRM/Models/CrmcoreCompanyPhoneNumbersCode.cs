...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class CrmcoreCompanyPhoneNumbersCode
    {
        /// <summary>
        /// Initializes a new instance of the CrmcoreCompanyPhoneNumbersCode
        /// class.
        /// </summary>
        public CrmcoreCompanyPhoneNumbersCode()
        {
            CustomInit();
        }
        ...
        public CrmcoreCompanyPhoneNumbersCode(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
