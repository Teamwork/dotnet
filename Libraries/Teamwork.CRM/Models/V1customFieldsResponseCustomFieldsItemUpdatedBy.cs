...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1customFieldsResponseCustomFieldsItemUpdatedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// V1customFieldsResponseCustomFieldsItemUpdatedBy class.
        /// </summary>
        public V1customFieldsResponseCustomFieldsItemUpdatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1customFieldsResponseCustomFieldsItemUpdatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
