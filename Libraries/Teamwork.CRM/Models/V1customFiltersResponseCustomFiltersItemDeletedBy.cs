...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1customFiltersResponseCustomFiltersItemDeletedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// V1customFiltersResponseCustomFiltersItemDeletedBy class.
        /// </summary>
        public V1customFiltersResponseCustomFiltersItemDeletedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1customFiltersResponseCustomFiltersItemDeletedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
