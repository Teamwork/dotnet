...
namespace Teamwork.CRM.Models
{
    ...
    public partial class DownloadUnauthorizedResponseErrorsItem
    {
        /// <summary>
        /// Initializes a new instance of the
        /// DownloadUnauthorizedResponseErrorsItem class.
        /// </summary>
        public DownloadUnauthorizedResponseErrorsItem()
        {
            CustomInit();
        }
        ...
        public DownloadUnauthorizedResponseErrorsItem(string code = default(string), string detail = default(string), string id = default(string), string title = default(string))
        {
            Code = code;
            Detail = detail;
            Id = id;
