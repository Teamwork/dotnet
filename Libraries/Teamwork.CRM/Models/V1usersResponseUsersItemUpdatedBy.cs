...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1usersResponseUsersItemUpdatedBy
    {
        /// <summary>
        /// Initializes a new instance of the V1usersResponseUsersItemUpdatedBy
        /// class.
        /// </summary>
        public V1usersResponseUsersItemUpdatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1usersResponseUsersItemUpdatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
