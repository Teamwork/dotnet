...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1companiesResponseCompaniesItemUpdatedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// V1companiesResponseCompaniesItemUpdatedBy class.
        /// </summary>
        public V1companiesResponseCompaniesItemUpdatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1companiesResponseCompaniesItemUpdatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
