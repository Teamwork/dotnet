...
namespace Teamwork.CRM.Models
{
    ...
    /// </remarks>
    public partial class CrmcoreActivity
    {
        /// <summary>
        /// Initializes a new instance of the CrmcoreActivity class.
        /// </summary>
        public CrmcoreActivity()
        {
            CustomInit();
        }
        ...
        /// object](https://crmdev-teamwork.docs.stoplight.io/documentation/general/entity-models#relationships)
        /// which describes a relationship to another entity.</param>
        public CrmcoreActivity(CrmcoreActivityActivityType activityType = default(CrmcoreActivityActivityType), IList<CrmcoreActivityAssigneesItem> assignees = default(IList<CrmcoreActivityAssigneesItem>), int? assigneesCount = default(int?), System.DateTime? completedAt = default(System.DateTime?), CrmcoreActivityCompletedByUser completedByUser = default(CrmcoreActivityCompletedByUser), IList<CrmcoreActivityContactsItem> contacts = default(IList<CrmcoreActivityContactsItem>), int? contactsCount = default(int?), System.DateTime? createdAt = default(System.DateTime?), CrmcoreActivityCreatedBy createdBy = default(CrmcoreActivityCreatedBy), object custom = default(object), CrmcoreActivityDeal deal = default(CrmcoreActivityDeal), System.DateTime? deletedAt = default(System.DateTime?), CrmcoreActivityDeletedBy deletedBy = default(CrmcoreActivityDeletedBy), string description = default(string), System.DateTime? dueDate = default(System.DateTime?), int? duration = default(int?), int? id = default(int?), bool? isComplete = default(bool?), System.DateTime? startDate = default(System.DateTime?), string title = default(string), System.DateTime? updatedAt = default(System.DateTime?), CrmcoreActivityUpdatedBy updatedBy = default(CrmcoreActivityUpdatedBy), int? updatedSourceId = default(int?))
        {
        ...
        public CrmcoreActivityActivityType ActivityType { get; set; }
        ...
        public IList<CrmcoreActivityAssigneesItem> Assignees { get; set; }
        ...
        public CrmcoreActivityCompletedByUser CompletedByUser { get; set; }
        ...
        public IList<CrmcoreActivityContactsItem> Contacts { get; set; }
        ...
        public CrmcoreActivityCreatedBy CreatedBy { get; set; }
        ...
        public CrmcoreActivityDeal Deal { get; set; }
        ...
        public CrmcoreActivityDeletedBy DeletedBy { get; set; }
        ...
        public CrmcoreActivityUpdatedBy UpdatedBy { get; set; }
