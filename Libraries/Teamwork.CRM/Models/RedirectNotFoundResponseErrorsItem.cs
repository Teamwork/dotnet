...
namespace Teamwork.CRM.Models
{
    ...
    public partial class RedirectNotFoundResponseErrorsItem
    {
        /// <summary>
        /// Initializes a new instance of the
        /// RedirectNotFoundResponseErrorsItem class.
        /// </summary>
        public RedirectNotFoundResponseErrorsItem()
        {
            CustomInit();
        }
        ...
        public RedirectNotFoundResponseErrorsItem(string code = default(string), string detail = default(string), string id = default(string), string title = default(string))
        {
            Code = code;
            Detail = detail;
            Id = id;
