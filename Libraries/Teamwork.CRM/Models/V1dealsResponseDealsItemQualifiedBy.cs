...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1dealsResponseDealsItemQualifiedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// V1dealsResponseDealsItemQualifiedBy class.
        /// </summary>
        public V1dealsResponseDealsItemQualifiedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1dealsResponseDealsItemQualifiedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
