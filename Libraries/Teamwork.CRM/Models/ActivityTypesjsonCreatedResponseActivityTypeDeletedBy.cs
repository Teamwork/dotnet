...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class ActivityTypesjsonCreatedResponseActivityTypeDeletedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// ActivityTypesjsonCreatedResponseActivityTypeDeletedBy class.
        /// </summary>
        public ActivityTypesjsonCreatedResponseActivityTypeDeletedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public ActivityTypesjsonCreatedResponseActivityTypeDeletedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
