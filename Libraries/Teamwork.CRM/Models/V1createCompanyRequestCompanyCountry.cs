...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1createCompanyRequestCompanyCountry
    {
        /// <summary>
        /// Initializes a new instance of the
        /// V1createCompanyRequestCompanyCountry class.
        /// </summary>
        public V1createCompanyRequestCompanyCountry()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1createCompanyRequestCompanyCountry(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
