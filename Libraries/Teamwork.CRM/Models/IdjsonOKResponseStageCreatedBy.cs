...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class IdjsonOKResponseStageCreatedBy
    {
        /// <summary>
        /// Initializes a new instance of the IdjsonOKResponseStageCreatedBy
        /// class.
        /// </summary>
        public IdjsonOKResponseStageCreatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public IdjsonOKResponseStageCreatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
