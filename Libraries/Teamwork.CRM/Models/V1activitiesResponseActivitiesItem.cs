...
namespace Teamwork.CRM.Models
{
    ...
    /// </remarks>
    public partial class V1activitiesResponseActivitiesItem
    {
        /// <summary>
        /// Initializes a new instance of the
        /// V1activitiesResponseActivitiesItem class.
        /// </summary>
        public V1activitiesResponseActivitiesItem()
        {
            CustomInit();
        }
        ...
        /// object](https://crmdev-teamwork.docs.stoplight.io/documentation/general/entity-models#relationships)
        /// which describes a relationship to another entity.</param>
        public V1activitiesResponseActivitiesItem(V1activitiesResponseActivitiesItemActivityType activityType = default(V1activitiesResponseActivitiesItemActivityType), IList<V1activitiesResponseActivitiesItemAssigneesItem> assignees = default(IList<V1activitiesResponseActivitiesItemAssigneesItem>), int? assigneesCount = default(int?), System.DateTime? completedAt = default(System.DateTime?), V1activitiesResponseActivitiesItemCompletedByUser completedByUser = default(V1activitiesResponseActivitiesItemCompletedByUser), IList<V1activitiesResponseActivitiesItemContactsItem> contacts = default(IList<V1activitiesResponseActivitiesItemContactsItem>), int? contactsCount = default(int?), System.DateTime? createdAt = default(System.DateTime?), V1activitiesResponseActivitiesItemCreatedBy createdBy = default(V1activitiesResponseActivitiesItemCreatedBy), object custom = default(object), V1activitiesResponseActivitiesItemDeal deal = default(V1activitiesResponseActivitiesItemDeal), System.DateTime? deletedAt = default(System.DateTime?), V1activitiesResponseActivitiesItemDeletedBy deletedBy = default(V1activitiesResponseActivitiesItemDeletedBy), string description = default(string), System.DateTime? dueDate = default(System.DateTime?), int? duration = default(int?), int? id = default(int?), bool? isComplete = default(bool?), System.DateTime? startDate = default(System.DateTime?), string title = default(string), System.DateTime? updatedAt = default(System.DateTime?), V1activitiesResponseActivitiesItemUpdatedBy updatedBy = default(V1activitiesResponseActivitiesItemUpdatedBy), int? updatedSourceId = default(int?))
        {
        ...
        public V1activitiesResponseActivitiesItemActivityType ActivityType { get; set; }
        ...
        public IList<V1activitiesResponseActivitiesItemAssigneesItem> Assignees { get; set; }
        ...
        public V1activitiesResponseActivitiesItemCompletedByUser CompletedByUser { get; set; }
        ...
        public IList<V1activitiesResponseActivitiesItemContactsItem> Contacts { get; set; }
        ...
        public V1activitiesResponseActivitiesItemCreatedBy CreatedBy { get; set; }
        ...
        public V1activitiesResponseActivitiesItemDeal Deal { get; set; }
        ...
        public V1activitiesResponseActivitiesItemDeletedBy DeletedBy { get; set; }
        ...
        public V1activitiesResponseActivitiesItemUpdatedBy UpdatedBy { get; set; }
