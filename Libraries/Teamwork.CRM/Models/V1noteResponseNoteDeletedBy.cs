...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1noteResponseNoteDeletedBy
    {
        /// <summary>
        /// Initializes a new instance of the V1noteResponseNoteDeletedBy
        /// class.
        /// </summary>
        public V1noteResponseNoteDeletedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1noteResponseNoteDeletedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
