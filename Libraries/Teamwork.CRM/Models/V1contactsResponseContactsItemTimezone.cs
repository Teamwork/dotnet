...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1contactsResponseContactsItemTimezone
    {
        /// <summary>
        /// Initializes a new instance of the
        /// V1contactsResponseContactsItemTimezone class.
        /// </summary>
        public V1contactsResponseContactsItemTimezone()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1contactsResponseContactsItemTimezone(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
