...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class ExportsjsonOKResponseExportsItemUpdatedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// ExportsjsonOKResponseExportsItemUpdatedBy class.
        /// </summary>
        public ExportsjsonOKResponseExportsItemUpdatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public ExportsjsonOKResponseExportsItemUpdatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
