...
namespace Teamwork.CRM.Models
{
    ...
    /// </remarks>
    public partial class V1dealsListResponseDealsItem
    {
        /// <summary>
        /// Initializes a new instance of the V1dealsListResponseDealsItem
        /// class.
        /// </summary>
        public V1dealsListResponseDealsItem()
        {
            CustomInit();
        }
        ...
        /// object](https://crmdev-teamwork.docs.stoplight.io/documentation/general/entity-models#relationships)
        /// which describes a relationship to another entity.</param>
        public V1dealsListResponseDealsItem(System.DateTime? closedAt = default(System.DateTime?), V1dealsListResponseDealsItemCompany company = default(V1dealsListResponseDealsItemCompany), IList<V1dealsListResponseDealsItemContactsItem> contacts = default(IList<V1dealsListResponseDealsItemContactsItem>), int? contactsCount = default(int?), System.DateTime? createdAt = default(System.DateTime?), V1dealsListResponseDealsItemCreatedBy createdBy = default(V1dealsListResponseDealsItemCreatedBy), V1dealsListResponseDealsItemCurrency currency = default(V1dealsListResponseDealsItemCurrency), object custom = default(object), int? customValue = default(int?), System.DateTime? deletedAt = default(System.DateTime?), V1dealsListResponseDealsItemDeletedBy deletedBy = default(V1dealsListResponseDealsItemDeletedBy), System.DateTime? expectedCloseDate = default(System.DateTime?), int? id = default(int?), bool? isQualified = default(bool?), V1dealsListResponseDealsItemLostReason lostReason = default(V1dealsListResponseDealsItemLostReason), V1dealsListResponseDealsItemNextIncompleteActivity nextIncompleteActivity = default(V1dealsListResponseDealsItemNextIncompleteActivity), V1dealsListResponseDealsItemOwner owner = default(V1dealsListResponseDealsItemOwner), IList<V1dealsListResponseDealsItemProductsItem> products = default(IList<V1dealsListResponseDealsItemProductsItem>), System.DateTime? qualifiedAt = default(System.DateTime?), V1dealsListResponseDealsItemQualifiedBy qualifiedBy = default(V1dealsListResponseDealsItemQualifiedBy), V1dealsListResponseDealsItemStage stage = default(V1dealsListResponseDealsItemStage), string state = default(string), object teamworkProjects = default(object), string title = default(string), int? totalValue = default(int?), System.DateTime? updatedAt = default(System.DateTime?), V1dealsListResponseDealsItemUpdatedBy updatedBy = default(V1dealsListResponseDealsItemUpdatedBy), int? updatedSourceId = default(int?))
        {
            ClosedAt = closedAt;
            Company = company;
            Contacts = contacts;
        ...
        public V1dealsListResponseDealsItemCompany Company { get; set; }
        ...
        public IList<V1dealsListResponseDealsItemContactsItem> Contacts { get; set; }
        ...
        public V1dealsListResponseDealsItemCreatedBy CreatedBy { get; set; }
        ...
        public V1dealsListResponseDealsItemCurrency Currency { get; set; }
        ...
        public V1dealsListResponseDealsItemDeletedBy DeletedBy { get; set; }
        ...
        public V1dealsListResponseDealsItemLostReason LostReason { get; set; }
        ...
        public V1dealsListResponseDealsItemNextIncompleteActivity NextIncompleteActivity { get; set; }
        ...
        public V1dealsListResponseDealsItemOwner Owner { get; set; }
        ...
        public IList<V1dealsListResponseDealsItemProductsItem> Products { get; set; }
        ...
        public V1dealsListResponseDealsItemQualifiedBy QualifiedBy { get; set; }
        ...
        public V1dealsListResponseDealsItemStage Stage { get; set; }
        ...
        public V1dealsListResponseDealsItemUpdatedBy UpdatedBy { get; set; }
