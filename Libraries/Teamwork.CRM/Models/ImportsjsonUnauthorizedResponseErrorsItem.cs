...
namespace Teamwork.CRM.Models
{
    ...
    public partial class ImportsjsonUnauthorizedResponseErrorsItem
    {
        /// <summary>
        /// Initializes a new instance of the
        /// ImportsjsonUnauthorizedResponseErrorsItem class.
        /// </summary>
        public ImportsjsonUnauthorizedResponseErrorsItem()
        {
            CustomInit();
        }
        ...
        public ImportsjsonUnauthorizedResponseErrorsItem(string code = default(string), string detail = default(string), string id = default(string), string title = default(string))
        {
            Code = code;
            Detail = detail;
            Id = id;
