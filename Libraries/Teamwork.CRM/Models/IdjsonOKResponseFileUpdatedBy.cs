...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class IdjsonOKResponseFileUpdatedBy
    {
        /// <summary>
        /// Initializes a new instance of the IdjsonOKResponseFileUpdatedBy
        /// class.
        /// </summary>
        public IdjsonOKResponseFileUpdatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public IdjsonOKResponseFileUpdatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
