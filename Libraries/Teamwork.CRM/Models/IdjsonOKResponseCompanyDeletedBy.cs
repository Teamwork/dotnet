...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class IdjsonOKResponseCompanyDeletedBy
    {
        /// <summary>
        /// Initializes a new instance of the IdjsonOKResponseCompanyDeletedBy
        /// class.
        /// </summary>
        public IdjsonOKResponseCompanyDeletedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public IdjsonOKResponseCompanyDeletedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
