...
namespace Teamwork.CRM.Models
{
    ...
    /// </remarks>
    public partial class V1customFieldsResponseCustomFieldsItem
    {
        /// <summary>
        /// Initializes a new instance of the
        /// V1customFieldsResponseCustomFieldsItem class.
        /// </summary>
        public V1customFieldsResponseCustomFieldsItem()
        {
            CustomInit();
        }
        ...
        /// object](https://crmdev-teamwork.docs.stoplight.io/documentation/general/entity-models#relationships)
        /// which describes a relationship to another entity.</param>
        public V1customFieldsResponseCustomFieldsItem(System.DateTime? createdAt = default(System.DateTime?), V1customFieldsResponseCustomFieldsItemCreatedBy createdBy = default(V1customFieldsResponseCustomFieldsItemCreatedBy), System.DateTime? deletedAt = default(System.DateTime?), V1customFieldsResponseCustomFieldsItemDeletedBy deletedBy = default(V1customFieldsResponseCustomFieldsItemDeletedBy), string fieldType = default(string), int? id = default(int?), bool? isMandatory = default(bool?), bool? isShownWhenAdding = default(bool?), string key = default(string), string kind = default(string), string name = default(string), IList<string> options = default(IList<string>), System.DateTime? updatedAt = default(System.DateTime?), V1customFieldsResponseCustomFieldsItemUpdatedBy updatedBy = default(V1customFieldsResponseCustomFieldsItemUpdatedBy), int? updatedSourceId = default(int?))
        {
            CreatedAt = createdAt;
            CreatedBy = createdBy;
            DeletedAt = deletedAt;
        ...
        public V1customFieldsResponseCustomFieldsItemCreatedBy CreatedBy { get; set; }
        ...
        public V1customFieldsResponseCustomFieldsItemDeletedBy DeletedBy { get; set; }
        ...
        public V1customFieldsResponseCustomFieldsItemUpdatedBy UpdatedBy { get; set; }
