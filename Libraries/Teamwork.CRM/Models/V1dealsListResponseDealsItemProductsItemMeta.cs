...
namespace Teamwork.CRM.Models
{
    ...
    public partial class V1dealsListResponseDealsItemProductsItemMeta
    {
        /// <summary>
        /// Initializes a new instance of the
        /// V1dealsListResponseDealsItemProductsItemMeta class.
        /// </summary>
        public V1dealsListResponseDealsItemProductsItemMeta()
        {
            CustomInit();
        }
        ...
        public V1dealsListResponseDealsItemProductsItemMeta(int price, int quantity, double? discount = default(double?))
        {
            Discount = discount;
            Price = price;
            Quantity = quantity;
