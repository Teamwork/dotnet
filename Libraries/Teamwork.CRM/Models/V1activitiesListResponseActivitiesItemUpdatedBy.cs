...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1activitiesListResponseActivitiesItemUpdatedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// V1activitiesListResponseActivitiesItemUpdatedBy class.
        /// </summary>
        public V1activitiesListResponseActivitiesItemUpdatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1activitiesListResponseActivitiesItemUpdatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
