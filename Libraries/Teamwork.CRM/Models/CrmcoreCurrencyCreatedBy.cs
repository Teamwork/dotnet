...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class CrmcoreCurrencyCreatedBy
    {
        /// <summary>
        /// Initializes a new instance of the CrmcoreCurrencyCreatedBy class.
        /// </summary>
        public CrmcoreCurrencyCreatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public CrmcoreCurrencyCreatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
