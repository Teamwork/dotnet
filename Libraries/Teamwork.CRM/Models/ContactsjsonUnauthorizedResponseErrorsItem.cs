...
namespace Teamwork.CRM.Models
{
    ...
    public partial class ContactsjsonUnauthorizedResponseErrorsItem
    {
        /// <summary>
        /// Initializes a new instance of the
        /// ContactsjsonUnauthorizedResponseErrorsItem class.
        /// </summary>
        public ContactsjsonUnauthorizedResponseErrorsItem()
        {
            CustomInit();
        }
        ...
        public ContactsjsonUnauthorizedResponseErrorsItem(string code = default(string), string detail = default(string), string id = default(string), string title = default(string))
        {
            Code = code;
            Detail = detail;
            Id = id;
