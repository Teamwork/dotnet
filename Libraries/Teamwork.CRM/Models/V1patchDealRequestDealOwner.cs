...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1patchDealRequestDealOwner
    {
        /// <summary>
        /// Initializes a new instance of the V1patchDealRequestDealOwner
        /// class.
        /// </summary>
        public V1patchDealRequestDealOwner()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1patchDealRequestDealOwner(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
