...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1dealResponseDealLostReason
    {
        /// <summary>
        /// Initializes a new instance of the V1dealResponseDealLostReason
        /// class.
        /// </summary>
        public V1dealResponseDealLostReason()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1dealResponseDealLostReason(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
