...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1dealsResponseDealsItemOwner
    {
        /// <summary>
        /// Initializes a new instance of the V1dealsResponseDealsItemOwner
        /// class.
        /// </summary>
        public V1dealsResponseDealsItemOwner()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1dealsResponseDealsItemOwner(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
