...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1dealResponseDealStage
    {
        /// <summary>
        /// Initializes a new instance of the V1dealResponseDealStage class.
        /// </summary>
        public V1dealResponseDealStage()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1dealResponseDealStage(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
