...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1dealResponseDealCreatedBy
    {
        /// <summary>
        /// Initializes a new instance of the V1dealResponseDealCreatedBy
        /// class.
        /// </summary>
        public V1dealResponseDealCreatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1dealResponseDealCreatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
