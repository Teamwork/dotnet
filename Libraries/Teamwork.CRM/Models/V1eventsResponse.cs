...
namespace Teamwork.CRM.Models
{
    ...
    /// eventsResponse
    /// </summary>
    public partial class V1eventsResponse
    {
        /// <summary>
        /// Initializes a new instance of the V1eventsResponse class.
        /// </summary>
        ...
        public V1eventsResponse(IList<V1eventsResponseEventsItem> events = default(IList<V1eventsResponseEventsItem>), object included = default(object), V1eventsResponseMeta meta = default(V1eventsResponseMeta))
        {
            Events = events;
            Included = included;
            Meta = meta;
        ...
        public IList<V1eventsResponseEventsItem> Events { get; set; }
        ...
        public V1eventsResponseMeta Meta { get; set; }
