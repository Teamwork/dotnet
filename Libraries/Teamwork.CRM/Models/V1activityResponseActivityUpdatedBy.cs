...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1activityResponseActivityUpdatedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// V1activityResponseActivityUpdatedBy class.
        /// </summary>
        public V1activityResponseActivityUpdatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1activityResponseActivityUpdatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
