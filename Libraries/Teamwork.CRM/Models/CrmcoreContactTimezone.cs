...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class CrmcoreContactTimezone
    {
        /// <summary>
        /// Initializes a new instance of the CrmcoreContactTimezone class.
        /// </summary>
        public CrmcoreContactTimezone()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public CrmcoreContactTimezone(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
