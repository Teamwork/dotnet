...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class CrmcoreDealUpdatedBy
    {
        /// <summary>
        /// Initializes a new instance of the CrmcoreDealUpdatedBy class.
        /// </summary>
        public CrmcoreDealUpdatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public CrmcoreDealUpdatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
