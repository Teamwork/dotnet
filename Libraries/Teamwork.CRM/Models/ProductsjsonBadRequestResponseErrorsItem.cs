...
namespace Teamwork.CRM.Models
{
    ...
    public partial class ProductsjsonBadRequestResponseErrorsItem
    {
        /// <summary>
        /// Initializes a new instance of the
        /// ProductsjsonBadRequestResponseErrorsItem class.
        /// </summary>
        public ProductsjsonBadRequestResponseErrorsItem()
        {
            CustomInit();
        }
        ...
        public ProductsjsonBadRequestResponseErrorsItem(string code = default(string), string detail = default(string), string id = default(string), string title = default(string))
        {
            Code = code;
            Detail = detail;
            Id = id;
