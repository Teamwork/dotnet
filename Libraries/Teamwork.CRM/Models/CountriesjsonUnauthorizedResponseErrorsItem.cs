...
namespace Teamwork.CRM.Models
{
    ...
    public partial class CountriesjsonUnauthorizedResponseErrorsItem
    {
        /// <summary>
        /// Initializes a new instance of the
        /// CountriesjsonUnauthorizedResponseErrorsItem class.
        /// </summary>
        public CountriesjsonUnauthorizedResponseErrorsItem()
        {
            CustomInit();
        }
        ...
        public CountriesjsonUnauthorizedResponseErrorsItem(string code = default(string), string detail = default(string), string id = default(string), string title = default(string))
        {
            Code = code;
            Detail = detail;
            Id = id;
