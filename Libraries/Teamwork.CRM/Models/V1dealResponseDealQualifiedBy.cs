...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1dealResponseDealQualifiedBy
    {
        /// <summary>
        /// Initializes a new instance of the V1dealResponseDealQualifiedBy
        /// class.
        /// </summary>
        public V1dealResponseDealQualifiedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1dealResponseDealQualifiedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
