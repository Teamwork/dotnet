...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1contactsListResponseContactsItemCompany
    {
        /// <summary>
        /// Initializes a new instance of the
        /// V1contactsListResponseContactsItemCompany class.
        /// </summary>
        public V1contactsListResponseContactsItemCompany()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1contactsListResponseContactsItemCompany(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
