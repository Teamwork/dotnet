...
namespace Teamwork.CRM.Models
{
    ...
    public partial class CustomFieldsjsonUnauthorizedResponseErrorsItem
    {
        /// <summary>
        /// Initializes a new instance of the
        /// CustomFieldsjsonUnauthorizedResponseErrorsItem class.
        /// </summary>
        public CustomFieldsjsonUnauthorizedResponseErrorsItem()
        {
            CustomInit();
        }
        ...
        public CustomFieldsjsonUnauthorizedResponseErrorsItem(string code = default(string), string detail = default(string), string id = default(string), string title = default(string))
        {
            Code = code;
            Detail = detail;
            Id = id;
