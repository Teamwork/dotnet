...
namespace Teamwork.CRM.Models
{
    ...
    /// </remarks>
    public partial class DealsjsonCreatedResponseDeal
    {
        /// <summary>
        /// Initializes a new instance of the DealsjsonCreatedResponseDeal
        /// class.
        /// </summary>
        public DealsjsonCreatedResponseDeal()
        {
            CustomInit();
        }
        ...
        /// object](https://crmdev-teamwork.docs.stoplight.io/documentation/general/entity-models#relationships)
        /// which describes a relationship to another entity.</param>
        public DealsjsonCreatedResponseDeal(System.DateTime? closedAt = default(System.DateTime?), DealsjsonCreatedResponseDealCompany company = default(DealsjsonCreatedResponseDealCompany), IList<DealsjsonCreatedResponseDealContactsItem> contacts = default(IList<DealsjsonCreatedResponseDealContactsItem>), int? contactsCount = default(int?), System.DateTime? createdAt = default(System.DateTime?), DealsjsonCreatedResponseDealCreatedBy createdBy = default(DealsjsonCreatedResponseDealCreatedBy), DealsjsonCreatedResponseDealCurrency currency = default(DealsjsonCreatedResponseDealCurrency), object custom = default(object), int? customValue = default(int?), System.DateTime? deletedAt = default(System.DateTime?), DealsjsonCreatedResponseDealDeletedBy deletedBy = default(DealsjsonCreatedResponseDealDeletedBy), System.DateTime? expectedCloseDate = default(System.DateTime?), int? id = default(int?), bool? isQualified = default(bool?), DealsjsonCreatedResponseDealLostReason lostReason = default(DealsjsonCreatedResponseDealLostReason), DealsjsonCreatedResponseDealNextIncompleteActivity nextIncompleteActivity = default(DealsjsonCreatedResponseDealNextIncompleteActivity), DealsjsonCreatedResponseDealOwner owner = default(DealsjsonCreatedResponseDealOwner), IList<DealsjsonCreatedResponseDealProductsItem> products = default(IList<DealsjsonCreatedResponseDealProductsItem>), System.DateTime? qualifiedAt = default(System.DateTime?), DealsjsonCreatedResponseDealQualifiedBy qualifiedBy = default(DealsjsonCreatedResponseDealQualifiedBy), DealsjsonCreatedResponseDealStage stage = default(DealsjsonCreatedResponseDealStage), string state = default(string), object teamworkProjects = default(object), string title = default(string), int? totalValue = default(int?), System.DateTime? updatedAt = default(System.DateTime?), DealsjsonCreatedResponseDealUpdatedBy updatedBy = default(DealsjsonCreatedResponseDealUpdatedBy), int? updatedSourceId = default(int?))
        {
            ClosedAt = closedAt;
            Company = company;
            Contacts = contacts;
        ...
        public DealsjsonCreatedResponseDealCompany Company { get; set; }
        ...
        public IList<DealsjsonCreatedResponseDealContactsItem> Contacts { get; set; }
        ...
        public DealsjsonCreatedResponseDealCreatedBy CreatedBy { get; set; }
        ...
        public DealsjsonCreatedResponseDealCurrency Currency { get; set; }
        ...
        public DealsjsonCreatedResponseDealDeletedBy DeletedBy { get; set; }
        ...
        public DealsjsonCreatedResponseDealLostReason LostReason { get; set; }
        ...
        public DealsjsonCreatedResponseDealNextIncompleteActivity NextIncompleteActivity { get; set; }
        ...
        public DealsjsonCreatedResponseDealOwner Owner { get; set; }
        ...
        public IList<DealsjsonCreatedResponseDealProductsItem> Products { get; set; }
        ...
        public DealsjsonCreatedResponseDealQualifiedBy QualifiedBy { get; set; }
        ...
        public DealsjsonCreatedResponseDealStage Stage { get; set; }
        ...
        public DealsjsonCreatedResponseDealUpdatedBy UpdatedBy { get; set; }
