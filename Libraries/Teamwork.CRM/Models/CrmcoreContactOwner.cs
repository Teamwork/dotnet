...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class CrmcoreContactOwner
    {
        /// <summary>
        /// Initializes a new instance of the CrmcoreContactOwner class.
        /// </summary>
        public CrmcoreContactOwner()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public CrmcoreContactOwner(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
