...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class CrmcoreDealCreatedBy
    {
        /// <summary>
        /// Initializes a new instance of the CrmcoreDealCreatedBy class.
        /// </summary>
        public CrmcoreDealCreatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public CrmcoreDealCreatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
