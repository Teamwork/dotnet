...
namespace Teamwork.CRM.Models
{
    ...
    public partial class PipelinesjsonConflictResponseErrorsItem
    {
        /// <summary>
        /// Initializes a new instance of the
        /// PipelinesjsonConflictResponseErrorsItem class.
        /// </summary>
        public PipelinesjsonConflictResponseErrorsItem()
        {
            CustomInit();
        }
        ...
        public PipelinesjsonConflictResponseErrorsItem(string code = default(string), string detail = default(string), string id = default(string), string title = default(string))
        {
            Code = code;
            Detail = detail;
            Id = id;
