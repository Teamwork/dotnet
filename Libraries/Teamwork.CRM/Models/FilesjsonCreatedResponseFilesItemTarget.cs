...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class FilesjsonCreatedResponseFilesItemTarget
    {
        /// <summary>
        /// Initializes a new instance of the
        /// FilesjsonCreatedResponseFilesItemTarget class.
        /// </summary>
        public FilesjsonCreatedResponseFilesItemTarget()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public FilesjsonCreatedResponseFilesItemTarget(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
