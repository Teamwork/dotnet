...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1dealsListResponseDealsItemOwner
    {
        /// <summary>
        /// Initializes a new instance of the V1dealsListResponseDealsItemOwner
        /// class.
        /// </summary>
        public V1dealsListResponseDealsItemOwner()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1dealsListResponseDealsItemOwner(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
