...
namespace Teamwork.CRM.Models
{
    ...
    public partial class PipelinesjsonBadRequestResponseErrorsItem
    {
        /// <summary>
        /// Initializes a new instance of the
        /// PipelinesjsonBadRequestResponseErrorsItem class.
        /// </summary>
        public PipelinesjsonBadRequestResponseErrorsItem()
        {
            CustomInit();
        }
        ...
        public PipelinesjsonBadRequestResponseErrorsItem(string code = default(string), string detail = default(string), string id = default(string), string title = default(string))
        {
            Code = code;
            Detail = detail;
            Id = id;
