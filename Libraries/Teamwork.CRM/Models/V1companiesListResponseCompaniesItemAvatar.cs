...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1companiesListResponseCompaniesItemAvatar
    {
        /// <summary>
        /// Initializes a new instance of the
        /// V1companiesListResponseCompaniesItemAvatar class.
        /// </summary>
        public V1companiesListResponseCompaniesItemAvatar()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1companiesListResponseCompaniesItemAvatar(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
