...
namespace Teamwork.CRM.Models
{
    ...
    public partial class ActivatejsonNotFoundResponseErrorsItem
    {
        /// <summary>
        /// Initializes a new instance of the
        /// ActivatejsonNotFoundResponseErrorsItem class.
        /// </summary>
        public ActivatejsonNotFoundResponseErrorsItem()
        {
            CustomInit();
        }
        ...
        public ActivatejsonNotFoundResponseErrorsItem(string code = default(string), string detail = default(string), string id = default(string), string title = default(string))
        {
            Code = code;
            Detail = detail;
            Id = id;
