...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1companiesListResponseCompaniesItemCustomItemDeletedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// V1companiesListResponseCompaniesItemCustomItemDeletedBy class.
        /// </summary>
        public V1companiesListResponseCompaniesItemCustomItemDeletedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1companiesListResponseCompaniesItemCustomItemDeletedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
