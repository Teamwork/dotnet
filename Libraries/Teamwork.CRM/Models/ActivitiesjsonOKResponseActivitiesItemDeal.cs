...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class ActivitiesjsonOKResponseActivitiesItemDeal
    {
        /// <summary>
        /// Initializes a new instance of the
        /// ActivitiesjsonOKResponseActivitiesItemDeal class.
        /// </summary>
        public ActivitiesjsonOKResponseActivitiesItemDeal()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public ActivitiesjsonOKResponseActivitiesItemDeal(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
