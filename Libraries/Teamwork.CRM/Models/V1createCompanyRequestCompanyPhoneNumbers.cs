...
namespace Teamwork.CRM.Models
{
    ...
    public partial class V1createCompanyRequestCompanyPhoneNumbers
    {
        /// <summary>
        /// Initializes a new instance of the
        /// V1createCompanyRequestCompanyPhoneNumbers class.
        /// </summary>
        public V1createCompanyRequestCompanyPhoneNumbers()
        {
            CustomInit();
        }
        ...
        public V1createCompanyRequestCompanyPhoneNumbers(V1createCompanyRequestCompanyPhoneNumbersCode code = default(V1createCompanyRequestCompanyPhoneNumbersCode), string number = default(string))
        {
            Code = code;
            Number = number;
            CustomInit();
        ...
        public V1createCompanyRequestCompanyPhoneNumbersCode Code { get; set; }
