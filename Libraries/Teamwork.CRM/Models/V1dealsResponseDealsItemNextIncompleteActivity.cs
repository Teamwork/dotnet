...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1dealsResponseDealsItemNextIncompleteActivity
    {
        /// <summary>
        /// Initializes a new instance of the
        /// V1dealsResponseDealsItemNextIncompleteActivity class.
        /// </summary>
        public V1dealsResponseDealsItemNextIncompleteActivity()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1dealsResponseDealsItemNextIncompleteActivity(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
