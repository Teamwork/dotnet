...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class CrmcoreActivityTypeUpdatedBy
    {
        /// <summary>
        /// Initializes a new instance of the CrmcoreActivityTypeUpdatedBy
        /// class.
        /// </summary>
        public CrmcoreActivityTypeUpdatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public CrmcoreActivityTypeUpdatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
