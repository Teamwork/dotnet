...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1dealsListResponseDealsItemLostReason
    {
        /// <summary>
        /// Initializes a new instance of the
        /// V1dealsListResponseDealsItemLostReason class.
        /// </summary>
        public V1dealsListResponseDealsItemLostReason()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1dealsListResponseDealsItemLostReason(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
