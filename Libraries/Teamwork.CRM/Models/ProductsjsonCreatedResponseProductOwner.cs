...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class ProductsjsonCreatedResponseProductOwner
    {
        /// <summary>
        /// Initializes a new instance of the
        /// ProductsjsonCreatedResponseProductOwner class.
        /// </summary>
        public ProductsjsonCreatedResponseProductOwner()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public ProductsjsonCreatedResponseProductOwner(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
