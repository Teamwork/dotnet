...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1createCompanyRequestCompanyTimezone
    {
        /// <summary>
        /// Initializes a new instance of the
        /// V1createCompanyRequestCompanyTimezone class.
        /// </summary>
        public V1createCompanyRequestCompanyTimezone()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1createCompanyRequestCompanyTimezone(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
