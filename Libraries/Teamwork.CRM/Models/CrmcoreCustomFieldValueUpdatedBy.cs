...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class CrmcoreCustomFieldValueUpdatedBy
    {
        /// <summary>
        /// Initializes a new instance of the CrmcoreCustomFieldValueUpdatedBy
        /// class.
        /// </summary>
        public CrmcoreCustomFieldValueUpdatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public CrmcoreCustomFieldValueUpdatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
