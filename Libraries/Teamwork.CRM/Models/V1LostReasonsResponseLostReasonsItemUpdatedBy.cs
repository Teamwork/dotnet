...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1LostReasonsResponseLostReasonsItemUpdatedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// V1LostReasonsResponseLostReasonsItemUpdatedBy class.
        /// </summary>
        public V1LostReasonsResponseLostReasonsItemUpdatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1LostReasonsResponseLostReasonsItemUpdatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
