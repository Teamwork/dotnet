...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class IdjsonOKResponseDealOwner
    {
        /// <summary>
        /// Initializes a new instance of the IdjsonOKResponseDealOwner class.
        /// </summary>
        public IdjsonOKResponseDealOwner()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public IdjsonOKResponseDealOwner(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
