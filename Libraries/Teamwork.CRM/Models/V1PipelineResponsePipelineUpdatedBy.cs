...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1PipelineResponsePipelineUpdatedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// V1PipelineResponsePipelineUpdatedBy class.
        /// </summary>
        public V1PipelineResponsePipelineUpdatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1PipelineResponsePipelineUpdatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
