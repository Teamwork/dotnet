...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1createContactRequestContactTimezone
    {
        /// <summary>
        /// Initializes a new instance of the
        /// V1createContactRequestContactTimezone class.
        /// </summary>
        public V1createContactRequestContactTimezone()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1createContactRequestContactTimezone(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
