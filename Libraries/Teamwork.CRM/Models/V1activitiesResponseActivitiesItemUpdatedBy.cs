...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1activitiesResponseActivitiesItemUpdatedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// V1activitiesResponseActivitiesItemUpdatedBy class.
        /// </summary>
        public V1activitiesResponseActivitiesItemUpdatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1activitiesResponseActivitiesItemUpdatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
