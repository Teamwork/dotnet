...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class LostReasonsjsonCreatedResponseLostReasonCreatedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// LostReasonsjsonCreatedResponseLostReasonCreatedBy class.
        /// </summary>
        public LostReasonsjsonCreatedResponseLostReasonCreatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public LostReasonsjsonCreatedResponseLostReasonCreatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
