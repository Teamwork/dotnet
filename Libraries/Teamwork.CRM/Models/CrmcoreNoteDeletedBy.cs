...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class CrmcoreNoteDeletedBy
    {
        /// <summary>
        /// Initializes a new instance of the CrmcoreNoteDeletedBy class.
        /// </summary>
        public CrmcoreNoteDeletedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public CrmcoreNoteDeletedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
