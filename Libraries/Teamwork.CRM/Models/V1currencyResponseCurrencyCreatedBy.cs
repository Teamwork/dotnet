...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1currencyResponseCurrencyCreatedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// V1currencyResponseCurrencyCreatedBy class.
        /// </summary>
        public V1currencyResponseCurrencyCreatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1currencyResponseCurrencyCreatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
