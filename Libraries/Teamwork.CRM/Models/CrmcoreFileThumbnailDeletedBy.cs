...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class CrmcoreFileThumbnailDeletedBy
    {
        /// <summary>
        /// Initializes a new instance of the CrmcoreFileThumbnailDeletedBy
        /// class.
        /// </summary>
        public CrmcoreFileThumbnailDeletedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public CrmcoreFileThumbnailDeletedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
