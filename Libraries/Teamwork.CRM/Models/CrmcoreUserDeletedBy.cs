...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class CrmcoreUserDeletedBy
    {
        /// <summary>
        /// Initializes a new instance of the CrmcoreUserDeletedBy class.
        /// </summary>
        public CrmcoreUserDeletedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public CrmcoreUserDeletedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
