...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1stagesResponseStagesItemPipeline
    {
        /// <summary>
        /// Initializes a new instance of the
        /// V1stagesResponseStagesItemPipeline class.
        /// </summary>
        public V1stagesResponseStagesItemPipeline()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1stagesResponseStagesItemPipeline(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
