...
namespace Teamwork.CRM.Models
{
    ...
    /// </remarks>
    public partial class V1currenciesResponseCurrenciesItem
    {
        /// <summary>
        /// Initializes a new instance of the
        /// V1currenciesResponseCurrenciesItem class.
        /// </summary>
        public V1currenciesResponseCurrenciesItem()
        {
            CustomInit();
        }
        ...
        /// object](https://crmdev-teamwork.docs.stoplight.io/documentation/general/entity-models#relationships)
        /// which describes a relationship to another entity.</param>
        public V1currenciesResponseCurrenciesItem(string code = default(string), System.DateTime? createdAt = default(System.DateTime?), V1currenciesResponseCurrenciesItemCreatedBy createdBy = default(V1currenciesResponseCurrenciesItemCreatedBy), int? decimalPoints = default(int?), System.DateTime? deletedAt = default(System.DateTime?), V1currenciesResponseCurrenciesItemDeletedBy deletedBy = default(V1currenciesResponseCurrenciesItemDeletedBy), int? id = default(int?), string name = default(string), string state = default(string), string symbol = default(string), System.DateTime? updatedAt = default(System.DateTime?), V1currenciesResponseCurrenciesItemUpdatedBy updatedBy = default(V1currenciesResponseCurrenciesItemUpdatedBy), int? updatedSourceId = default(int?))
        {
            Code = code;
            CreatedAt = createdAt;
            CreatedBy = createdBy;
        ...
        public V1currenciesResponseCurrenciesItemCreatedBy CreatedBy { get; set; }
        ...
        public V1currenciesResponseCurrenciesItemDeletedBy DeletedBy { get; set; }
        ...
        public V1currenciesResponseCurrenciesItemUpdatedBy UpdatedBy { get; set; }
