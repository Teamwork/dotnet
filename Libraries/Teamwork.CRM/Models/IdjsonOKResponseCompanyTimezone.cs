...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class IdjsonOKResponseCompanyTimezone
    {
        /// <summary>
        /// Initializes a new instance of the IdjsonOKResponseCompanyTimezone
        /// class.
        /// </summary>
        public IdjsonOKResponseCompanyTimezone()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public IdjsonOKResponseCompanyTimezone(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
