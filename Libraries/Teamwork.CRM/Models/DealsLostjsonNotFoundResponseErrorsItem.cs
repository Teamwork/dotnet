...
namespace Teamwork.CRM.Models
{
    ...
    public partial class DealsLostjsonNotFoundResponseErrorsItem
    {
        /// <summary>
        /// Initializes a new instance of the
        /// DealsLostjsonNotFoundResponseErrorsItem class.
        /// </summary>
        public DealsLostjsonNotFoundResponseErrorsItem()
        {
            CustomInit();
        }
        ...
        public DealsLostjsonNotFoundResponseErrorsItem(string code = default(string), string detail = default(string), string id = default(string), string title = default(string))
        {
            Code = code;
            Detail = detail;
            Id = id;
