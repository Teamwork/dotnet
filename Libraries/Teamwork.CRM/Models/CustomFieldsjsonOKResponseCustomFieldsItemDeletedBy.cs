...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class CustomFieldsjsonOKResponseCustomFieldsItemDeletedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// CustomFieldsjsonOKResponseCustomFieldsItemDeletedBy class.
        /// </summary>
        public CustomFieldsjsonOKResponseCustomFieldsItemDeletedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public CustomFieldsjsonOKResponseCustomFieldsItemDeletedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
