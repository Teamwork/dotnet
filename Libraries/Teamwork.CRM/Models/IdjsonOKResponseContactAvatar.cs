...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class IdjsonOKResponseContactAvatar
    {
        /// <summary>
        /// Initializes a new instance of the IdjsonOKResponseContactAvatar
        /// class.
        /// </summary>
        public IdjsonOKResponseContactAvatar()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public IdjsonOKResponseContactAvatar(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
