...
namespace Teamwork.CRM.Models
{
    ...
    /// patchNote
    /// </summary>
    public partial class V1patchNote
    {
        /// <summary>
        /// Initializes a new instance of the V1patchNote class.
        /// </summary>
        public V1patchNote()
        {
            CustomInit();
        ...
        /// notes.</param>
        public V1patchNote(string description = default(string), bool? isPinned = default(bool?))
        {
