...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class CompaniesjsonCreatedResponseCompanyDeletedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// CompaniesjsonCreatedResponseCompanyDeletedBy class.
        /// </summary>
        public CompaniesjsonCreatedResponseCompanyDeletedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public CompaniesjsonCreatedResponseCompanyDeletedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
