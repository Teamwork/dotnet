...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1companiesResponseCompaniesItemCreatedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// V1companiesResponseCompaniesItemCreatedBy class.
        /// </summary>
        public V1companiesResponseCompaniesItemCreatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1companiesResponseCompaniesItemCreatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
