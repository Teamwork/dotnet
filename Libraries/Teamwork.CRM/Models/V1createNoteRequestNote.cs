...
namespace Teamwork.CRM.Models
{
    ...
    /// createNote
    /// </summary>
    public partial class V1createNoteRequestNote
    {
        /// <summary>
        /// Initializes a new instance of the V1createNoteRequestNote class.
        /// </summary>
        public V1createNoteRequestNote()
        {
            CustomInit();
        }
        ...
        /// notes.</param>
        public V1createNoteRequestNote(string description, string subject, bool? isPinned = default(bool?))
        {
