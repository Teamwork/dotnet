...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1productResponseProductAvatar
    {
        /// <summary>
        /// Initializes a new instance of the V1productResponseProductAvatar
        /// class.
        /// </summary>
        public V1productResponseProductAvatar()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1productResponseProductAvatar(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
