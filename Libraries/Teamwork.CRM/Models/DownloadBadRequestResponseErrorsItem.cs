...
namespace Teamwork.CRM.Models
{
    ...
    public partial class DownloadBadRequestResponseErrorsItem
    {
        /// <summary>
        /// Initializes a new instance of the
        /// DownloadBadRequestResponseErrorsItem class.
        /// </summary>
        public DownloadBadRequestResponseErrorsItem()
        {
            CustomInit();
        }
        ...
        public DownloadBadRequestResponseErrorsItem(string code = default(string), string detail = default(string), string id = default(string), string title = default(string))
        {
            Code = code;
            Detail = detail;
            Id = id;
