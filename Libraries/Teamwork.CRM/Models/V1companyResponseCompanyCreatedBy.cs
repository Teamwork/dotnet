...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1companyResponseCompanyCreatedBy
    {
        /// <summary>
        /// Initializes a new instance of the V1companyResponseCompanyCreatedBy
        /// class.
        /// </summary>
        public V1companyResponseCompanyCreatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1companyResponseCompanyCreatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
