...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class IdjsonOKResponseNoteDeletedBy
    {
        /// <summary>
        /// Initializes a new instance of the IdjsonOKResponseNoteDeletedBy
        /// class.
        /// </summary>
        public IdjsonOKResponseNoteDeletedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public IdjsonOKResponseNoteDeletedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
