...
namespace Teamwork.CRM.Models
{
    ...
    public partial class V1productsListResponseProductsItemPricesItemMeta
    {
        /// <summary>
        /// Initializes a new instance of the
        /// V1productsListResponseProductsItemPricesItemMeta class.
        /// </summary>
        public V1productsListResponseProductsItemPricesItemMeta()
        {
            CustomInit();
        }
        ...
        /// cents.</param>
        public V1productsListResponseProductsItemPricesItemMeta(int price)
        {
            Price = price;
            CustomInit();
        }
