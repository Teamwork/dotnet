...
namespace Teamwork.CRM.Models
{
    ...
    public partial class CustomFieldsjsonNotFoundResponseErrorsItem
    {
        /// <summary>
        /// Initializes a new instance of the
        /// CustomFieldsjsonNotFoundResponseErrorsItem class.
        /// </summary>
        public CustomFieldsjsonNotFoundResponseErrorsItem()
        {
            CustomInit();
        }
        ...
        public CustomFieldsjsonNotFoundResponseErrorsItem(string code = default(string), string detail = default(string), string id = default(string), string title = default(string))
        {
            Code = code;
            Detail = detail;
            Id = id;
