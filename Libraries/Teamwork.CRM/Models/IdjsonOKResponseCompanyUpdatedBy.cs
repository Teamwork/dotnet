...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class IdjsonOKResponseCompanyUpdatedBy
    {
        /// <summary>
        /// Initializes a new instance of the IdjsonOKResponseCompanyUpdatedBy
        /// class.
        /// </summary>
        public IdjsonOKResponseCompanyUpdatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public IdjsonOKResponseCompanyUpdatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
