...
namespace Teamwork.CRM.Models
{
    ...
    /// </remarks>
    public partial class SearchjsonOKResponseSearchResultsItem
    {
        /// <summary>
        /// Initializes a new instance of the
        /// SearchjsonOKResponseSearchResultsItem class.
        /// </summary>
        public SearchjsonOKResponseSearchResultsItem()
        {
            CustomInit();
        }
        ...
        /// entity.</param>
        public SearchjsonOKResponseSearchResultsItem(SearchjsonOKResponseSearchResultsItemContent content = default(SearchjsonOKResponseSearchResultsItemContent), string kind = default(string), string title = default(string))
        {
            Content = content;
            Kind = kind;
            Title = title;
        ...
        public SearchjsonOKResponseSearchResultsItemContent Content { get; set; }
