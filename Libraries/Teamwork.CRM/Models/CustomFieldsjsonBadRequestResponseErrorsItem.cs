...
namespace Teamwork.CRM.Models
{
    ...
    public partial class CustomFieldsjsonBadRequestResponseErrorsItem
    {
        /// <summary>
        /// Initializes a new instance of the
        /// CustomFieldsjsonBadRequestResponseErrorsItem class.
        /// </summary>
        public CustomFieldsjsonBadRequestResponseErrorsItem()
        {
            CustomInit();
        }
        ...
        public CustomFieldsjsonBadRequestResponseErrorsItem(string code = default(string), string detail = default(string), string id = default(string), string title = default(string))
        {
            Code = code;
            Detail = detail;
            Id = id;
