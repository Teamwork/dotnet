...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1patchContactRequestContactTimezone
    {
        /// <summary>
        /// Initializes a new instance of the
        /// V1patchContactRequestContactTimezone class.
        /// </summary>
        public V1patchContactRequestContactTimezone()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1patchContactRequestContactTimezone(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
