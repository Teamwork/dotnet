...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1patchContactRequestContactCompany
    {
        /// <summary>
        /// Initializes a new instance of the
        /// V1patchContactRequestContactCompany class.
        /// </summary>
        public V1patchContactRequestContactCompany()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1patchContactRequestContactCompany(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
