...
namespace Teamwork.CRM.Models
{
    ...
    public partial class DealsjsonUnauthorizedResponseErrorsItem
    {
        /// <summary>
        /// Initializes a new instance of the
        /// DealsjsonUnauthorizedResponseErrorsItem class.
        /// </summary>
        public DealsjsonUnauthorizedResponseErrorsItem()
        {
            CustomInit();
        }
        ...
        public DealsjsonUnauthorizedResponseErrorsItem(string code = default(string), string detail = default(string), string id = default(string), string title = default(string))
        {
            Code = code;
            Detail = detail;
            Id = id;
