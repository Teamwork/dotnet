...
namespace Teamwork.CRM.Models
{
    ...
    /// </remarks>
    public partial class IdjsonOKResponseCurrency
    {
        /// <summary>
        /// Initializes a new instance of the IdjsonOKResponseCurrency class.
        /// </summary>
        public IdjsonOKResponseCurrency()
        {
            CustomInit();
        }
        ...
        /// object](https://crmdev-teamwork.docs.stoplight.io/documentation/general/entity-models#relationships)
        /// which describes a relationship to another entity.</param>
        public IdjsonOKResponseCurrency(string code = default(string), System.DateTime? createdAt = default(System.DateTime?), IdjsonOKResponseCurrencyCreatedBy createdBy = default(IdjsonOKResponseCurrencyCreatedBy), int? decimalPoints = default(int?), System.DateTime? deletedAt = default(System.DateTime?), IdjsonOKResponseCurrencyDeletedBy deletedBy = default(IdjsonOKResponseCurrencyDeletedBy), int? id = default(int?), string name = default(string), string state = default(string), string symbol = default(string), System.DateTime? updatedAt = default(System.DateTime?), IdjsonOKResponseCurrencyUpdatedBy updatedBy = default(IdjsonOKResponseCurrencyUpdatedBy), int? updatedSourceId = default(int?))
        {
            Code = code;
            CreatedAt = createdAt;
            CreatedBy = createdBy;
        ...
        public IdjsonOKResponseCurrencyCreatedBy CreatedBy { get; set; }
        ...
        public IdjsonOKResponseCurrencyDeletedBy DeletedBy { get; set; }
        ...
        public IdjsonOKResponseCurrencyUpdatedBy UpdatedBy { get; set; }
