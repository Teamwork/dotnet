...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class CrmcoreContactUpdatedBy
    {
        /// <summary>
        /// Initializes a new instance of the CrmcoreContactUpdatedBy class.
        /// </summary>
        public CrmcoreContactUpdatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public CrmcoreContactUpdatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
