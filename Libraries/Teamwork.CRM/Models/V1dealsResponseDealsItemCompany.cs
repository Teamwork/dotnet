...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1dealsResponseDealsItemCompany
    {
        /// <summary>
        /// Initializes a new instance of the V1dealsResponseDealsItemCompany
        /// class.
        /// </summary>
        public V1dealsResponseDealsItemCompany()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1dealsResponseDealsItemCompany(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
