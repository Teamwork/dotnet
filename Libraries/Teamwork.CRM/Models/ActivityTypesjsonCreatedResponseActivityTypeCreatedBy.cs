...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class ActivityTypesjsonCreatedResponseActivityTypeCreatedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// ActivityTypesjsonCreatedResponseActivityTypeCreatedBy class.
        /// </summary>
        public ActivityTypesjsonCreatedResponseActivityTypeCreatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public ActivityTypesjsonCreatedResponseActivityTypeCreatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
