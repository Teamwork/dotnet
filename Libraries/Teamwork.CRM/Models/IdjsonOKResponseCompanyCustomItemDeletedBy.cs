...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class IdjsonOKResponseCompanyCustomItemDeletedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// IdjsonOKResponseCompanyCustomItemDeletedBy class.
        /// </summary>
        public IdjsonOKResponseCompanyCustomItemDeletedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public IdjsonOKResponseCompanyCustomItemDeletedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
