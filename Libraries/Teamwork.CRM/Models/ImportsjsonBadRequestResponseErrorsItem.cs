...
namespace Teamwork.CRM.Models
{
    ...
    public partial class ImportsjsonBadRequestResponseErrorsItem
    {
        /// <summary>
        /// Initializes a new instance of the
        /// ImportsjsonBadRequestResponseErrorsItem class.
        /// </summary>
        public ImportsjsonBadRequestResponseErrorsItem()
        {
            CustomInit();
        }
        ...
        public ImportsjsonBadRequestResponseErrorsItem(string code = default(string), string detail = default(string), string id = default(string), string title = default(string))
        {
            Code = code;
            Detail = detail;
            Id = id;
