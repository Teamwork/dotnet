...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1LostReasonResponseLostReasonUpdatedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// V1LostReasonResponseLostReasonUpdatedBy class.
        /// </summary>
        public V1LostReasonResponseLostReasonUpdatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1LostReasonResponseLostReasonUpdatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
