...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class NotesjsonOKResponseNoteDeletedBy
    {
        /// <summary>
        /// Initializes a new instance of the NotesjsonOKResponseNoteDeletedBy
        /// class.
        /// </summary>
        public NotesjsonOKResponseNoteDeletedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public NotesjsonOKResponseNoteDeletedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
