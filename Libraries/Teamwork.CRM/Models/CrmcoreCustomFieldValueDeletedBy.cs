...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class CrmcoreCustomFieldValueDeletedBy
    {
        /// <summary>
        /// Initializes a new instance of the CrmcoreCustomFieldValueDeletedBy
        /// class.
        /// </summary>
        public CrmcoreCustomFieldValueDeletedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public CrmcoreCustomFieldValueDeletedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
