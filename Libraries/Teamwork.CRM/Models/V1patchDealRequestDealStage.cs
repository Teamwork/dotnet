...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1patchDealRequestDealStage
    {
        /// <summary>
        /// Initializes a new instance of the V1patchDealRequestDealStage
        /// class.
        /// </summary>
        public V1patchDealRequestDealStage()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1patchDealRequestDealStage(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
