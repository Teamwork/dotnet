...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1productsListResponseProductsItemOwner
    {
        /// <summary>
        /// Initializes a new instance of the
        /// V1productsListResponseProductsItemOwner class.
        /// </summary>
        public V1productsListResponseProductsItemOwner()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1productsListResponseProductsItemOwner(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
