...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class CrmcoreCompanyAvatar
    {
        /// <summary>
        /// Initializes a new instance of the CrmcoreCompanyAvatar class.
        /// </summary>
        public CrmcoreCompanyAvatar()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public CrmcoreCompanyAvatar(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
