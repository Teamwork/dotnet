...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class CrmcorePipelineUpdatedBy
    {
        /// <summary>
        /// Initializes a new instance of the CrmcorePipelineUpdatedBy class.
        /// </summary>
        public CrmcorePipelineUpdatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public CrmcorePipelineUpdatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
