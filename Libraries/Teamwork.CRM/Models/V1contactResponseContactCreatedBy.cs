...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1contactResponseContactCreatedBy
    {
        /// <summary>
        /// Initializes a new instance of the V1contactResponseContactCreatedBy
        /// class.
        /// </summary>
        public V1contactResponseContactCreatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1contactResponseContactCreatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
