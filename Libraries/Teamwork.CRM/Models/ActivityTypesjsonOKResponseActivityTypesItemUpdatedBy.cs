...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class ActivityTypesjsonOKResponseActivityTypesItemUpdatedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// ActivityTypesjsonOKResponseActivityTypesItemUpdatedBy class.
        /// </summary>
        public ActivityTypesjsonOKResponseActivityTypesItemUpdatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public ActivityTypesjsonOKResponseActivityTypesItemUpdatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
