...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1fileResponseFileCreatedBy
    {
        /// <summary>
        /// Initializes a new instance of the V1fileResponseFileCreatedBy
        /// class.
        /// </summary>
        public V1fileResponseFileCreatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1fileResponseFileCreatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
