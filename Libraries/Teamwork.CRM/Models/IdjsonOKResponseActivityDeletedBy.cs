...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class IdjsonOKResponseActivityDeletedBy
    {
        /// <summary>
        /// Initializes a new instance of the IdjsonOKResponseActivityDeletedBy
        /// class.
        /// </summary>
        public IdjsonOKResponseActivityDeletedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public IdjsonOKResponseActivityDeletedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
