...
namespace Teamwork.CRM.Models
{
    ...
    /// </remarks>
    public partial class PipelinesjsonCreatedResponsePipeline
    {
        /// <summary>
        /// Initializes a new instance of the
        /// PipelinesjsonCreatedResponsePipeline class.
        /// </summary>
        public PipelinesjsonCreatedResponsePipeline()
        {
            CustomInit();
        }
        ...
        /// object](https://crmdev-teamwork.docs.stoplight.io/documentation/general/entity-models#relationships)
        /// which describes a relationship to another entity.</param>
        public PipelinesjsonCreatedResponsePipeline(System.DateTime? createdAt = default(System.DateTime?), PipelinesjsonCreatedResponsePipelineCreatedBy createdBy = default(PipelinesjsonCreatedResponsePipelineCreatedBy), System.DateTime? deletedAt = default(System.DateTime?), PipelinesjsonCreatedResponsePipelineDeletedBy deletedBy = default(PipelinesjsonCreatedResponsePipelineDeletedBy), int? id = default(int?), bool? isQualified = default(bool?), string name = default(string), int? orderIndex = default(int?), IList<PipelinesjsonCreatedResponsePipelineStagesItem> stages = default(IList<PipelinesjsonCreatedResponsePipelineStagesItem>), int? stagesCount = default(int?), double? totalValue = default(double?), System.DateTime? updatedAt = default(System.DateTime?), PipelinesjsonCreatedResponsePipelineUpdatedBy updatedBy = default(PipelinesjsonCreatedResponsePipelineUpdatedBy), int? updatedSourceId = default(int?))
        {
            CreatedAt = createdAt;
            CreatedBy = createdBy;
            DeletedAt = deletedAt;
        ...
        public PipelinesjsonCreatedResponsePipelineCreatedBy CreatedBy { get; set; }
        ...
        public PipelinesjsonCreatedResponsePipelineDeletedBy DeletedBy { get; set; }
        ...
        public IList<PipelinesjsonCreatedResponsePipelineStagesItem> Stages { get; set; }
        ...
        public PipelinesjsonCreatedResponsePipelineUpdatedBy UpdatedBy { get; set; }
