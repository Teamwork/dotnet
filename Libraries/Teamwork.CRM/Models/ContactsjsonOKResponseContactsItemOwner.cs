...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class ContactsjsonOKResponseContactsItemOwner
    {
        /// <summary>
        /// Initializes a new instance of the
        /// ContactsjsonOKResponseContactsItemOwner class.
        /// </summary>
        public ContactsjsonOKResponseContactsItemOwner()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public ContactsjsonOKResponseContactsItemOwner(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
