...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1searchableResponseSearchResultsItemContent
    {
        /// <summary>
        /// Initializes a new instance of the
        /// V1searchableResponseSearchResultsItemContent class.
        /// </summary>
        public V1searchableResponseSearchResultsItemContent()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1searchableResponseSearchResultsItemContent(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
