...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class StagesjsonCreatedResponseStageDeletedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// StagesjsonCreatedResponseStageDeletedBy class.
        /// </summary>
        public StagesjsonCreatedResponseStageDeletedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public StagesjsonCreatedResponseStageDeletedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
