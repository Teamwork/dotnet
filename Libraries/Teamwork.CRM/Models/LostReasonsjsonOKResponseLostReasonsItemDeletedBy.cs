...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class LostReasonsjsonOKResponseLostReasonsItemDeletedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// LostReasonsjsonOKResponseLostReasonsItemDeletedBy class.
        /// </summary>
        public LostReasonsjsonOKResponseLostReasonsItemDeletedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public LostReasonsjsonOKResponseLostReasonsItemDeletedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
