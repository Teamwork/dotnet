...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1dealsListResponseDealsItemCurrency
    {
        /// <summary>
        /// Initializes a new instance of the
        /// V1dealsListResponseDealsItemCurrency class.
        /// </summary>
        public V1dealsListResponseDealsItemCurrency()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1dealsListResponseDealsItemCurrency(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
