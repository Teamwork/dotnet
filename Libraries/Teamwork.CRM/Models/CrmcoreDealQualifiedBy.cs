...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class CrmcoreDealQualifiedBy
    {
        /// <summary>
        /// Initializes a new instance of the CrmcoreDealQualifiedBy class.
        /// </summary>
        public CrmcoreDealQualifiedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public CrmcoreDealQualifiedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
