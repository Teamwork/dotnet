...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1dealsResponseDealsItemStage
    {
        /// <summary>
        /// Initializes a new instance of the V1dealsResponseDealsItemStage
        /// class.
        /// </summary>
        public V1dealsResponseDealsItemStage()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1dealsResponseDealsItemStage(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
