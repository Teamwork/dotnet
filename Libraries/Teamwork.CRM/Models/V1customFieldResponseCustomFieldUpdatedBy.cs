...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1customFieldResponseCustomFieldUpdatedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// V1customFieldResponseCustomFieldUpdatedBy class.
        /// </summary>
        public V1customFieldResponseCustomFieldUpdatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1customFieldResponseCustomFieldUpdatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
