...
namespace Teamwork.CRM.Models
{
    ...
    public partial class ActivitiesjsonConflictResponseErrorsItem
    {
        /// <summary>
        /// Initializes a new instance of the
        /// ActivitiesjsonConflictResponseErrorsItem class.
        /// </summary>
        public ActivitiesjsonConflictResponseErrorsItem()
        {
            CustomInit();
        }
        ...
        public ActivitiesjsonConflictResponseErrorsItem(string code = default(string), string detail = default(string), string id = default(string), string title = default(string))
        {
            Code = code;
            Detail = detail;
            Id = id;
