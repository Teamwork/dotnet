...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class IdjsonOKResponseCustomFieldDeletedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// IdjsonOKResponseCustomFieldDeletedBy class.
        /// </summary>
        public IdjsonOKResponseCustomFieldDeletedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public IdjsonOKResponseCustomFieldDeletedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
