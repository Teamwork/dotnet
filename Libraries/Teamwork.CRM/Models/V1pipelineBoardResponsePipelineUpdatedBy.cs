...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1pipelineBoardResponsePipelineUpdatedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// V1pipelineBoardResponsePipelineUpdatedBy class.
        /// </summary>
        public V1pipelineBoardResponsePipelineUpdatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1pipelineBoardResponsePipelineUpdatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
