...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1patchProductRequestProductOwner
    {
        /// <summary>
        /// Initializes a new instance of the V1patchProductRequestProductOwner
        /// class.
        /// </summary>
        public V1patchProductRequestProductOwner()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1patchProductRequestProductOwner(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
