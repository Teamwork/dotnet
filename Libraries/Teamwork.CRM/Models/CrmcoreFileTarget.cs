...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class CrmcoreFileTarget
    {
        /// <summary>
        /// Initializes a new instance of the CrmcoreFileTarget class.
        /// </summary>
        public CrmcoreFileTarget()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public CrmcoreFileTarget(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
