...
namespace Teamwork.CRM.Models
{
    ...
    public partial class ContactsjsonBadRequestResponseErrorsItem
    {
        /// <summary>
        /// Initializes a new instance of the
        /// ContactsjsonBadRequestResponseErrorsItem class.
        /// </summary>
        public ContactsjsonBadRequestResponseErrorsItem()
        {
            CustomInit();
        }
        ...
        public ContactsjsonBadRequestResponseErrorsItem(string code = default(string), string detail = default(string), string id = default(string), string title = default(string))
        {
            Code = code;
            Detail = detail;
            Id = id;
