...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class NotesjsonCreatedResponseNoteCreatedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// NotesjsonCreatedResponseNoteCreatedBy class.
        /// </summary>
        public NotesjsonCreatedResponseNoteCreatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public NotesjsonCreatedResponseNoteCreatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
