...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class IdjsonOKResponsePipelineDeletedBy
    {
        /// <summary>
        /// Initializes a new instance of the IdjsonOKResponsePipelineDeletedBy
        /// class.
        /// </summary>
        public IdjsonOKResponsePipelineDeletedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public IdjsonOKResponsePipelineDeletedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
