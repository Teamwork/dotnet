...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1createdFilesResponseFilesItemCreatedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// V1createdFilesResponseFilesItemCreatedBy class.
        /// </summary>
        public V1createdFilesResponseFilesItemCreatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1createdFilesResponseFilesItemCreatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
