...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class CrmcoreFileThumbnailCreatedBy
    {
        /// <summary>
        /// Initializes a new instance of the CrmcoreFileThumbnailCreatedBy
        /// class.
        /// </summary>
        public CrmcoreFileThumbnailCreatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public CrmcoreFileThumbnailCreatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
