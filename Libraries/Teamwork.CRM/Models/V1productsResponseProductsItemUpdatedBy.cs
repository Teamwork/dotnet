...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1productsResponseProductsItemUpdatedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// V1productsResponseProductsItemUpdatedBy class.
        /// </summary>
        public V1productsResponseProductsItemUpdatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1productsResponseProductsItemUpdatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
