...
namespace Teamwork.CRM.Models
{
    ...
    public partial class V1createContactRequestContactPhoneNumbers
    {
        /// <summary>
        /// Initializes a new instance of the
        /// V1createContactRequestContactPhoneNumbers class.
        /// </summary>
        public V1createContactRequestContactPhoneNumbers()
        {
            CustomInit();
        }
        ...
        public V1createContactRequestContactPhoneNumbers(V1createContactRequestContactPhoneNumbersCode code = default(V1createContactRequestContactPhoneNumbersCode), string number = default(string))
        {
            Code = code;
            Number = number;
            CustomInit();
        ...
        public V1createContactRequestContactPhoneNumbersCode Code { get; set; }
