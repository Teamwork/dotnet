...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1createDealRequestDealCompany
    {
        /// <summary>
        /// Initializes a new instance of the V1createDealRequestDealCompany
        /// class.
        /// </summary>
        public V1createDealRequestDealCompany()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1createDealRequestDealCompany(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
