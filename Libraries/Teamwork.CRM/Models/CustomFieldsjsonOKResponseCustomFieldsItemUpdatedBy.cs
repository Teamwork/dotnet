...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class CustomFieldsjsonOKResponseCustomFieldsItemUpdatedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// CustomFieldsjsonOKResponseCustomFieldsItemUpdatedBy class.
        /// </summary>
        public CustomFieldsjsonOKResponseCustomFieldsItemUpdatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public CustomFieldsjsonOKResponseCustomFieldsItemUpdatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
