...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class CrmcoreActivityCompletedByUser
    {
        /// <summary>
        /// Initializes a new instance of the CrmcoreActivityCompletedByUser
        /// class.
        /// </summary>
        public CrmcoreActivityCompletedByUser()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public CrmcoreActivityCompletedByUser(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
