...
namespace Teamwork.CRM.Models
{
    ...
    /// userResponse
    /// </summary>
    public partial class V1userResponse
    {
        /// <summary>
        /// Initializes a new instance of the V1userResponse class.
        /// </summary>
        public V1userResponse()
        {
            CustomInit();
        }
        ...
        public V1userResponse(object included = default(object), V1userResponseUser user = default(V1userResponseUser))
        {
            Included = included;
            User = user;
            CustomInit();
        ...
        public V1userResponseUser User { get; set; }
