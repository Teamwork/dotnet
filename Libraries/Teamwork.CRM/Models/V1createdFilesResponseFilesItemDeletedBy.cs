...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1createdFilesResponseFilesItemDeletedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// V1createdFilesResponseFilesItemDeletedBy class.
        /// </summary>
        public V1createdFilesResponseFilesItemDeletedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1createdFilesResponseFilesItemDeletedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
