...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class FilesjsonCreatedResponseFilesItemUpdatedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// FilesjsonCreatedResponseFilesItemUpdatedBy class.
        /// </summary>
        public FilesjsonCreatedResponseFilesItemUpdatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public FilesjsonCreatedResponseFilesItemUpdatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
