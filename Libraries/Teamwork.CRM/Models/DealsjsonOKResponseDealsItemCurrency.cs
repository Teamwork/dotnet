...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class DealsjsonOKResponseDealsItemCurrency
    {
        /// <summary>
        /// Initializes a new instance of the
        /// DealsjsonOKResponseDealsItemCurrency class.
        /// </summary>
        public DealsjsonOKResponseDealsItemCurrency()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public DealsjsonOKResponseDealsItemCurrency(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
