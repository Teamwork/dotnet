...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1productsResponseProductsItemAvatar
    {
        /// <summary>
        /// Initializes a new instance of the
        /// V1productsResponseProductsItemAvatar class.
        /// </summary>
        public V1productsResponseProductsItemAvatar()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1productsResponseProductsItemAvatar(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
