...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class CrmcoreActivityCreatedBy
    {
        /// <summary>
        /// Initializes a new instance of the CrmcoreActivityCreatedBy class.
        /// </summary>
        public CrmcoreActivityCreatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public CrmcoreActivityCreatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
