...
namespace Teamwork.CRM.Models
{
    ...
    /// </remarks>
    public partial class IdjsonOKResponseActivity
    {
        /// <summary>
        /// Initializes a new instance of the IdjsonOKResponseActivity class.
        /// </summary>
        public IdjsonOKResponseActivity()
        {
            CustomInit();
        }
        ...
        /// object](https://crmdev-teamwork.docs.stoplight.io/documentation/general/entity-models#relationships)
        /// which describes a relationship to another entity.</param>
        public IdjsonOKResponseActivity(IdjsonOKResponseActivityActivityType activityType = default(IdjsonOKResponseActivityActivityType), IList<IdjsonOKResponseActivityAssigneesItem> assignees = default(IList<IdjsonOKResponseActivityAssigneesItem>), int? assigneesCount = default(int?), System.DateTime? completedAt = default(System.DateTime?), IdjsonOKResponseActivityCompletedByUser completedByUser = default(IdjsonOKResponseActivityCompletedByUser), IList<IdjsonOKResponseActivityContactsItem> contacts = default(IList<IdjsonOKResponseActivityContactsItem>), int? contactsCount = default(int?), System.DateTime? createdAt = default(System.DateTime?), IdjsonOKResponseActivityCreatedBy createdBy = default(IdjsonOKResponseActivityCreatedBy), object custom = default(object), IdjsonOKResponseActivityDeal deal = default(IdjsonOKResponseActivityDeal), System.DateTime? deletedAt = default(System.DateTime?), IdjsonOKResponseActivityDeletedBy deletedBy = default(IdjsonOKResponseActivityDeletedBy), string description = default(string), System.DateTime? dueDate = default(System.DateTime?), int? duration = default(int?), int? id = default(int?), bool? isComplete = default(bool?), System.DateTime? startDate = default(System.DateTime?), string title = default(string), System.DateTime? updatedAt = default(System.DateTime?), IdjsonOKResponseActivityUpdatedBy updatedBy = default(IdjsonOKResponseActivityUpdatedBy), int? updatedSourceId = default(int?))
        {
        ...
        public IdjsonOKResponseActivityActivityType ActivityType { get; set; }
        ...
        public IList<IdjsonOKResponseActivityAssigneesItem> Assignees { get; set; }
        ...
        public IdjsonOKResponseActivityCompletedByUser CompletedByUser { get; set; }
        ...
        public IList<IdjsonOKResponseActivityContactsItem> Contacts { get; set; }
        ...
        public IdjsonOKResponseActivityCreatedBy CreatedBy { get; set; }
        ...
        public IdjsonOKResponseActivityDeal Deal { get; set; }
        ...
        public IdjsonOKResponseActivityDeletedBy DeletedBy { get; set; }
        ...
        public IdjsonOKResponseActivityUpdatedBy UpdatedBy { get; set; }
