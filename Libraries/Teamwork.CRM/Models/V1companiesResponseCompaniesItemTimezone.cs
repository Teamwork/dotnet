...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1companiesResponseCompaniesItemTimezone
    {
        /// <summary>
        /// Initializes a new instance of the
        /// V1companiesResponseCompaniesItemTimezone class.
        /// </summary>
        public V1companiesResponseCompaniesItemTimezone()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1companiesResponseCompaniesItemTimezone(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
