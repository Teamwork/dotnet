...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class ContactsjsonCreatedResponseContactAvatar
    {
        /// <summary>
        /// Initializes a new instance of the
        /// ContactsjsonCreatedResponseContactAvatar class.
        /// </summary>
        public ContactsjsonCreatedResponseContactAvatar()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public ContactsjsonCreatedResponseContactAvatar(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
