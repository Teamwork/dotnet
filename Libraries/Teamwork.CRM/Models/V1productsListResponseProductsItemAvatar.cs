...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1productsListResponseProductsItemAvatar
    {
        /// <summary>
        /// Initializes a new instance of the
        /// V1productsListResponseProductsItemAvatar class.
        /// </summary>
        public V1productsListResponseProductsItemAvatar()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1productsListResponseProductsItemAvatar(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
