...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class IdjsonOKResponseCustomFilterCreatedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// IdjsonOKResponseCustomFilterCreatedBy class.
        /// </summary>
        public IdjsonOKResponseCustomFilterCreatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public IdjsonOKResponseCustomFilterCreatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
