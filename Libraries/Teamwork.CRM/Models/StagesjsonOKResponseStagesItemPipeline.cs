...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class StagesjsonOKResponseStagesItemPipeline
    {
        /// <summary>
        /// Initializes a new instance of the
        /// StagesjsonOKResponseStagesItemPipeline class.
        /// </summary>
        public StagesjsonOKResponseStagesItemPipeline()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public StagesjsonOKResponseStagesItemPipeline(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
