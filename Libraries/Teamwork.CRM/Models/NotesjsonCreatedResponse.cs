...
namespace Teamwork.CRM.Models
{
    ...
    /// noteResponse
    /// </summary>
    public partial class NotesjsonCreatedResponse
    {
        /// <summary>
        /// Initializes a new instance of the NotesjsonCreatedResponse class.
        /// </summary>
        public NotesjsonCreatedResponse()
        {
            CustomInit();
        }
        ...
        public NotesjsonCreatedResponse(object included = default(object), NotesjsonCreatedResponseNote note = default(NotesjsonCreatedResponseNote))
        {
            Included = included;
            Note = note;
            CustomInit();
        ...
        public NotesjsonCreatedResponseNote Note { get; set; }
