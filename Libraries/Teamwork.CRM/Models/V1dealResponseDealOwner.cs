...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1dealResponseDealOwner
    {
        /// <summary>
        /// Initializes a new instance of the V1dealResponseDealOwner class.
        /// </summary>
        public V1dealResponseDealOwner()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1dealResponseDealOwner(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
