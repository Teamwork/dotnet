...
namespace Teamwork.CRM.Models
{
    ...
    public partial class CustomFiltersjsonNotFoundResponseErrorsItem
    {
        /// <summary>
        /// Initializes a new instance of the
        /// CustomFiltersjsonNotFoundResponseErrorsItem class.
        /// </summary>
        public CustomFiltersjsonNotFoundResponseErrorsItem()
        {
            CustomInit();
        }
        ...
        public CustomFiltersjsonNotFoundResponseErrorsItem(string code = default(string), string detail = default(string), string id = default(string), string title = default(string))
        {
            Code = code;
            Detail = detail;
            Id = id;
