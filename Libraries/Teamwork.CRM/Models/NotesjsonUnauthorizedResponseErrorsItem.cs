...
namespace Teamwork.CRM.Models
{
    ...
    public partial class NotesjsonUnauthorizedResponseErrorsItem
    {
        /// <summary>
        /// Initializes a new instance of the
        /// NotesjsonUnauthorizedResponseErrorsItem class.
        /// </summary>
        public NotesjsonUnauthorizedResponseErrorsItem()
        {
            CustomInit();
        }
        ...
        public NotesjsonUnauthorizedResponseErrorsItem(string code = default(string), string detail = default(string), string id = default(string), string title = default(string))
        {
            Code = code;
            Detail = detail;
            Id = id;
