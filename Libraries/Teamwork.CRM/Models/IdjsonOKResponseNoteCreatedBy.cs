...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class IdjsonOKResponseNoteCreatedBy
    {
        /// <summary>
        /// Initializes a new instance of the IdjsonOKResponseNoteCreatedBy
        /// class.
        /// </summary>
        public IdjsonOKResponseNoteCreatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public IdjsonOKResponseNoteCreatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
