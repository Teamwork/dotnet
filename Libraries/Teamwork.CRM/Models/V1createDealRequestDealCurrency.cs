...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1createDealRequestDealCurrency
    {
        /// <summary>
        /// Initializes a new instance of the V1createDealRequestDealCurrency
        /// class.
        /// </summary>
        public V1createDealRequestDealCurrency()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1createDealRequestDealCurrency(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
