...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class CustomFiltersjsonCreatedResponseCustomFilterUpdatedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// CustomFiltersjsonCreatedResponseCustomFilterUpdatedBy class.
        /// </summary>
        public CustomFiltersjsonCreatedResponseCustomFilterUpdatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public CustomFiltersjsonCreatedResponseCustomFilterUpdatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
