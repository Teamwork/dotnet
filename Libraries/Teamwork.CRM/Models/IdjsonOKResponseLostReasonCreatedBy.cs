...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class IdjsonOKResponseLostReasonCreatedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// IdjsonOKResponseLostReasonCreatedBy class.
        /// </summary>
        public IdjsonOKResponseLostReasonCreatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public IdjsonOKResponseLostReasonCreatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
