...
namespace Teamwork.CRM.Models
{
    ...
    /// </remarks>
    public partial class NotesjsonCreatedResponseNote
    {
        /// <summary>
        /// Initializes a new instance of the NotesjsonCreatedResponseNote
        /// class.
        /// </summary>
        public NotesjsonCreatedResponseNote()
        {
            CustomInit();
        }
        ...
        /// object](https://crmdev-teamwork.docs.stoplight.io/documentation/general/entity-models#relationships)
        /// which describes a relationship to another entity.</param>
        public NotesjsonCreatedResponseNote(string subject, System.DateTime? createdAt = default(System.DateTime?), NotesjsonCreatedResponseNoteCreatedBy createdBy = default(NotesjsonCreatedResponseNoteCreatedBy), System.DateTime? deletedAt = default(System.DateTime?), NotesjsonCreatedResponseNoteDeletedBy deletedBy = default(NotesjsonCreatedResponseNoteDeletedBy), string description = default(string), int? id = default(int?), bool? isPinned = default(bool?), System.DateTime? updatedAt = default(System.DateTime?), NotesjsonCreatedResponseNoteUpdatedBy updatedBy = default(NotesjsonCreatedResponseNoteUpdatedBy), int? updatedSourceId = default(int?))
        {
            CreatedAt = createdAt;
            CreatedBy = createdBy;
            DeletedAt = deletedAt;
        ...
        public NotesjsonCreatedResponseNoteCreatedBy CreatedBy { get; set; }
        ...
        public NotesjsonCreatedResponseNoteDeletedBy DeletedBy { get; set; }
        ...
        public NotesjsonCreatedResponseNoteUpdatedBy UpdatedBy { get; set; }
