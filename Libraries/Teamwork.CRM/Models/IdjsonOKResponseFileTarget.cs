...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class IdjsonOKResponseFileTarget
    {
        /// <summary>
        /// Initializes a new instance of the IdjsonOKResponseFileTarget class.
        /// </summary>
        public IdjsonOKResponseFileTarget()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public IdjsonOKResponseFileTarget(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
