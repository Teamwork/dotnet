...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1LostReasonResponseLostReasonCreatedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// V1LostReasonResponseLostReasonCreatedBy class.
        /// </summary>
        public V1LostReasonResponseLostReasonCreatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1LostReasonResponseLostReasonCreatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
