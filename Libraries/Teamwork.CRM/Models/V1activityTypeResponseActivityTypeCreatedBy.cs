...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1activityTypeResponseActivityTypeCreatedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// V1activityTypeResponseActivityTypeCreatedBy class.
        /// </summary>
        public V1activityTypeResponseActivityTypeCreatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1activityTypeResponseActivityTypeCreatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
