...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1dealResponseDealUpdatedBy
    {
        /// <summary>
        /// Initializes a new instance of the V1dealResponseDealUpdatedBy
        /// class.
        /// </summary>
        public V1dealResponseDealUpdatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1dealResponseDealUpdatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
