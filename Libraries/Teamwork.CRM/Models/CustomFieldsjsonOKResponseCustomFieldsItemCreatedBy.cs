...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class CustomFieldsjsonOKResponseCustomFieldsItemCreatedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// CustomFieldsjsonOKResponseCustomFieldsItemCreatedBy class.
        /// </summary>
        public CustomFieldsjsonOKResponseCustomFieldsItemCreatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public CustomFieldsjsonOKResponseCustomFieldsItemCreatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
