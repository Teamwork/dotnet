...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1productsListResponseProductsItemUpdatedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// V1productsListResponseProductsItemUpdatedBy class.
        /// </summary>
        public V1productsListResponseProductsItemUpdatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1productsListResponseProductsItemUpdatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
