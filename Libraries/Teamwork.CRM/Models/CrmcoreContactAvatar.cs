...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class CrmcoreContactAvatar
    {
        /// <summary>
        /// Initializes a new instance of the CrmcoreContactAvatar class.
        /// </summary>
        public CrmcoreContactAvatar()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public CrmcoreContactAvatar(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
