...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class IdjsonOKResponseNoteUpdatedBy
    {
        /// <summary>
        /// Initializes a new instance of the IdjsonOKResponseNoteUpdatedBy
        /// class.
        /// </summary>
        public IdjsonOKResponseNoteUpdatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public IdjsonOKResponseNoteUpdatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
