...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1contactsListResponseContactsItemDeletedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// V1contactsListResponseContactsItemDeletedBy class.
        /// </summary>
        public V1contactsListResponseContactsItemDeletedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1contactsListResponseContactsItemDeletedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
