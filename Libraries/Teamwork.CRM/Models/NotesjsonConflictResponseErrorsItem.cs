...
namespace Teamwork.CRM.Models
{
    ...
    public partial class NotesjsonConflictResponseErrorsItem
    {
        /// <summary>
        /// Initializes a new instance of the
        /// NotesjsonConflictResponseErrorsItem class.
        /// </summary>
        public NotesjsonConflictResponseErrorsItem()
        {
            CustomInit();
        }
        ...
        public NotesjsonConflictResponseErrorsItem(string code = default(string), string detail = default(string), string id = default(string), string title = default(string))
        {
            Code = code;
            Detail = detail;
            Id = id;
