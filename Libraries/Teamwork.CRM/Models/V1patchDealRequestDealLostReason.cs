...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1patchDealRequestDealLostReason
    {
        /// <summary>
        /// Initializes a new instance of the V1patchDealRequestDealLostReason
        /// class.
        /// </summary>
        public V1patchDealRequestDealLostReason()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1patchDealRequestDealLostReason(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
