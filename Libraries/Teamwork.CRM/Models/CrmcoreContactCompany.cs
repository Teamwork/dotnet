...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class CrmcoreContactCompany
    {
        /// <summary>
        /// Initializes a new instance of the CrmcoreContactCompany class.
        /// </summary>
        public CrmcoreContactCompany()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public CrmcoreContactCompany(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
