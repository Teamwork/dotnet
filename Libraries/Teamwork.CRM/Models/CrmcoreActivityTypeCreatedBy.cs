...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class CrmcoreActivityTypeCreatedBy
    {
        /// <summary>
        /// Initializes a new instance of the CrmcoreActivityTypeCreatedBy
        /// class.
        /// </summary>
        public CrmcoreActivityTypeCreatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public CrmcoreActivityTypeCreatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
