...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class UsersjsonOKResponseUsersItemUpdatedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// UsersjsonOKResponseUsersItemUpdatedBy class.
        /// </summary>
        public UsersjsonOKResponseUsersItemUpdatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public UsersjsonOKResponseUsersItemUpdatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
