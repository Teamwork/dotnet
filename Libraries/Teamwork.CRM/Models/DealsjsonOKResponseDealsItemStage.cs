...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class DealsjsonOKResponseDealsItemStage
    {
        /// <summary>
        /// Initializes a new instance of the DealsjsonOKResponseDealsItemStage
        /// class.
        /// </summary>
        public DealsjsonOKResponseDealsItemStage()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public DealsjsonOKResponseDealsItemStage(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
