...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class CrmcoreCompanyCountry
    {
        /// <summary>
        /// Initializes a new instance of the CrmcoreCompanyCountry class.
        /// </summary>
        public CrmcoreCompanyCountry()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public CrmcoreCompanyCountry(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
