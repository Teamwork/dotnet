...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1ImportsListResponseImportsItemCreator
    {
        /// <summary>
        /// Initializes a new instance of the
        /// V1ImportsListResponseImportsItemCreator class.
        /// </summary>
        public V1ImportsListResponseImportsItemCreator()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1ImportsListResponseImportsItemCreator(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
