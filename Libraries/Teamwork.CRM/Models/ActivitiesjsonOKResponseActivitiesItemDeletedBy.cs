...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class ActivitiesjsonOKResponseActivitiesItemDeletedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// ActivitiesjsonOKResponseActivitiesItemDeletedBy class.
        /// </summary>
        public ActivitiesjsonOKResponseActivitiesItemDeletedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public ActivitiesjsonOKResponseActivitiesItemDeletedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
