...
namespace Teamwork.CRM.Models
{
    ...
    public partial class SearchjsonNotFoundResponseErrorsItem
    {
        /// <summary>
        /// Initializes a new instance of the
        /// SearchjsonNotFoundResponseErrorsItem class.
        /// </summary>
        public SearchjsonNotFoundResponseErrorsItem()
        {
            CustomInit();
        }
        ...
        public SearchjsonNotFoundResponseErrorsItem(string code = default(string), string detail = default(string), string id = default(string), string title = default(string))
        {
            Code = code;
            Detail = detail;
            Id = id;
