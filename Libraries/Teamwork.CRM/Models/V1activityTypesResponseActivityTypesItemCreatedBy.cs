...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1activityTypesResponseActivityTypesItemCreatedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// V1activityTypesResponseActivityTypesItemCreatedBy class.
        /// </summary>
        public V1activityTypesResponseActivityTypesItemCreatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1activityTypesResponseActivityTypesItemCreatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
