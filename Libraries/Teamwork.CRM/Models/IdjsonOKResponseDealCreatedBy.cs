...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class IdjsonOKResponseDealCreatedBy
    {
        /// <summary>
        /// Initializes a new instance of the IdjsonOKResponseDealCreatedBy
        /// class.
        /// </summary>
        public IdjsonOKResponseDealCreatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public IdjsonOKResponseDealCreatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
