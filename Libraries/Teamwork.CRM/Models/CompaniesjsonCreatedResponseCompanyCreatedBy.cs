...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class CompaniesjsonCreatedResponseCompanyCreatedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// CompaniesjsonCreatedResponseCompanyCreatedBy class.
        /// </summary>
        public CompaniesjsonCreatedResponseCompanyCreatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public CompaniesjsonCreatedResponseCompanyCreatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
