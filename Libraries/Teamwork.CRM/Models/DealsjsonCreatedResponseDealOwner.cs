...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class DealsjsonCreatedResponseDealOwner
    {
        /// <summary>
        /// Initializes a new instance of the DealsjsonCreatedResponseDealOwner
        /// class.
        /// </summary>
        public DealsjsonCreatedResponseDealOwner()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public DealsjsonCreatedResponseDealOwner(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
