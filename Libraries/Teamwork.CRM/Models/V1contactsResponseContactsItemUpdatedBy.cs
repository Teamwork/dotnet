...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1contactsResponseContactsItemUpdatedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// V1contactsResponseContactsItemUpdatedBy class.
        /// </summary>
        public V1contactsResponseContactsItemUpdatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1contactsResponseContactsItemUpdatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
