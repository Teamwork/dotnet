...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1createProductRequestProductOwner
    {
        /// <summary>
        /// Initializes a new instance of the
        /// V1createProductRequestProductOwner class.
        /// </summary>
        public V1createProductRequestProductOwner()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1createProductRequestProductOwner(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
