...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1activitiesResponseActivitiesItemDeletedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// V1activitiesResponseActivitiesItemDeletedBy class.
        /// </summary>
        public V1activitiesResponseActivitiesItemDeletedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1activitiesResponseActivitiesItemDeletedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
