...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class IdjsonOKResponseFileCreatedBy
    {
        /// <summary>
        /// Initializes a new instance of the IdjsonOKResponseFileCreatedBy
        /// class.
        /// </summary>
        public IdjsonOKResponseFileCreatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public IdjsonOKResponseFileCreatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
