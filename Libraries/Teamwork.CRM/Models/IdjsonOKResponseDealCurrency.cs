...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class IdjsonOKResponseDealCurrency
    {
        /// <summary>
        /// Initializes a new instance of the IdjsonOKResponseDealCurrency
        /// class.
        /// </summary>
        public IdjsonOKResponseDealCurrency()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public IdjsonOKResponseDealCurrency(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
