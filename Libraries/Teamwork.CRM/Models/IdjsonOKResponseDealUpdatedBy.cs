...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class IdjsonOKResponseDealUpdatedBy
    {
        /// <summary>
        /// Initializes a new instance of the IdjsonOKResponseDealUpdatedBy
        /// class.
        /// </summary>
        public IdjsonOKResponseDealUpdatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public IdjsonOKResponseDealUpdatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
