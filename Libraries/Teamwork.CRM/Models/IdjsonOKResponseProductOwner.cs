...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class IdjsonOKResponseProductOwner
    {
        /// <summary>
        /// Initializes a new instance of the IdjsonOKResponseProductOwner
        /// class.
        /// </summary>
        public IdjsonOKResponseProductOwner()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public IdjsonOKResponseProductOwner(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
