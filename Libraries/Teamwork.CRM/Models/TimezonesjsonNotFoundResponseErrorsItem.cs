...
namespace Teamwork.CRM.Models
{
    ...
    public partial class TimezonesjsonNotFoundResponseErrorsItem
    {
        /// <summary>
        /// Initializes a new instance of the
        /// TimezonesjsonNotFoundResponseErrorsItem class.
        /// </summary>
        public TimezonesjsonNotFoundResponseErrorsItem()
        {
            CustomInit();
        }
        ...
        public TimezonesjsonNotFoundResponseErrorsItem(string code = default(string), string detail = default(string), string id = default(string), string title = default(string))
        {
            Code = code;
            Detail = detail;
            Id = id;
