...
namespace Teamwork.CRM.Models
{
    ...
    public partial class PhoneCodesjsonBadRequestResponseErrorsItem
    {
        /// <summary>
        /// Initializes a new instance of the
        /// PhoneCodesjsonBadRequestResponseErrorsItem class.
        /// </summary>
        public PhoneCodesjsonBadRequestResponseErrorsItem()
        {
            CustomInit();
        }
        ...
        public PhoneCodesjsonBadRequestResponseErrorsItem(string code = default(string), string detail = default(string), string id = default(string), string title = default(string))
        {
            Code = code;
            Detail = detail;
            Id = id;
