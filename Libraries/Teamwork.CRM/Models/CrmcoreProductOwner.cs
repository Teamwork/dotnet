...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class CrmcoreProductOwner
    {
        /// <summary>
        /// Initializes a new instance of the CrmcoreProductOwner class.
        /// </summary>
        public CrmcoreProductOwner()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public CrmcoreProductOwner(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
