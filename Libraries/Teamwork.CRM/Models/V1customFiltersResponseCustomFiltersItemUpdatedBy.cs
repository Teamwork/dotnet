...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1customFiltersResponseCustomFiltersItemUpdatedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// V1customFiltersResponseCustomFiltersItemUpdatedBy class.
        /// </summary>
        public V1customFiltersResponseCustomFiltersItemUpdatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1customFiltersResponseCustomFiltersItemUpdatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
