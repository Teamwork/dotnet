...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class CrmcoreImportHistoryCreator
    {
        /// <summary>
        /// Initializes a new instance of the CrmcoreImportHistoryCreator
        /// class.
        /// </summary>
        public CrmcoreImportHistoryCreator()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public CrmcoreImportHistoryCreator(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
