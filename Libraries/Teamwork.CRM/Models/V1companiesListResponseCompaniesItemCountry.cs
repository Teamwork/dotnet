...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1companiesListResponseCompaniesItemCountry
    {
        /// <summary>
        /// Initializes a new instance of the
        /// V1companiesListResponseCompaniesItemCountry class.
        /// </summary>
        public V1companiesListResponseCompaniesItemCountry()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1companiesListResponseCompaniesItemCountry(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
