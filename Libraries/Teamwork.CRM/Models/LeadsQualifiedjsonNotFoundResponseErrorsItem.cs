...
namespace Teamwork.CRM.Models
{
    ...
    public partial class LeadsQualifiedjsonNotFoundResponseErrorsItem
    {
        /// <summary>
        /// Initializes a new instance of the
        /// LeadsQualifiedjsonNotFoundResponseErrorsItem class.
        /// </summary>
        public LeadsQualifiedjsonNotFoundResponseErrorsItem()
        {
            CustomInit();
        }
        ...
        public LeadsQualifiedjsonNotFoundResponseErrorsItem(string code = default(string), string detail = default(string), string id = default(string), string title = default(string))
        {
            Code = code;
            Detail = detail;
            Id = id;
