...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1companiesResponseCompaniesItemCustomItemDeletedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// V1companiesResponseCompaniesItemCustomItemDeletedBy class.
        /// </summary>
        public V1companiesResponseCompaniesItemCustomItemDeletedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1companiesResponseCompaniesItemCustomItemDeletedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
