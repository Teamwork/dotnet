...
namespace Teamwork.CRM.Models
{
    ...
    /// activityResponse
    /// </summary>
    public partial class IdjsonOKResponse
    {
        /// <summary>
        /// Initializes a new instance of the IdjsonOKResponse class.
        /// </summary>
        public IdjsonOKResponse()
        {
            CustomInit();
        }
        ...
        public IdjsonOKResponse(IdjsonOKResponseActivity activity = default(IdjsonOKResponseActivity), object included = default(object))
        {
            Activity = activity;
            Included = included;
            CustomInit();
        ...
        public IdjsonOKResponseActivity Activity { get; set; }
