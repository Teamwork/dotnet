...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1PipelineResponsePipelineCreatedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// V1PipelineResponsePipelineCreatedBy class.
        /// </summary>
        public V1PipelineResponsePipelineCreatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1PipelineResponsePipelineCreatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
