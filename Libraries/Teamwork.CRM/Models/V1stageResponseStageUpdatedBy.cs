...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1stageResponseStageUpdatedBy
    {
        /// <summary>
        /// Initializes a new instance of the V1stageResponseStageUpdatedBy
        /// class.
        /// </summary>
        public V1stageResponseStageUpdatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1stageResponseStageUpdatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
