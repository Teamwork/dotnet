...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class CrmcoreCustomFieldCreatedBy
    {
        /// <summary>
        /// Initializes a new instance of the CrmcoreCustomFieldCreatedBy
        /// class.
        /// </summary>
        public CrmcoreCustomFieldCreatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public CrmcoreCustomFieldCreatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
