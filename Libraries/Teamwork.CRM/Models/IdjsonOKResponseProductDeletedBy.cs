...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class IdjsonOKResponseProductDeletedBy
    {
        /// <summary>
        /// Initializes a new instance of the IdjsonOKResponseProductDeletedBy
        /// class.
        /// </summary>
        public IdjsonOKResponseProductDeletedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public IdjsonOKResponseProductDeletedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
