...
namespace Teamwork.CRM.Models
{
    ...
    /// </remarks>
    public partial class CrmcoreCustomField
    {
        /// <summary>
        /// Initializes a new instance of the CrmcoreCustomField class.
        /// </summary>
        public CrmcoreCustomField()
        {
            CustomInit();
        }
        ...
        /// object](https://crmdev-teamwork.docs.stoplight.io/documentation/general/entity-models#relationships)
        /// which describes a relationship to another entity.</param>
        public CrmcoreCustomField(System.DateTime? createdAt = default(System.DateTime?), CrmcoreCustomFieldCreatedBy createdBy = default(CrmcoreCustomFieldCreatedBy), System.DateTime? deletedAt = default(System.DateTime?), CrmcoreCustomFieldDeletedBy deletedBy = default(CrmcoreCustomFieldDeletedBy), string fieldType = default(string), int? id = default(int?), bool? isMandatory = default(bool?), bool? isShownWhenAdding = default(bool?), string key = default(string), string kind = default(string), string name = default(string), IList<string> options = default(IList<string>), System.DateTime? updatedAt = default(System.DateTime?), CrmcoreCustomFieldUpdatedBy updatedBy = default(CrmcoreCustomFieldUpdatedBy), int? updatedSourceId = default(int?))
        {
            CreatedAt = createdAt;
            CreatedBy = createdBy;
            DeletedAt = deletedAt;
        ...
        public CrmcoreCustomFieldCreatedBy CreatedBy { get; set; }
        ...
        public CrmcoreCustomFieldDeletedBy DeletedBy { get; set; }
        ...
        public CrmcoreCustomFieldUpdatedBy UpdatedBy { get; set; }
