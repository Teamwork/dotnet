...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1activityTypesResponseActivityTypesItemUpdatedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// V1activityTypesResponseActivityTypesItemUpdatedBy class.
        /// </summary>
        public V1activityTypesResponseActivityTypesItemUpdatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1activityTypesResponseActivityTypesItemUpdatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
