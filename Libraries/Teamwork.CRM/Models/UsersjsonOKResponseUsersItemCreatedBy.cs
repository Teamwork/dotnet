...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class UsersjsonOKResponseUsersItemCreatedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// UsersjsonOKResponseUsersItemCreatedBy class.
        /// </summary>
        public UsersjsonOKResponseUsersItemCreatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public UsersjsonOKResponseUsersItemCreatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
