...
namespace Teamwork.CRM.Models
{
    ...
    public partial class ActivitiesjsonUnauthorizedResponseErrorsItem
    {
        /// <summary>
        /// Initializes a new instance of the
        /// ActivitiesjsonUnauthorizedResponseErrorsItem class.
        /// </summary>
        public ActivitiesjsonUnauthorizedResponseErrorsItem()
        {
            CustomInit();
        }
        ...
        public ActivitiesjsonUnauthorizedResponseErrorsItem(string code = default(string), string detail = default(string), string id = default(string), string title = default(string))
        {
            Code = code;
            Detail = detail;
            Id = id;
