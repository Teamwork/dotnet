...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class CrmcorePipelineCreatedBy
    {
        /// <summary>
        /// Initializes a new instance of the CrmcorePipelineCreatedBy class.
        /// </summary>
        public CrmcorePipelineCreatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public CrmcorePipelineCreatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
