...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1contactsListResponseContactsItemCountry
    {
        /// <summary>
        /// Initializes a new instance of the
        /// V1contactsListResponseContactsItemCountry class.
        /// </summary>
        public V1contactsListResponseContactsItemCountry()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1contactsListResponseContactsItemCountry(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
