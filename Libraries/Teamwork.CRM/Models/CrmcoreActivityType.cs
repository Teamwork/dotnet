...
namespace Teamwork.CRM.Models
{
    ...
    /// </remarks>
    public partial class CrmcoreActivityType
    {
        /// <summary>
        /// Initializes a new instance of the CrmcoreActivityType class.
        /// </summary>
        public CrmcoreActivityType()
        {
            CustomInit();
        }
        ...
        /// object](https://crmdev-teamwork.docs.stoplight.io/documentation/general/entity-models#relationships)
        /// which describes a relationship to another entity.</param>
        public CrmcoreActivityType(System.DateTime? createdAt = default(System.DateTime?), CrmcoreActivityTypeCreatedBy createdBy = default(CrmcoreActivityTypeCreatedBy), System.DateTime? deletedAt = default(System.DateTime?), CrmcoreActivityTypeDeletedBy deletedBy = default(CrmcoreActivityTypeDeletedBy), string icon = default(string), int? id = default(int?), bool? isEnabled = default(bool?), string name = default(string), int? orderIndex = default(int?), System.DateTime? updatedAt = default(System.DateTime?), CrmcoreActivityTypeUpdatedBy updatedBy = default(CrmcoreActivityTypeUpdatedBy), int? updatedSourceId = default(int?))
        {
            CreatedAt = createdAt;
            CreatedBy = createdBy;
            DeletedAt = deletedAt;
        ...
        public CrmcoreActivityTypeCreatedBy CreatedBy { get; set; }
        ...
        public CrmcoreActivityTypeDeletedBy DeletedBy { get; set; }
        ...
        public CrmcoreActivityTypeUpdatedBy UpdatedBy { get; set; }
