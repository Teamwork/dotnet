...
namespace Teamwork.CRM.Models
{
    ...
    public partial class IdjsonOKResponseCompanyPhoneNumbers
    {
        /// <summary>
        /// Initializes a new instance of the
        /// IdjsonOKResponseCompanyPhoneNumbers class.
        /// </summary>
        public IdjsonOKResponseCompanyPhoneNumbers()
        {
            CustomInit();
        }
        ...
        public IdjsonOKResponseCompanyPhoneNumbers(IdjsonOKResponseCompanyPhoneNumbersCode code = default(IdjsonOKResponseCompanyPhoneNumbersCode), string number = default(string))
        {
            Code = code;
            Number = number;
            CustomInit();
        ...
        public IdjsonOKResponseCompanyPhoneNumbersCode Code { get; set; }
