...
namespace Teamwork.CRM.Models
{
    ...
    public partial class CurrenciesjsonBadRequestResponseErrorsItem
    {
        /// <summary>
        /// Initializes a new instance of the
        /// CurrenciesjsonBadRequestResponseErrorsItem class.
        /// </summary>
        public CurrenciesjsonBadRequestResponseErrorsItem()
        {
            CustomInit();
        }
        ...
        public CurrenciesjsonBadRequestResponseErrorsItem(string code = default(string), string detail = default(string), string id = default(string), string title = default(string))
        {
            Code = code;
            Detail = detail;
            Id = id;
