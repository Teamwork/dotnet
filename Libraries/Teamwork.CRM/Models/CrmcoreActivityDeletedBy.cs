...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class CrmcoreActivityDeletedBy
    {
        /// <summary>
        /// Initializes a new instance of the CrmcoreActivityDeletedBy class.
        /// </summary>
        public CrmcoreActivityDeletedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public CrmcoreActivityDeletedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
