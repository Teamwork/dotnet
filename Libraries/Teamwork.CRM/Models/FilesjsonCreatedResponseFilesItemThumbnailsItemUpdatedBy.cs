...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class FilesjsonCreatedResponseFilesItemThumbnailsItemUpdatedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// FilesjsonCreatedResponseFilesItemThumbnailsItemUpdatedBy class.
        /// </summary>
        public FilesjsonCreatedResponseFilesItemThumbnailsItemUpdatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public FilesjsonCreatedResponseFilesItemThumbnailsItemUpdatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
