...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class ProductsjsonCreatedResponseProductCreatedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// ProductsjsonCreatedResponseProductCreatedBy class.
        /// </summary>
        public ProductsjsonCreatedResponseProductCreatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public ProductsjsonCreatedResponseProductCreatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
