...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class NotesjsonCreatedResponseNoteDeletedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// NotesjsonCreatedResponseNoteDeletedBy class.
        /// </summary>
        public NotesjsonCreatedResponseNoteDeletedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public NotesjsonCreatedResponseNoteDeletedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
