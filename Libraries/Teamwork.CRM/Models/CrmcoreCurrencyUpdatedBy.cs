...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class CrmcoreCurrencyUpdatedBy
    {
        /// <summary>
        /// Initializes a new instance of the CrmcoreCurrencyUpdatedBy class.
        /// </summary>
        public CrmcoreCurrencyUpdatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public CrmcoreCurrencyUpdatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
