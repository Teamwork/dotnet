...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class FilesjsonOKResponseFilesItemTarget
    {
        /// <summary>
        /// Initializes a new instance of the
        /// FilesjsonOKResponseFilesItemTarget class.
        /// </summary>
        public FilesjsonOKResponseFilesItemTarget()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public FilesjsonOKResponseFilesItemTarget(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
