...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1fileResponseFileThumbnailsItemUpdatedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// V1fileResponseFileThumbnailsItemUpdatedBy class.
        /// </summary>
        public V1fileResponseFileThumbnailsItemUpdatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1fileResponseFileThumbnailsItemUpdatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
