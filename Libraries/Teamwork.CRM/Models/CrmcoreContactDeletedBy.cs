...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class CrmcoreContactDeletedBy
    {
        /// <summary>
        /// Initializes a new instance of the CrmcoreContactDeletedBy class.
        /// </summary>
        public CrmcoreContactDeletedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public CrmcoreContactDeletedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
