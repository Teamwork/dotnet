...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1exportResponseExportCreatedBy
    {
        /// <summary>
        /// Initializes a new instance of the V1exportResponseExportCreatedBy
        /// class.
        /// </summary>
        public V1exportResponseExportCreatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1exportResponseExportCreatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
