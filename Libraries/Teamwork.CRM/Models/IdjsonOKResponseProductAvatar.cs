...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class IdjsonOKResponseProductAvatar
    {
        /// <summary>
        /// Initializes a new instance of the IdjsonOKResponseProductAvatar
        /// class.
        /// </summary>
        public IdjsonOKResponseProductAvatar()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public IdjsonOKResponseProductAvatar(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
