...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class StagesjsonCreatedResponseStageUpdatedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// StagesjsonCreatedResponseStageUpdatedBy class.
        /// </summary>
        public StagesjsonCreatedResponseStageUpdatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public StagesjsonCreatedResponseStageUpdatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
