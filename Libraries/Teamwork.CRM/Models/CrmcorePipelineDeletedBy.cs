...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class CrmcorePipelineDeletedBy
    {
        /// <summary>
        /// Initializes a new instance of the CrmcorePipelineDeletedBy class.
        /// </summary>
        public CrmcorePipelineDeletedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public CrmcorePipelineDeletedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
