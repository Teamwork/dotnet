...
namespace Teamwork.CRM.Models
{
    ...
    public partial class IdjsonConflictResponseErrorsItem
    {
        /// <summary>
        /// Initializes a new instance of the IdjsonConflictResponseErrorsItem
        /// class.
        /// </summary>
        public IdjsonConflictResponseErrorsItem()
        {
            CustomInit();
        }
        ...
        public IdjsonConflictResponseErrorsItem(string code = default(string), string detail = default(string), string id = default(string), string title = default(string))
        {
            Code = code;
            Detail = detail;
            Id = id;
