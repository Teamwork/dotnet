...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class ProductsjsonOKResponseProductsItemDeletedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// ProductsjsonOKResponseProductsItemDeletedBy class.
        /// </summary>
        public ProductsjsonOKResponseProductsItemDeletedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public ProductsjsonOKResponseProductsItemDeletedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
