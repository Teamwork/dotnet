...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1createContactRequestContactOwner
    {
        /// <summary>
        /// Initializes a new instance of the
        /// V1createContactRequestContactOwner class.
        /// </summary>
        public V1createContactRequestContactOwner()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1createContactRequestContactOwner(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
