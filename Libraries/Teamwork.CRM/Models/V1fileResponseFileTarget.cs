...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1fileResponseFileTarget
    {
        /// <summary>
        /// Initializes a new instance of the V1fileResponseFileTarget class.
        /// </summary>
        public V1fileResponseFileTarget()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1fileResponseFileTarget(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
