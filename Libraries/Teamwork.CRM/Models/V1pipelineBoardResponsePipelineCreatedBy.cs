...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1pipelineBoardResponsePipelineCreatedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// V1pipelineBoardResponsePipelineCreatedBy class.
        /// </summary>
        public V1pipelineBoardResponsePipelineCreatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1pipelineBoardResponsePipelineCreatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
