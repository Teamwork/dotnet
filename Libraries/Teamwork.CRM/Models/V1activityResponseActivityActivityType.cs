...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1activityResponseActivityActivityType
    {
        /// <summary>
        /// Initializes a new instance of the
        /// V1activityResponseActivityActivityType class.
        /// </summary>
        public V1activityResponseActivityActivityType()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1activityResponseActivityActivityType(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
