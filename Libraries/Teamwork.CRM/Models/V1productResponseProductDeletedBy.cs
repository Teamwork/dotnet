...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1productResponseProductDeletedBy
    {
        /// <summary>
        /// Initializes a new instance of the V1productResponseProductDeletedBy
        /// class.
        /// </summary>
        public V1productResponseProductDeletedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1productResponseProductDeletedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
