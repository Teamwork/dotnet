...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class CrmcoreDealDeletedBy
    {
        /// <summary>
        /// Initializes a new instance of the CrmcoreDealDeletedBy class.
        /// </summary>
        public CrmcoreDealDeletedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public CrmcoreDealDeletedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
