...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1productResponseProductOwner
    {
        /// <summary>
        /// Initializes a new instance of the V1productResponseProductOwner
        /// class.
        /// </summary>
        public V1productResponseProductOwner()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1productResponseProductOwner(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
