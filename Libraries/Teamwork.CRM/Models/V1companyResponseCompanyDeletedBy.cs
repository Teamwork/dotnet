...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1companyResponseCompanyDeletedBy
    {
        /// <summary>
        /// Initializes a new instance of the V1companyResponseCompanyDeletedBy
        /// class.
        /// </summary>
        public V1companyResponseCompanyDeletedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1companyResponseCompanyDeletedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
