...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class ContactsjsonOKResponseContactsItemCompany
    {
        /// <summary>
        /// Initializes a new instance of the
        /// ContactsjsonOKResponseContactsItemCompany class.
        /// </summary>
        public ContactsjsonOKResponseContactsItemCompany()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public ContactsjsonOKResponseContactsItemCompany(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
