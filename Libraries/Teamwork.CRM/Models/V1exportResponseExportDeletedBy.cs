...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1exportResponseExportDeletedBy
    {
        /// <summary>
        /// Initializes a new instance of the V1exportResponseExportDeletedBy
        /// class.
        /// </summary>
        public V1exportResponseExportDeletedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1exportResponseExportDeletedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
