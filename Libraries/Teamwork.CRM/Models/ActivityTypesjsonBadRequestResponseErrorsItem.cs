...
namespace Teamwork.CRM.Models
{
    ...
    public partial class ActivityTypesjsonBadRequestResponseErrorsItem
    {
        /// <summary>
        /// Initializes a new instance of the
        /// ActivityTypesjsonBadRequestResponseErrorsItem class.
        /// </summary>
        public ActivityTypesjsonBadRequestResponseErrorsItem()
        {
            CustomInit();
        }
        ...
        public ActivityTypesjsonBadRequestResponseErrorsItem(string code = default(string), string detail = default(string), string id = default(string), string title = default(string))
        {
            Code = code;
            Detail = detail;
            Id = id;
