...
namespace Teamwork.CRM.Models
{
    ...
    public partial class CustomFieldsjsonConflictResponseErrorsItem
    {
        /// <summary>
        /// Initializes a new instance of the
        /// CustomFieldsjsonConflictResponseErrorsItem class.
        /// </summary>
        public CustomFieldsjsonConflictResponseErrorsItem()
        {
            CustomInit();
        }
        ...
        public CustomFieldsjsonConflictResponseErrorsItem(string code = default(string), string detail = default(string), string id = default(string), string title = default(string))
        {
            Code = code;
            Detail = detail;
            Id = id;
