...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1dealsListResponseDealsItemCompany
    {
        /// <summary>
        /// Initializes a new instance of the
        /// V1dealsListResponseDealsItemCompany class.
        /// </summary>
        public V1dealsListResponseDealsItemCompany()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1dealsListResponseDealsItemCompany(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
