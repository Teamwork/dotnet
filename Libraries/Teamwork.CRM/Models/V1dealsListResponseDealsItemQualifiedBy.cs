...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1dealsListResponseDealsItemQualifiedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// V1dealsListResponseDealsItemQualifiedBy class.
        /// </summary>
        public V1dealsListResponseDealsItemQualifiedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1dealsListResponseDealsItemQualifiedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
