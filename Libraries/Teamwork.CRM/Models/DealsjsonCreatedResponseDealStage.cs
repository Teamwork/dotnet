...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class DealsjsonCreatedResponseDealStage
    {
        /// <summary>
        /// Initializes a new instance of the DealsjsonCreatedResponseDealStage
        /// class.
        /// </summary>
        public DealsjsonCreatedResponseDealStage()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public DealsjsonCreatedResponseDealStage(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
