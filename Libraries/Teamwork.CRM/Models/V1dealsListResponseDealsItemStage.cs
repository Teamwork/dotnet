...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1dealsListResponseDealsItemStage
    {
        /// <summary>
        /// Initializes a new instance of the V1dealsListResponseDealsItemStage
        /// class.
        /// </summary>
        public V1dealsListResponseDealsItemStage()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1dealsListResponseDealsItemStage(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
