...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1activitiesResponseActivitiesItemCompletedByUser
    {
        /// <summary>
        /// Initializes a new instance of the
        /// V1activitiesResponseActivitiesItemCompletedByUser class.
        /// </summary>
        public V1activitiesResponseActivitiesItemCompletedByUser()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1activitiesResponseActivitiesItemCompletedByUser(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
