...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1companyResponseCompanyCustomItemCreatedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// V1companyResponseCompanyCustomItemCreatedBy class.
        /// </summary>
        public V1companyResponseCompanyCustomItemCreatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1companyResponseCompanyCustomItemCreatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
