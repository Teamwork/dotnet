...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class CrmcoreStagePipeline
    {
        /// <summary>
        /// Initializes a new instance of the CrmcoreStagePipeline class.
        /// </summary>
        public CrmcoreStagePipeline()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public CrmcoreStagePipeline(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
