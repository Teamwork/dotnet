...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1contactResponseContactDeletedBy
    {
        /// <summary>
        /// Initializes a new instance of the V1contactResponseContactDeletedBy
        /// class.
        /// </summary>
        public V1contactResponseContactDeletedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1contactResponseContactDeletedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
