...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1createdFilesResponseFilesItemUpdatedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// V1createdFilesResponseFilesItemUpdatedBy class.
        /// </summary>
        public V1createdFilesResponseFilesItemUpdatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1createdFilesResponseFilesItemUpdatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
