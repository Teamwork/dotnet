...
namespace Teamwork.CRM.Models
{
    ...
    public partial class V1patchContactRequestContactPhoneNumbers
    {
        /// <summary>
        /// Initializes a new instance of the
        /// V1patchContactRequestContactPhoneNumbers class.
        /// </summary>
        public V1patchContactRequestContactPhoneNumbers()
        {
            CustomInit();
        }
        ...
        public V1patchContactRequestContactPhoneNumbers(V1patchContactRequestContactPhoneNumbersCode code = default(V1patchContactRequestContactPhoneNumbersCode), string number = default(string))
        {
            Code = code;
            Number = number;
            CustomInit();
        ...
        public V1patchContactRequestContactPhoneNumbersCode Code { get; set; }
