...
namespace Teamwork.CRM.Models
{
    ...
    public partial class DealsjsonCreatedResponseDealProductsItemMeta
    {
        /// <summary>
        /// Initializes a new instance of the
        /// DealsjsonCreatedResponseDealProductsItemMeta class.
        /// </summary>
        public DealsjsonCreatedResponseDealProductsItemMeta()
        {
            CustomInit();
        }
        ...
        public DealsjsonCreatedResponseDealProductsItemMeta(int price, int quantity, double? discount = default(double?))
        {
            Discount = discount;
            Price = price;
            Quantity = quantity;
