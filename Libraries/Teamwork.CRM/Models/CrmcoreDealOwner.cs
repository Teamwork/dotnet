...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class CrmcoreDealOwner
    {
        /// <summary>
        /// Initializes a new instance of the CrmcoreDealOwner class.
        /// </summary>
        public CrmcoreDealOwner()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public CrmcoreDealOwner(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
