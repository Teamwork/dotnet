...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1contactResponseContactTimezone
    {
        /// <summary>
        /// Initializes a new instance of the V1contactResponseContactTimezone
        /// class.
        /// </summary>
        public V1contactResponseContactTimezone()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1contactResponseContactTimezone(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
