...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1productsListResponseProductsItemDeletedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// V1productsListResponseProductsItemDeletedBy class.
        /// </summary>
        public V1productsListResponseProductsItemDeletedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1productsListResponseProductsItemDeletedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
