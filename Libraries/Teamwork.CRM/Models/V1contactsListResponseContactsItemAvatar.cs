...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1contactsListResponseContactsItemAvatar
    {
        /// <summary>
        /// Initializes a new instance of the
        /// V1contactsListResponseContactsItemAvatar class.
        /// </summary>
        public V1contactsListResponseContactsItemAvatar()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1contactsListResponseContactsItemAvatar(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
