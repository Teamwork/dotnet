...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class CrmcoreActivityActivityType
    {
        /// <summary>
        /// Initializes a new instance of the CrmcoreActivityActivityType
        /// class.
        /// </summary>
        public CrmcoreActivityActivityType()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public CrmcoreActivityActivityType(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
