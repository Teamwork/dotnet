...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1stageResponseStageDeletedBy
    {
        /// <summary>
        /// Initializes a new instance of the V1stageResponseStageDeletedBy
        /// class.
        /// </summary>
        public V1stageResponseStageDeletedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1stageResponseStageDeletedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
