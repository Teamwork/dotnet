...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class CrmcoreDealCompany
    {
        /// <summary>
        /// Initializes a new instance of the CrmcoreDealCompany class.
        /// </summary>
        public CrmcoreDealCompany()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public CrmcoreDealCompany(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
