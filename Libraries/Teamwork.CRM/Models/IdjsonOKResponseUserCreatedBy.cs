...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class IdjsonOKResponseUserCreatedBy
    {
        /// <summary>
        /// Initializes a new instance of the IdjsonOKResponseUserCreatedBy
        /// class.
        /// </summary>
        public IdjsonOKResponseUserCreatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public IdjsonOKResponseUserCreatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
