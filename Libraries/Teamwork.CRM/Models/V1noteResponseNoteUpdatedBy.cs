...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1noteResponseNoteUpdatedBy
    {
        /// <summary>
        /// Initializes a new instance of the V1noteResponseNoteUpdatedBy
        /// class.
        /// </summary>
        public V1noteResponseNoteUpdatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1noteResponseNoteUpdatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
