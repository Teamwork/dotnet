...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class CrmcoreCompanyCustomItemUpdatedBy
    {
        /// <summary>
        /// Initializes a new instance of the CrmcoreCompanyCustomItemUpdatedBy
        /// class.
        /// </summary>
        public CrmcoreCompanyCustomItemUpdatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public CrmcoreCompanyCustomItemUpdatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
