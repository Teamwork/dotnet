...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1patchContactRequestContactCountry
    {
        /// <summary>
        /// Initializes a new instance of the
        /// V1patchContactRequestContactCountry class.
        /// </summary>
        public V1patchContactRequestContactCountry()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1patchContactRequestContactCountry(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
