...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1usersResponseUsersItemDeletedBy
    {
        /// <summary>
        /// Initializes a new instance of the V1usersResponseUsersItemDeletedBy
        /// class.
        /// </summary>
        public V1usersResponseUsersItemDeletedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1usersResponseUsersItemDeletedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
