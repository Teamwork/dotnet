...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class CrmcoreCompanyCreatedBy
    {
        /// <summary>
        /// Initializes a new instance of the CrmcoreCompanyCreatedBy class.
        /// </summary>
        public CrmcoreCompanyCreatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public CrmcoreCompanyCreatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
