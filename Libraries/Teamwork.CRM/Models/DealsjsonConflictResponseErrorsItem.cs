...
namespace Teamwork.CRM.Models
{
    ...
    public partial class DealsjsonConflictResponseErrorsItem
    {
        /// <summary>
        /// Initializes a new instance of the
        /// DealsjsonConflictResponseErrorsItem class.
        /// </summary>
        public DealsjsonConflictResponseErrorsItem()
        {
            CustomInit();
        }
        ...
        public DealsjsonConflictResponseErrorsItem(string code = default(string), string detail = default(string), string id = default(string), string title = default(string))
        {
            Code = code;
            Detail = detail;
            Id = id;
