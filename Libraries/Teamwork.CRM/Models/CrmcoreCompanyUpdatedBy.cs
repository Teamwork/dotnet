...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class CrmcoreCompanyUpdatedBy
    {
        /// <summary>
        /// Initializes a new instance of the CrmcoreCompanyUpdatedBy class.
        /// </summary>
        public CrmcoreCompanyUpdatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public CrmcoreCompanyUpdatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
