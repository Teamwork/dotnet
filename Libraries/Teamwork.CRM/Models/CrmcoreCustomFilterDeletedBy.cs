...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class CrmcoreCustomFilterDeletedBy
    {
        /// <summary>
        /// Initializes a new instance of the CrmcoreCustomFilterDeletedBy
        /// class.
        /// </summary>
        public CrmcoreCustomFilterDeletedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public CrmcoreCustomFilterDeletedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
