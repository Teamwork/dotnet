...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class ImportsjsonOKResponseImportsItemCreator
    {
        /// <summary>
        /// Initializes a new instance of the
        /// ImportsjsonOKResponseImportsItemCreator class.
        /// </summary>
        public ImportsjsonOKResponseImportsItemCreator()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public ImportsjsonOKResponseImportsItemCreator(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
