...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1currenciesResponseCurrenciesItemCreatedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// V1currenciesResponseCurrenciesItemCreatedBy class.
        /// </summary>
        public V1currenciesResponseCurrenciesItemCreatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1currenciesResponseCurrenciesItemCreatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
