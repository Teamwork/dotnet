...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class CrmcoreFileThumbnailsItemDeletedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// CrmcoreFileThumbnailsItemDeletedBy class.
        /// </summary>
        public CrmcoreFileThumbnailsItemDeletedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public CrmcoreFileThumbnailsItemDeletedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
