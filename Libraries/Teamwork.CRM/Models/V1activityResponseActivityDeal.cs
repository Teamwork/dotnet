...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1activityResponseActivityDeal
    {
        /// <summary>
        /// Initializes a new instance of the V1activityResponseActivityDeal
        /// class.
        /// </summary>
        public V1activityResponseActivityDeal()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1activityResponseActivityDeal(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
