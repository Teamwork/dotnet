...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1fileResponseFileThumbnailsItemDeletedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// V1fileResponseFileThumbnailsItemDeletedBy class.
        /// </summary>
        public V1fileResponseFileThumbnailsItemDeletedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1fileResponseFileThumbnailsItemDeletedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
