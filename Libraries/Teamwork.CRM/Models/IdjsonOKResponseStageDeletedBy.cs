...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class IdjsonOKResponseStageDeletedBy
    {
        /// <summary>
        /// Initializes a new instance of the IdjsonOKResponseStageDeletedBy
        /// class.
        /// </summary>
        public IdjsonOKResponseStageDeletedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public IdjsonOKResponseStageDeletedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
