...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class DealsjsonCreatedResponseDealCurrency
    {
        /// <summary>
        /// Initializes a new instance of the
        /// DealsjsonCreatedResponseDealCurrency class.
        /// </summary>
        public DealsjsonCreatedResponseDealCurrency()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public DealsjsonCreatedResponseDealCurrency(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
