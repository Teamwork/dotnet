...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1activityResponseActivityCreatedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// V1activityResponseActivityCreatedBy class.
        /// </summary>
        public V1activityResponseActivityCreatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1activityResponseActivityCreatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
