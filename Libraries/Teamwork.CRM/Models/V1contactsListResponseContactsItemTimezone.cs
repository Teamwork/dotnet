...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1contactsListResponseContactsItemTimezone
    {
        /// <summary>
        /// Initializes a new instance of the
        /// V1contactsListResponseContactsItemTimezone class.
        /// </summary>
        public V1contactsListResponseContactsItemTimezone()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1contactsListResponseContactsItemTimezone(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
