...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class DealsjsonCreatedResponseDealDeletedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// DealsjsonCreatedResponseDealDeletedBy class.
        /// </summary>
        public DealsjsonCreatedResponseDealDeletedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public DealsjsonCreatedResponseDealDeletedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
