...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1companiesResponseCompaniesItemOwner
    {
        /// <summary>
        /// Initializes a new instance of the
        /// V1companiesResponseCompaniesItemOwner class.
        /// </summary>
        public V1companiesResponseCompaniesItemOwner()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1companiesResponseCompaniesItemOwner(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
