...
namespace Teamwork.CRM.Models
{
    ...
    public partial class FilesjsonUnauthorizedResponseErrorsItem
    {
        /// <summary>
        /// Initializes a new instance of the
        /// FilesjsonUnauthorizedResponseErrorsItem class.
        /// </summary>
        public FilesjsonUnauthorizedResponseErrorsItem()
        {
            CustomInit();
        }
        ...
        public FilesjsonUnauthorizedResponseErrorsItem(string code = default(string), string detail = default(string), string id = default(string), string title = default(string))
        {
            Code = code;
            Detail = detail;
            Id = id;
