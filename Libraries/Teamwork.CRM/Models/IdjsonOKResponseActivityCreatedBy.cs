...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class IdjsonOKResponseActivityCreatedBy
    {
        /// <summary>
        /// Initializes a new instance of the IdjsonOKResponseActivityCreatedBy
        /// class.
        /// </summary>
        public IdjsonOKResponseActivityCreatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public IdjsonOKResponseActivityCreatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
