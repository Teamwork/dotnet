...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class ActivitiesjsonCreatedResponseActivityUpdatedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// ActivitiesjsonCreatedResponseActivityUpdatedBy class.
        /// </summary>
        public ActivitiesjsonCreatedResponseActivityUpdatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public ActivitiesjsonCreatedResponseActivityUpdatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
