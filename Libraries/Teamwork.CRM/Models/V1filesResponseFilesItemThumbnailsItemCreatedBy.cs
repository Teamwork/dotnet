...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1filesResponseFilesItemThumbnailsItemCreatedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// V1filesResponseFilesItemThumbnailsItemCreatedBy class.
        /// </summary>
        public V1filesResponseFilesItemThumbnailsItemCreatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1filesResponseFilesItemThumbnailsItemCreatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
