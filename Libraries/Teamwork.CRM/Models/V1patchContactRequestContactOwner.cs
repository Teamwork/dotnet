...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1patchContactRequestContactOwner
    {
        /// <summary>
        /// Initializes a new instance of the V1patchContactRequestContactOwner
        /// class.
        /// </summary>
        public V1patchContactRequestContactOwner()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1patchContactRequestContactOwner(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
