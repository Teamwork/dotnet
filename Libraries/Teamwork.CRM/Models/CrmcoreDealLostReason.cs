...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class CrmcoreDealLostReason
    {
        /// <summary>
        /// Initializes a new instance of the CrmcoreDealLostReason class.
        /// </summary>
        public CrmcoreDealLostReason()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public CrmcoreDealLostReason(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
