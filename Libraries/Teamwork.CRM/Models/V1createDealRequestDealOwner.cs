...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1createDealRequestDealOwner
    {
        /// <summary>
        /// Initializes a new instance of the V1createDealRequestDealOwner
        /// class.
        /// </summary>
        public V1createDealRequestDealOwner()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1createDealRequestDealOwner(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
