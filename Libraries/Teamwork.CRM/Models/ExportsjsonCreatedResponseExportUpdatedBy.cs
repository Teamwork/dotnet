...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class ExportsjsonCreatedResponseExportUpdatedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// ExportsjsonCreatedResponseExportUpdatedBy class.
        /// </summary>
        public ExportsjsonCreatedResponseExportUpdatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public ExportsjsonCreatedResponseExportUpdatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
