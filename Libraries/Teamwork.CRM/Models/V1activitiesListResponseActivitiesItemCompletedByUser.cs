...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1activitiesListResponseActivitiesItemCompletedByUser
    {
        /// <summary>
        /// Initializes a new instance of the
        /// V1activitiesListResponseActivitiesItemCompletedByUser class.
        /// </summary>
        public V1activitiesListResponseActivitiesItemCompletedByUser()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1activitiesListResponseActivitiesItemCompletedByUser(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
