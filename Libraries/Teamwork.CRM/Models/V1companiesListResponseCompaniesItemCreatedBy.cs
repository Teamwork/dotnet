...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1companiesListResponseCompaniesItemCreatedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// V1companiesListResponseCompaniesItemCreatedBy class.
        /// </summary>
        public V1companiesListResponseCompaniesItemCreatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1companiesListResponseCompaniesItemCreatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
