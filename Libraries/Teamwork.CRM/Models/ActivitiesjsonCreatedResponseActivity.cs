...
namespace Teamwork.CRM.Models
{
    ...
    /// </remarks>
    public partial class ActivitiesjsonCreatedResponseActivity
    {
        /// <summary>
        /// Initializes a new instance of the
        /// ActivitiesjsonCreatedResponseActivity class.
        /// </summary>
        public ActivitiesjsonCreatedResponseActivity()
        {
            CustomInit();
        }
        ...
        /// object](https://crmdev-teamwork.docs.stoplight.io/documentation/general/entity-models#relationships)
        /// which describes a relationship to another entity.</param>
        public ActivitiesjsonCreatedResponseActivity(ActivitiesjsonCreatedResponseActivityActivityType activityType = default(ActivitiesjsonCreatedResponseActivityActivityType), IList<ActivitiesjsonCreatedResponseActivityAssigneesItem> assignees = default(IList<ActivitiesjsonCreatedResponseActivityAssigneesItem>), int? assigneesCount = default(int?), System.DateTime? completedAt = default(System.DateTime?), ActivitiesjsonCreatedResponseActivityCompletedByUser completedByUser = default(ActivitiesjsonCreatedResponseActivityCompletedByUser), IList<ActivitiesjsonCreatedResponseActivityContactsItem> contacts = default(IList<ActivitiesjsonCreatedResponseActivityContactsItem>), int? contactsCount = default(int?), System.DateTime? createdAt = default(System.DateTime?), ActivitiesjsonCreatedResponseActivityCreatedBy createdBy = default(ActivitiesjsonCreatedResponseActivityCreatedBy), object custom = default(object), ActivitiesjsonCreatedResponseActivityDeal deal = default(ActivitiesjsonCreatedResponseActivityDeal), System.DateTime? deletedAt = default(System.DateTime?), ActivitiesjsonCreatedResponseActivityDeletedBy deletedBy = default(ActivitiesjsonCreatedResponseActivityDeletedBy), string description = default(string), System.DateTime? dueDate = default(System.DateTime?), int? duration = default(int?), int? id = default(int?), bool? isComplete = default(bool?), System.DateTime? startDate = default(System.DateTime?), string title = default(string), System.DateTime? updatedAt = default(System.DateTime?), ActivitiesjsonCreatedResponseActivityUpdatedBy updatedBy = default(ActivitiesjsonCreatedResponseActivityUpdatedBy), int? updatedSourceId = default(int?))
        {
        ...
        public ActivitiesjsonCreatedResponseActivityActivityType ActivityType { get; set; }
        ...
        public IList<ActivitiesjsonCreatedResponseActivityAssigneesItem> Assignees { get; set; }
        ...
        public ActivitiesjsonCreatedResponseActivityCompletedByUser CompletedByUser { get; set; }
        ...
        public IList<ActivitiesjsonCreatedResponseActivityContactsItem> Contacts { get; set; }
        ...
        public ActivitiesjsonCreatedResponseActivityCreatedBy CreatedBy { get; set; }
        ...
        public ActivitiesjsonCreatedResponseActivityDeal Deal { get; set; }
        ...
        public ActivitiesjsonCreatedResponseActivityDeletedBy DeletedBy { get; set; }
        ...
        public ActivitiesjsonCreatedResponseActivityUpdatedBy UpdatedBy { get; set; }
