...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class IdjsonOKResponseLostReasonUpdatedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// IdjsonOKResponseLostReasonUpdatedBy class.
        /// </summary>
        public IdjsonOKResponseLostReasonUpdatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public IdjsonOKResponseLostReasonUpdatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
