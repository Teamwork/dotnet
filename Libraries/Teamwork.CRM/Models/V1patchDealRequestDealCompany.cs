...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1patchDealRequestDealCompany
    {
        /// <summary>
        /// Initializes a new instance of the V1patchDealRequestDealCompany
        /// class.
        /// </summary>
        public V1patchDealRequestDealCompany()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1patchDealRequestDealCompany(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
