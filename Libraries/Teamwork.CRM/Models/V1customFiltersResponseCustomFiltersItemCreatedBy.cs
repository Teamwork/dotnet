...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1customFiltersResponseCustomFiltersItemCreatedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// V1customFiltersResponseCustomFiltersItemCreatedBy class.
        /// </summary>
        public V1customFiltersResponseCustomFiltersItemCreatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1customFiltersResponseCustomFiltersItemCreatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
