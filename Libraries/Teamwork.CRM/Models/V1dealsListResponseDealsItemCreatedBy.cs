...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1dealsListResponseDealsItemCreatedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// V1dealsListResponseDealsItemCreatedBy class.
        /// </summary>
        public V1dealsListResponseDealsItemCreatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1dealsListResponseDealsItemCreatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
