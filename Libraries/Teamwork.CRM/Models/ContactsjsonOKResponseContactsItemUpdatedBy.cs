...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class ContactsjsonOKResponseContactsItemUpdatedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// ContactsjsonOKResponseContactsItemUpdatedBy class.
        /// </summary>
        public ContactsjsonOKResponseContactsItemUpdatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public ContactsjsonOKResponseContactsItemUpdatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
