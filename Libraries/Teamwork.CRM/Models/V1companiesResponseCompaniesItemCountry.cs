...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1companiesResponseCompaniesItemCountry
    {
        /// <summary>
        /// Initializes a new instance of the
        /// V1companiesResponseCompaniesItemCountry class.
        /// </summary>
        public V1companiesResponseCompaniesItemCountry()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1companiesResponseCompaniesItemCountry(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
