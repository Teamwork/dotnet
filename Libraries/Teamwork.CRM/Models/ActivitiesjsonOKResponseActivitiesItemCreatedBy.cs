...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class ActivitiesjsonOKResponseActivitiesItemCreatedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// ActivitiesjsonOKResponseActivitiesItemCreatedBy class.
        /// </summary>
        public ActivitiesjsonOKResponseActivitiesItemCreatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public ActivitiesjsonOKResponseActivitiesItemCreatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
