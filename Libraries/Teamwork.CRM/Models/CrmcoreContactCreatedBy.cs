...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class CrmcoreContactCreatedBy
    {
        /// <summary>
        /// Initializes a new instance of the CrmcoreContactCreatedBy class.
        /// </summary>
        public CrmcoreContactCreatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public CrmcoreContactCreatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
