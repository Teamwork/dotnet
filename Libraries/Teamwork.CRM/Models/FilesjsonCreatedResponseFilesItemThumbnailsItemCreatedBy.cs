...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class FilesjsonCreatedResponseFilesItemThumbnailsItemCreatedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// FilesjsonCreatedResponseFilesItemThumbnailsItemCreatedBy class.
        /// </summary>
        public FilesjsonCreatedResponseFilesItemThumbnailsItemCreatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public FilesjsonCreatedResponseFilesItemThumbnailsItemCreatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
