...
namespace Teamwork.CRM.Models
{
    ...
    public partial class DealsjsonBadRequestResponseErrorsItem
    {
        /// <summary>
        /// Initializes a new instance of the
        /// DealsjsonBadRequestResponseErrorsItem class.
        /// </summary>
        public DealsjsonBadRequestResponseErrorsItem()
        {
            CustomInit();
        }
        ...
        public DealsjsonBadRequestResponseErrorsItem(string code = default(string), string detail = default(string), string id = default(string), string title = default(string))
        {
            Code = code;
            Detail = detail;
            Id = id;
