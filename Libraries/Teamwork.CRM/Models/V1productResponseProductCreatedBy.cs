...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1productResponseProductCreatedBy
    {
        /// <summary>
        /// Initializes a new instance of the V1productResponseProductCreatedBy
        /// class.
        /// </summary>
        public V1productResponseProductCreatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1productResponseProductCreatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
