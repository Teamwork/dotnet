...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class ContactsjsonOKResponseContactsItemDeletedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// ContactsjsonOKResponseContactsItemDeletedBy class.
        /// </summary>
        public ContactsjsonOKResponseContactsItemDeletedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public ContactsjsonOKResponseContactsItemDeletedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
