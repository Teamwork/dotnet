...
namespace Teamwork.CRM.Models
{
    ...
    public partial class FilesjsonConflictResponseErrorsItem
    {
        /// <summary>
        /// Initializes a new instance of the
        /// FilesjsonConflictResponseErrorsItem class.
        /// </summary>
        public FilesjsonConflictResponseErrorsItem()
        {
            CustomInit();
        }
        ...
        public FilesjsonConflictResponseErrorsItem(string code = default(string), string detail = default(string), string id = default(string), string title = default(string))
        {
            Code = code;
            Detail = detail;
            Id = id;
