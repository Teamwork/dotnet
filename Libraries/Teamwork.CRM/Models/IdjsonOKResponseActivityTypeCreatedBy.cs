...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class IdjsonOKResponseActivityTypeCreatedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// IdjsonOKResponseActivityTypeCreatedBy class.
        /// </summary>
        public IdjsonOKResponseActivityTypeCreatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public IdjsonOKResponseActivityTypeCreatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
