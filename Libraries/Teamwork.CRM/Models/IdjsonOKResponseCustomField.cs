...
namespace Teamwork.CRM.Models
{
    ...
    /// </remarks>
    public partial class IdjsonOKResponseCustomField
    {
        /// <summary>
        /// Initializes a new instance of the IdjsonOKResponseCustomField
        /// class.
        /// </summary>
        public IdjsonOKResponseCustomField()
        {
            CustomInit();
        }
        ...
        /// object](https://crmdev-teamwork.docs.stoplight.io/documentation/general/entity-models#relationships)
        /// which describes a relationship to another entity.</param>
        public IdjsonOKResponseCustomField(System.DateTime? createdAt = default(System.DateTime?), IdjsonOKResponseCustomFieldCreatedBy createdBy = default(IdjsonOKResponseCustomFieldCreatedBy), System.DateTime? deletedAt = default(System.DateTime?), IdjsonOKResponseCustomFieldDeletedBy deletedBy = default(IdjsonOKResponseCustomFieldDeletedBy), string fieldType = default(string), int? id = default(int?), bool? isMandatory = default(bool?), bool? isShownWhenAdding = default(bool?), string key = default(string), string kind = default(string), string name = default(string), IList<string> options = default(IList<string>), System.DateTime? updatedAt = default(System.DateTime?), IdjsonOKResponseCustomFieldUpdatedBy updatedBy = default(IdjsonOKResponseCustomFieldUpdatedBy), int? updatedSourceId = default(int?))
        {
            CreatedAt = createdAt;
            CreatedBy = createdBy;
            DeletedAt = deletedAt;
        ...
        public IdjsonOKResponseCustomFieldCreatedBy CreatedBy { get; set; }
        ...
        public IdjsonOKResponseCustomFieldDeletedBy DeletedBy { get; set; }
        ...
        public IdjsonOKResponseCustomFieldUpdatedBy UpdatedBy { get; set; }
