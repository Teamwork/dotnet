...
namespace Teamwork.CRM.Models
{
    ...
    public partial class DownloadNotFoundResponseErrorsItem
    {
        /// <summary>
        /// Initializes a new instance of the
        /// DownloadNotFoundResponseErrorsItem class.
        /// </summary>
        public DownloadNotFoundResponseErrorsItem()
        {
            CustomInit();
        }
        ...
        public DownloadNotFoundResponseErrorsItem(string code = default(string), string detail = default(string), string id = default(string), string title = default(string))
        {
            Code = code;
            Detail = detail;
            Id = id;
