...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class CompaniesjsonOKResponseCompaniesItemTimezone
    {
        /// <summary>
        /// Initializes a new instance of the
        /// CompaniesjsonOKResponseCompaniesItemTimezone class.
        /// </summary>
        public CompaniesjsonOKResponseCompaniesItemTimezone()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public CompaniesjsonOKResponseCompaniesItemTimezone(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
