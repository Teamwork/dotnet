...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class CrmcoreDealNextIncompleteActivity
    {
        /// <summary>
        /// Initializes a new instance of the CrmcoreDealNextIncompleteActivity
        /// class.
        /// </summary>
        public CrmcoreDealNextIncompleteActivity()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public CrmcoreDealNextIncompleteActivity(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
