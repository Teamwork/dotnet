...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class CompaniesjsonOKResponseCompaniesItemAvatar
    {
        /// <summary>
        /// Initializes a new instance of the
        /// CompaniesjsonOKResponseCompaniesItemAvatar class.
        /// </summary>
        public CompaniesjsonOKResponseCompaniesItemAvatar()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public CompaniesjsonOKResponseCompaniesItemAvatar(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
