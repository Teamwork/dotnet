...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class DealsjsonCreatedResponseDealLostReason
    {
        /// <summary>
        /// Initializes a new instance of the
        /// DealsjsonCreatedResponseDealLostReason class.
        /// </summary>
        public DealsjsonCreatedResponseDealLostReason()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public DealsjsonCreatedResponseDealLostReason(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
