...
namespace Teamwork.CRM.Models
{
    ...
    public partial class LostReasonsjsonBadRequestResponseErrorsItem
    {
        /// <summary>
        /// Initializes a new instance of the
        /// LostReasonsjsonBadRequestResponseErrorsItem class.
        /// </summary>
        public LostReasonsjsonBadRequestResponseErrorsItem()
        {
            CustomInit();
        }
        ...
        public LostReasonsjsonBadRequestResponseErrorsItem(string code = default(string), string detail = default(string), string id = default(string), string title = default(string))
        {
            Code = code;
            Detail = detail;
            Id = id;
