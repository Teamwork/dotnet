...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class IdjsonOKResponseCurrencyCreatedBy
    {
        /// <summary>
        /// Initializes a new instance of the IdjsonOKResponseCurrencyCreatedBy
        /// class.
        /// </summary>
        public IdjsonOKResponseCurrencyCreatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public IdjsonOKResponseCurrencyCreatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
