...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1activityTypesResponseActivityTypesItemDeletedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// V1activityTypesResponseActivityTypesItemDeletedBy class.
        /// </summary>
        public V1activityTypesResponseActivityTypesItemDeletedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1activityTypesResponseActivityTypesItemDeletedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
