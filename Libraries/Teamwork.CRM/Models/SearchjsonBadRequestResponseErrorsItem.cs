...
namespace Teamwork.CRM.Models
{
    ...
    public partial class SearchjsonBadRequestResponseErrorsItem
    {
        /// <summary>
        /// Initializes a new instance of the
        /// SearchjsonBadRequestResponseErrorsItem class.
        /// </summary>
        public SearchjsonBadRequestResponseErrorsItem()
        {
            CustomInit();
        }
        ...
        public SearchjsonBadRequestResponseErrorsItem(string code = default(string), string detail = default(string), string id = default(string), string title = default(string))
        {
            Code = code;
            Detail = detail;
            Id = id;
