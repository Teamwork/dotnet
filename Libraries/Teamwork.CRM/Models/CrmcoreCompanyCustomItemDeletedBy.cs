...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class CrmcoreCompanyCustomItemDeletedBy
    {
        /// <summary>
        /// Initializes a new instance of the CrmcoreCompanyCustomItemDeletedBy
        /// class.
        /// </summary>
        public CrmcoreCompanyCustomItemDeletedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public CrmcoreCompanyCustomItemDeletedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
