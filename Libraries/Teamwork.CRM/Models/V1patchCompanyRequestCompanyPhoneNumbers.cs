...
namespace Teamwork.CRM.Models
{
    ...
    public partial class V1patchCompanyRequestCompanyPhoneNumbers
    {
        /// <summary>
        /// Initializes a new instance of the
        /// V1patchCompanyRequestCompanyPhoneNumbers class.
        /// </summary>
        public V1patchCompanyRequestCompanyPhoneNumbers()
        {
            CustomInit();
        }
        ...
        public V1patchCompanyRequestCompanyPhoneNumbers(V1patchCompanyRequestCompanyPhoneNumbersCode code = default(V1patchCompanyRequestCompanyPhoneNumbersCode), string number = default(string))
        {
            Code = code;
            Number = number;
            CustomInit();
        ...
        public V1patchCompanyRequestCompanyPhoneNumbersCode Code { get; set; }
