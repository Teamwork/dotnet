...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1customFieldResponseCustomFieldDeletedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// V1customFieldResponseCustomFieldDeletedBy class.
        /// </summary>
        public V1customFieldResponseCustomFieldDeletedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1customFieldResponseCustomFieldDeletedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
