...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class CrmcoreCustomFilterCreatedBy
    {
        /// <summary>
        /// Initializes a new instance of the CrmcoreCustomFilterCreatedBy
        /// class.
        /// </summary>
        public CrmcoreCustomFilterCreatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public CrmcoreCustomFilterCreatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
