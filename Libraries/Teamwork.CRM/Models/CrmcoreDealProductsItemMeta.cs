...
namespace Teamwork.CRM.Models
{
    ...
    public partial class CrmcoreDealProductsItemMeta
    {
        /// <summary>
        /// Initializes a new instance of the CrmcoreDealProductsItemMeta
        /// class.
        /// </summary>
        public CrmcoreDealProductsItemMeta()
        {
            CustomInit();
        }
        ...
        public CrmcoreDealProductsItemMeta(int price, int quantity, double? discount = default(double?))
        {
            Discount = discount;
            Price = price;
            Quantity = quantity;
