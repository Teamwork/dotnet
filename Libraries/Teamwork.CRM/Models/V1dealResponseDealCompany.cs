...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1dealResponseDealCompany
    {
        /// <summary>
        /// Initializes a new instance of the V1dealResponseDealCompany class.
        /// </summary>
        public V1dealResponseDealCompany()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1dealResponseDealCompany(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
