...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1dealsListResponseDealsItemDeletedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// V1dealsListResponseDealsItemDeletedBy class.
        /// </summary>
        public V1dealsListResponseDealsItemDeletedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1dealsListResponseDealsItemDeletedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
