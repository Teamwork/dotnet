...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1createdFilesResponseFilesItemTarget
    {
        /// <summary>
        /// Initializes a new instance of the
        /// V1createdFilesResponseFilesItemTarget class.
        /// </summary>
        public V1createdFilesResponseFilesItemTarget()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1createdFilesResponseFilesItemTarget(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
