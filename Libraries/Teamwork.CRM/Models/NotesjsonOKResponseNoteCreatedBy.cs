...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class NotesjsonOKResponseNoteCreatedBy
    {
        /// <summary>
        /// Initializes a new instance of the NotesjsonOKResponseNoteCreatedBy
        /// class.
        /// </summary>
        public NotesjsonOKResponseNoteCreatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public NotesjsonOKResponseNoteCreatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
