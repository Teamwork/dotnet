...
namespace Teamwork.CRM.Models
{
    ...
    /// </remarks>
    public partial class DealsjsonOKResponseDealsItem
    {
        /// <summary>
        /// Initializes a new instance of the DealsjsonOKResponseDealsItem
        /// class.
        /// </summary>
        public DealsjsonOKResponseDealsItem()
        {
            CustomInit();
        }
        ...
        /// object](https://crmdev-teamwork.docs.stoplight.io/documentation/general/entity-models#relationships)
        /// which describes a relationship to another entity.</param>
        public DealsjsonOKResponseDealsItem(System.DateTime? closedAt = default(System.DateTime?), DealsjsonOKResponseDealsItemCompany company = default(DealsjsonOKResponseDealsItemCompany), IList<DealsjsonOKResponseDealsItemContactsItem> contacts = default(IList<DealsjsonOKResponseDealsItemContactsItem>), int? contactsCount = default(int?), System.DateTime? createdAt = default(System.DateTime?), DealsjsonOKResponseDealsItemCreatedBy createdBy = default(DealsjsonOKResponseDealsItemCreatedBy), DealsjsonOKResponseDealsItemCurrency currency = default(DealsjsonOKResponseDealsItemCurrency), object custom = default(object), int? customValue = default(int?), System.DateTime? deletedAt = default(System.DateTime?), DealsjsonOKResponseDealsItemDeletedBy deletedBy = default(DealsjsonOKResponseDealsItemDeletedBy), System.DateTime? expectedCloseDate = default(System.DateTime?), int? id = default(int?), bool? isQualified = default(bool?), DealsjsonOKResponseDealsItemLostReason lostReason = default(DealsjsonOKResponseDealsItemLostReason), DealsjsonOKResponseDealsItemNextIncompleteActivity nextIncompleteActivity = default(DealsjsonOKResponseDealsItemNextIncompleteActivity), DealsjsonOKResponseDealsItemOwner owner = default(DealsjsonOKResponseDealsItemOwner), IList<DealsjsonOKResponseDealsItemProductsItem> products = default(IList<DealsjsonOKResponseDealsItemProductsItem>), System.DateTime? qualifiedAt = default(System.DateTime?), DealsjsonOKResponseDealsItemQualifiedBy qualifiedBy = default(DealsjsonOKResponseDealsItemQualifiedBy), DealsjsonOKResponseDealsItemStage stage = default(DealsjsonOKResponseDealsItemStage), string state = default(string), object teamworkProjects = default(object), string title = default(string), int? totalValue = default(int?), System.DateTime? updatedAt = default(System.DateTime?), DealsjsonOKResponseDealsItemUpdatedBy updatedBy = default(DealsjsonOKResponseDealsItemUpdatedBy), int? updatedSourceId = default(int?))
        {
            ClosedAt = closedAt;
            Company = company;
            Contacts = contacts;
        ...
        public DealsjsonOKResponseDealsItemCompany Company { get; set; }
        ...
        public IList<DealsjsonOKResponseDealsItemContactsItem> Contacts { get; set; }
        ...
        public DealsjsonOKResponseDealsItemCreatedBy CreatedBy { get; set; }
        ...
        public DealsjsonOKResponseDealsItemCurrency Currency { get; set; }
        ...
        public DealsjsonOKResponseDealsItemDeletedBy DeletedBy { get; set; }
        ...
        public DealsjsonOKResponseDealsItemLostReason LostReason { get; set; }
        ...
        public DealsjsonOKResponseDealsItemNextIncompleteActivity NextIncompleteActivity { get; set; }
        ...
        public DealsjsonOKResponseDealsItemOwner Owner { get; set; }
        ...
        public IList<DealsjsonOKResponseDealsItemProductsItem> Products { get; set; }
        ...
        public DealsjsonOKResponseDealsItemQualifiedBy QualifiedBy { get; set; }
        ...
        public DealsjsonOKResponseDealsItemStage Stage { get; set; }
        ...
        public DealsjsonOKResponseDealsItemUpdatedBy UpdatedBy { get; set; }
