...
namespace Teamwork.CRM.Models
{
    ...
    /// </remarks>
    public partial class ActivitiesjsonOKResponseActivitiesItem
    {
        /// <summary>
        /// Initializes a new instance of the
        /// ActivitiesjsonOKResponseActivitiesItem class.
        /// </summary>
        public ActivitiesjsonOKResponseActivitiesItem()
        {
            CustomInit();
        }
        ...
        /// object](https://crmdev-teamwork.docs.stoplight.io/documentation/general/entity-models#relationships)
        /// which describes a relationship to another entity.</param>
        public ActivitiesjsonOKResponseActivitiesItem(ActivitiesjsonOKResponseActivitiesItemActivityType activityType = default(ActivitiesjsonOKResponseActivitiesItemActivityType), IList<ActivitiesjsonOKResponseActivitiesItemAssigneesItem> assignees = default(IList<ActivitiesjsonOKResponseActivitiesItemAssigneesItem>), int? assigneesCount = default(int?), System.DateTime? completedAt = default(System.DateTime?), ActivitiesjsonOKResponseActivitiesItemCompletedByUser completedByUser = default(ActivitiesjsonOKResponseActivitiesItemCompletedByUser), IList<ActivitiesjsonOKResponseActivitiesItemContactsItem> contacts = default(IList<ActivitiesjsonOKResponseActivitiesItemContactsItem>), int? contactsCount = default(int?), System.DateTime? createdAt = default(System.DateTime?), ActivitiesjsonOKResponseActivitiesItemCreatedBy createdBy = default(ActivitiesjsonOKResponseActivitiesItemCreatedBy), object custom = default(object), ActivitiesjsonOKResponseActivitiesItemDeal deal = default(ActivitiesjsonOKResponseActivitiesItemDeal), System.DateTime? deletedAt = default(System.DateTime?), ActivitiesjsonOKResponseActivitiesItemDeletedBy deletedBy = default(ActivitiesjsonOKResponseActivitiesItemDeletedBy), string description = default(string), System.DateTime? dueDate = default(System.DateTime?), int? duration = default(int?), int? id = default(int?), bool? isComplete = default(bool?), System.DateTime? startDate = default(System.DateTime?), string title = default(string), System.DateTime? updatedAt = default(System.DateTime?), ActivitiesjsonOKResponseActivitiesItemUpdatedBy updatedBy = default(ActivitiesjsonOKResponseActivitiesItemUpdatedBy), int? updatedSourceId = default(int?))
        {
        ...
        public ActivitiesjsonOKResponseActivitiesItemActivityType ActivityType { get; set; }
        ...
        public IList<ActivitiesjsonOKResponseActivitiesItemAssigneesItem> Assignees { get; set; }
        ...
        public ActivitiesjsonOKResponseActivitiesItemCompletedByUser CompletedByUser { get; set; }
        ...
        public IList<ActivitiesjsonOKResponseActivitiesItemContactsItem> Contacts { get; set; }
        ...
        public ActivitiesjsonOKResponseActivitiesItemCreatedBy CreatedBy { get; set; }
        ...
        public ActivitiesjsonOKResponseActivitiesItemDeal Deal { get; set; }
        ...
        public ActivitiesjsonOKResponseActivitiesItemDeletedBy DeletedBy { get; set; }
        ...
        public ActivitiesjsonOKResponseActivitiesItemUpdatedBy UpdatedBy { get; set; }
