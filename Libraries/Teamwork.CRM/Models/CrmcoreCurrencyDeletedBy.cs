...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class CrmcoreCurrencyDeletedBy
    {
        /// <summary>
        /// Initializes a new instance of the CrmcoreCurrencyDeletedBy class.
        /// </summary>
        public CrmcoreCurrencyDeletedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public CrmcoreCurrencyDeletedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
