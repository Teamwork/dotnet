...
namespace Teamwork.CRM.Models
{
    ...
    public partial class NotesjsonBadRequestResponseErrorsItem
    {
        /// <summary>
        /// Initializes a new instance of the
        /// NotesjsonBadRequestResponseErrorsItem class.
        /// </summary>
        public NotesjsonBadRequestResponseErrorsItem()
        {
            CustomInit();
        }
        ...
        public NotesjsonBadRequestResponseErrorsItem(string code = default(string), string detail = default(string), string id = default(string), string title = default(string))
        {
            Code = code;
            Detail = detail;
            Id = id;
