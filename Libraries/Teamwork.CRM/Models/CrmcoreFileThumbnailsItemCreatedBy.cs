...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class CrmcoreFileThumbnailsItemCreatedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// CrmcoreFileThumbnailsItemCreatedBy class.
        /// </summary>
        public CrmcoreFileThumbnailsItemCreatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public CrmcoreFileThumbnailsItemCreatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
