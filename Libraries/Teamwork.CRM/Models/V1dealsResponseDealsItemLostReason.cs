...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1dealsResponseDealsItemLostReason
    {
        /// <summary>
        /// Initializes a new instance of the
        /// V1dealsResponseDealsItemLostReason class.
        /// </summary>
        public V1dealsResponseDealsItemLostReason()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1dealsResponseDealsItemLostReason(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
