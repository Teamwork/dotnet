...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class UsersjsonOKResponseUsersItemDeletedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// UsersjsonOKResponseUsersItemDeletedBy class.
        /// </summary>
        public UsersjsonOKResponseUsersItemDeletedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public UsersjsonOKResponseUsersItemDeletedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
