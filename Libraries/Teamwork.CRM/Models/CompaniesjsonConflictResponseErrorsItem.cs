...
namespace Teamwork.CRM.Models
{
    ...
    public partial class CompaniesjsonConflictResponseErrorsItem
    {
        /// <summary>
        /// Initializes a new instance of the
        /// CompaniesjsonConflictResponseErrorsItem class.
        /// </summary>
        public CompaniesjsonConflictResponseErrorsItem()
        {
            CustomInit();
        }
        ...
        public CompaniesjsonConflictResponseErrorsItem(string code = default(string), string detail = default(string), string id = default(string), string title = default(string))
        {
            Code = code;
            Detail = detail;
            Id = id;
