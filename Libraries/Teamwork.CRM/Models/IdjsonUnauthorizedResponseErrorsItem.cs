...
namespace Teamwork.CRM.Models
{
    ...
    public partial class IdjsonUnauthorizedResponseErrorsItem
    {
        /// <summary>
        /// Initializes a new instance of the
        /// IdjsonUnauthorizedResponseErrorsItem class.
        /// </summary>
        public IdjsonUnauthorizedResponseErrorsItem()
        {
            CustomInit();
        }
        ...
        public IdjsonUnauthorizedResponseErrorsItem(string code = default(string), string detail = default(string), string id = default(string), string title = default(string))
        {
            Code = code;
            Detail = detail;
            Id = id;
