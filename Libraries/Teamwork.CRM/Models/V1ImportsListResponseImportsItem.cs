...
namespace Teamwork.CRM.Models
{
    ...
    /// </remarks>
    public partial class V1ImportsListResponseImportsItem
    {
        /// <summary>
        /// Initializes a new instance of the V1ImportsListResponseImportsItem
        /// class.
        /// </summary>
        public V1ImportsListResponseImportsItem()
        {
            CustomInit();
        }
        ...
        public V1ImportsListResponseImportsItem(System.DateTime? createdAt = default(System.DateTime?), V1ImportsListResponseImportsItemCreator creator = default(V1ImportsListResponseImportsItemCreator), string errorReportFileUrl = default(string), string fileType = default(string), int? id = default(int?), string kind = default(string), string message = default(string), int? numberOfRowsProcessed = default(int?), int? numberOfRowsSkipped = default(int?), string state = default(string), System.DateTime? updatedAt = default(System.DateTime?))
        {
            CreatedAt = createdAt;
            Creator = creator;
        ...
        public V1ImportsListResponseImportsItemCreator Creator { get; set; }
