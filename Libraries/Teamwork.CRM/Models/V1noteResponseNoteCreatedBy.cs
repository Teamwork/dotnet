...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1noteResponseNoteCreatedBy
    {
        /// <summary>
        /// Initializes a new instance of the V1noteResponseNoteCreatedBy
        /// class.
        /// </summary>
        public V1noteResponseNoteCreatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1noteResponseNoteCreatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
