...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class IdjsonOKResponseContactTimezone
    {
        /// <summary>
        /// Initializes a new instance of the IdjsonOKResponseContactTimezone
        /// class.
        /// </summary>
        public IdjsonOKResponseContactTimezone()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public IdjsonOKResponseContactTimezone(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
