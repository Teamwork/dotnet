...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1activityResponseActivityDeletedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// V1activityResponseActivityDeletedBy class.
        /// </summary>
        public V1activityResponseActivityDeletedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1activityResponseActivityDeletedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
