...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class ActivitiesjsonOKResponseActivitiesItemActivityType
    {
        /// <summary>
        /// Initializes a new instance of the
        /// ActivitiesjsonOKResponseActivitiesItemActivityType class.
        /// </summary>
        public ActivitiesjsonOKResponseActivitiesItemActivityType()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public ActivitiesjsonOKResponseActivitiesItemActivityType(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
