...
namespace Teamwork.CRM.Models
{
    ...
    public partial class FilesjsonNotFoundResponseErrorsItem
    {
        /// <summary>
        /// Initializes a new instance of the
        /// FilesjsonNotFoundResponseErrorsItem class.
        /// </summary>
        public FilesjsonNotFoundResponseErrorsItem()
        {
            CustomInit();
        }
        ...
        public FilesjsonNotFoundResponseErrorsItem(string code = default(string), string detail = default(string), string id = default(string), string title = default(string))
        {
            Code = code;
            Detail = detail;
            Id = id;
