...
namespace Teamwork.CRM.Models
{
    ...
    public partial class V1docErrorRespErrorsItem
    {
        /// <summary>
        /// Initializes a new instance of the V1docErrorRespErrorsItem class.
        /// </summary>
        public V1docErrorRespErrorsItem()
        {
            CustomInit();
        }
        ...
        public V1docErrorRespErrorsItem(string code = default(string), string detail = default(string), string id = default(string), string title = default(string))
        {
            Code = code;
            Detail = detail;
            Id = id;
