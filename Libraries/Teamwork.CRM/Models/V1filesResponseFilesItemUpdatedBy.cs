...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1filesResponseFilesItemUpdatedBy
    {
        /// <summary>
        /// Initializes a new instance of the V1filesResponseFilesItemUpdatedBy
        /// class.
        /// </summary>
        public V1filesResponseFilesItemUpdatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1filesResponseFilesItemUpdatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
