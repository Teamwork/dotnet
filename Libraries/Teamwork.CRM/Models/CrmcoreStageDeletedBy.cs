...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class CrmcoreStageDeletedBy
    {
        /// <summary>
        /// Initializes a new instance of the CrmcoreStageDeletedBy class.
        /// </summary>
        public CrmcoreStageDeletedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public CrmcoreStageDeletedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
