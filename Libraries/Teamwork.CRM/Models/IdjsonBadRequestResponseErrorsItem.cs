...
namespace Teamwork.CRM.Models
{
    ...
    public partial class IdjsonBadRequestResponseErrorsItem
    {
        /// <summary>
        /// Initializes a new instance of the
        /// IdjsonBadRequestResponseErrorsItem class.
        /// </summary>
        public IdjsonBadRequestResponseErrorsItem()
        {
            CustomInit();
        }
        ...
        public IdjsonBadRequestResponseErrorsItem(string code = default(string), string detail = default(string), string id = default(string), string title = default(string))
        {
            Code = code;
            Detail = detail;
            Id = id;
