...
namespace Teamwork.CRM.Models
{
    ...
    public partial class ActivityTypesjsonUnauthorizedResponseErrorsItem
    {
        /// <summary>
        /// Initializes a new instance of the
        /// ActivityTypesjsonUnauthorizedResponseErrorsItem class.
        /// </summary>
        public ActivityTypesjsonUnauthorizedResponseErrorsItem()
        {
            CustomInit();
        }
        ...
        public ActivityTypesjsonUnauthorizedResponseErrorsItem(string code = default(string), string detail = default(string), string id = default(string), string title = default(string))
        {
            Code = code;
            Detail = detail;
            Id = id;
