...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class ContactsjsonCreatedResponseContactOwner
    {
        /// <summary>
        /// Initializes a new instance of the
        /// ContactsjsonCreatedResponseContactOwner class.
        /// </summary>
        public ContactsjsonCreatedResponseContactOwner()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public ContactsjsonCreatedResponseContactOwner(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
