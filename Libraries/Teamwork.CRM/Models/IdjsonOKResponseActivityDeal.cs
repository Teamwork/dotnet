...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class IdjsonOKResponseActivityDeal
    {
        /// <summary>
        /// Initializes a new instance of the IdjsonOKResponseActivityDeal
        /// class.
        /// </summary>
        public IdjsonOKResponseActivityDeal()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public IdjsonOKResponseActivityDeal(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
