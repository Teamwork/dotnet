...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1createDealRequestDealStage
    {
        /// <summary>
        /// Initializes a new instance of the V1createDealRequestDealStage
        /// class.
        /// </summary>
        public V1createDealRequestDealStage()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1createDealRequestDealStage(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
