...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1productsResponseProductsItemOwner
    {
        /// <summary>
        /// Initializes a new instance of the
        /// V1productsResponseProductsItemOwner class.
        /// </summary>
        public V1productsResponseProductsItemOwner()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1productsResponseProductsItemOwner(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
