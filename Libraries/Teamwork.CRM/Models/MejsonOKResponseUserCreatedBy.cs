...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class MejsonOKResponseUserCreatedBy
    {
        /// <summary>
        /// Initializes a new instance of the MejsonOKResponseUserCreatedBy
        /// class.
        /// </summary>
        public MejsonOKResponseUserCreatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public MejsonOKResponseUserCreatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
