...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class DealsjsonCreatedResponseDealNextIncompleteActivity
    {
        /// <summary>
        /// Initializes a new instance of the
        /// DealsjsonCreatedResponseDealNextIncompleteActivity class.
        /// </summary>
        public DealsjsonCreatedResponseDealNextIncompleteActivity()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public DealsjsonCreatedResponseDealNextIncompleteActivity(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
