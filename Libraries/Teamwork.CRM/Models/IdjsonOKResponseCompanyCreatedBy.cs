...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class IdjsonOKResponseCompanyCreatedBy
    {
        /// <summary>
        /// Initializes a new instance of the IdjsonOKResponseCompanyCreatedBy
        /// class.
        /// </summary>
        public IdjsonOKResponseCompanyCreatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public IdjsonOKResponseCompanyCreatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
