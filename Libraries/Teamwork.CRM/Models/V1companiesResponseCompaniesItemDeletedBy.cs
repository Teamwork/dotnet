...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1companiesResponseCompaniesItemDeletedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// V1companiesResponseCompaniesItemDeletedBy class.
        /// </summary>
        public V1companiesResponseCompaniesItemDeletedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1companiesResponseCompaniesItemDeletedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
