...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1contactsListResponseContactsItemUpdatedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// V1contactsListResponseContactsItemUpdatedBy class.
        /// </summary>
        public V1contactsListResponseContactsItemUpdatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1contactsListResponseContactsItemUpdatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
