...
namespace Teamwork.CRM.Models
{
    ...
    /// noteResponse
    /// </summary>
    public partial class NotesjsonOKResponse
    {
        /// <summary>
        /// Initializes a new instance of the NotesjsonOKResponse class.
        /// </summary>
        public NotesjsonOKResponse()
        {
            CustomInit();
        }
        ...
        public NotesjsonOKResponse(object included = default(object), NotesjsonOKResponseNote note = default(NotesjsonOKResponseNote))
        {
            Included = included;
            Note = note;
            CustomInit();
        ...
        public NotesjsonOKResponseNote Note { get; set; }
