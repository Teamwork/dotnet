...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1stageResponseStagePipeline
    {
        /// <summary>
        /// Initializes a new instance of the V1stageResponseStagePipeline
        /// class.
        /// </summary>
        public V1stageResponseStagePipeline()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1stageResponseStagePipeline(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
