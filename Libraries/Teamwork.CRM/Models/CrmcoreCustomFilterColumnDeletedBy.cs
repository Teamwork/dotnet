...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class CrmcoreCustomFilterColumnDeletedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// CrmcoreCustomFilterColumnDeletedBy class.
        /// </summary>
        public CrmcoreCustomFilterColumnDeletedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public CrmcoreCustomFilterColumnDeletedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
