...
namespace Teamwork.CRM.Models
{
    ...
    public partial class ActivitiesjsonBadRequestResponseErrorsItem
    {
        /// <summary>
        /// Initializes a new instance of the
        /// ActivitiesjsonBadRequestResponseErrorsItem class.
        /// </summary>
        public ActivitiesjsonBadRequestResponseErrorsItem()
        {
            CustomInit();
        }
        ...
        public ActivitiesjsonBadRequestResponseErrorsItem(string code = default(string), string detail = default(string), string id = default(string), string title = default(string))
        {
            Code = code;
            Detail = detail;
            Id = id;
