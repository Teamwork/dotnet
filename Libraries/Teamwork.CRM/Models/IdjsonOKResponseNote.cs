...
namespace Teamwork.CRM.Models
{
    ...
    /// </remarks>
    public partial class IdjsonOKResponseNote
    {
        /// <summary>
        /// Initializes a new instance of the IdjsonOKResponseNote class.
        /// </summary>
        public IdjsonOKResponseNote()
        {
            CustomInit();
        }
        ...
        /// object](https://crmdev-teamwork.docs.stoplight.io/documentation/general/entity-models#relationships)
        /// which describes a relationship to another entity.</param>
        public IdjsonOKResponseNote(string subject, System.DateTime? createdAt = default(System.DateTime?), IdjsonOKResponseNoteCreatedBy createdBy = default(IdjsonOKResponseNoteCreatedBy), System.DateTime? deletedAt = default(System.DateTime?), IdjsonOKResponseNoteDeletedBy deletedBy = default(IdjsonOKResponseNoteDeletedBy), string description = default(string), int? id = default(int?), bool? isPinned = default(bool?), System.DateTime? updatedAt = default(System.DateTime?), IdjsonOKResponseNoteUpdatedBy updatedBy = default(IdjsonOKResponseNoteUpdatedBy), int? updatedSourceId = default(int?))
        {
            CreatedAt = createdAt;
            CreatedBy = createdBy;
            DeletedAt = deletedAt;
        ...
        public IdjsonOKResponseNoteCreatedBy CreatedBy { get; set; }
        ...
        public IdjsonOKResponseNoteDeletedBy DeletedBy { get; set; }
        ...
        public IdjsonOKResponseNoteUpdatedBy UpdatedBy { get; set; }
