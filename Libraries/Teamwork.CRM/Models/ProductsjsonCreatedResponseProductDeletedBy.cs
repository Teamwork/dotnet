...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class ProductsjsonCreatedResponseProductDeletedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// ProductsjsonCreatedResponseProductDeletedBy class.
        /// </summary>
        public ProductsjsonCreatedResponseProductDeletedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public ProductsjsonCreatedResponseProductDeletedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
