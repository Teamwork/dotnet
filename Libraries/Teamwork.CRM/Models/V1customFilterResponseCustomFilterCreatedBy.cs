...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1customFilterResponseCustomFilterCreatedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// V1customFilterResponseCustomFilterCreatedBy class.
        /// </summary>
        public V1customFilterResponseCustomFilterCreatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1customFilterResponseCustomFilterCreatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
