...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class IdjsonOKResponseCustomFilterColumnsItemDeletedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// IdjsonOKResponseCustomFilterColumnsItemDeletedBy class.
        /// </summary>
        public IdjsonOKResponseCustomFilterColumnsItemDeletedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public IdjsonOKResponseCustomFilterColumnsItemDeletedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
