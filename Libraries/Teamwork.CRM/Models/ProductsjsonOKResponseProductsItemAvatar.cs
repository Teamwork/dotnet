...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class ProductsjsonOKResponseProductsItemAvatar
    {
        /// <summary>
        /// Initializes a new instance of the
        /// ProductsjsonOKResponseProductsItemAvatar class.
        /// </summary>
        public ProductsjsonOKResponseProductsItemAvatar()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public ProductsjsonOKResponseProductsItemAvatar(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
