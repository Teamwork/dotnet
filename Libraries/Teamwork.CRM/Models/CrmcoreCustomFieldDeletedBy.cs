...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class CrmcoreCustomFieldDeletedBy
    {
        /// <summary>
        /// Initializes a new instance of the CrmcoreCustomFieldDeletedBy
        /// class.
        /// </summary>
        public CrmcoreCustomFieldDeletedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public CrmcoreCustomFieldDeletedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
