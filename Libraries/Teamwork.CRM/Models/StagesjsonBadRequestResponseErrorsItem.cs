...
namespace Teamwork.CRM.Models
{
    ...
    public partial class StagesjsonBadRequestResponseErrorsItem
    {
        /// <summary>
        /// Initializes a new instance of the
        /// StagesjsonBadRequestResponseErrorsItem class.
        /// </summary>
        public StagesjsonBadRequestResponseErrorsItem()
        {
            CustomInit();
        }
        ...
        public StagesjsonBadRequestResponseErrorsItem(string code = default(string), string detail = default(string), string id = default(string), string title = default(string))
        {
            Code = code;
            Detail = detail;
            Id = id;
