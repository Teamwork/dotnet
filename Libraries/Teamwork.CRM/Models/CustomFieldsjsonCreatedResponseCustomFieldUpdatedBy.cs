...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class CustomFieldsjsonCreatedResponseCustomFieldUpdatedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// CustomFieldsjsonCreatedResponseCustomFieldUpdatedBy class.
        /// </summary>
        public CustomFieldsjsonCreatedResponseCustomFieldUpdatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public CustomFieldsjsonCreatedResponseCustomFieldUpdatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
