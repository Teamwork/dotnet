...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class DealsjsonCreatedResponseDealCreatedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// DealsjsonCreatedResponseDealCreatedBy class.
        /// </summary>
        public DealsjsonCreatedResponseDealCreatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public DealsjsonCreatedResponseDealCreatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
