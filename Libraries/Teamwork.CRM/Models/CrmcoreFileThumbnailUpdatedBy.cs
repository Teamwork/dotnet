...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class CrmcoreFileThumbnailUpdatedBy
    {
        /// <summary>
        /// Initializes a new instance of the CrmcoreFileThumbnailUpdatedBy
        /// class.
        /// </summary>
        public CrmcoreFileThumbnailUpdatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public CrmcoreFileThumbnailUpdatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
