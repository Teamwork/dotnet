...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class CrmcoreActivityTypeDeletedBy
    {
        /// <summary>
        /// Initializes a new instance of the CrmcoreActivityTypeDeletedBy
        /// class.
        /// </summary>
        public CrmcoreActivityTypeDeletedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public CrmcoreActivityTypeDeletedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
