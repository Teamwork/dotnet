...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class IdjsonOKResponseCurrencyUpdatedBy
    {
        /// <summary>
        /// Initializes a new instance of the IdjsonOKResponseCurrencyUpdatedBy
        /// class.
        /// </summary>
        public IdjsonOKResponseCurrencyUpdatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public IdjsonOKResponseCurrencyUpdatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
