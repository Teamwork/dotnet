...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1createCompanyRequestCompanyOwner
    {
        /// <summary>
        /// Initializes a new instance of the
        /// V1createCompanyRequestCompanyOwner class.
        /// </summary>
        public V1createCompanyRequestCompanyOwner()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1createCompanyRequestCompanyOwner(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
