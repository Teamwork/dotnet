...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1contactsResponseContactsItemCreatedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// V1contactsResponseContactsItemCreatedBy class.
        /// </summary>
        public V1contactsResponseContactsItemCreatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1contactsResponseContactsItemCreatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
