...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class DealsjsonCreatedResponseDealCompany
    {
        /// <summary>
        /// Initializes a new instance of the
        /// DealsjsonCreatedResponseDealCompany class.
        /// </summary>
        public DealsjsonCreatedResponseDealCompany()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public DealsjsonCreatedResponseDealCompany(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
