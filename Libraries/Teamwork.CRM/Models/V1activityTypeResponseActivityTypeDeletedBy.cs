...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1activityTypeResponseActivityTypeDeletedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// V1activityTypeResponseActivityTypeDeletedBy class.
        /// </summary>
        public V1activityTypeResponseActivityTypeDeletedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1activityTypeResponseActivityTypeDeletedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
