...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1createContactRequestContactCompany
    {
        /// <summary>
        /// Initializes a new instance of the
        /// V1createContactRequestContactCompany class.
        /// </summary>
        public V1createContactRequestContactCompany()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1createContactRequestContactCompany(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
