...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class ProductsjsonCreatedResponseProductAvatar
    {
        /// <summary>
        /// Initializes a new instance of the
        /// ProductsjsonCreatedResponseProductAvatar class.
        /// </summary>
        public ProductsjsonCreatedResponseProductAvatar()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public ProductsjsonCreatedResponseProductAvatar(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
