...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class FilesjsonCreatedResponseFilesItemThumbnailsItemDeletedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// FilesjsonCreatedResponseFilesItemThumbnailsItemDeletedBy class.
        /// </summary>
        public FilesjsonCreatedResponseFilesItemThumbnailsItemDeletedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public FilesjsonCreatedResponseFilesItemThumbnailsItemDeletedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
