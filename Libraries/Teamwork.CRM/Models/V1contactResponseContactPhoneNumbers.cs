...
namespace Teamwork.CRM.Models
{
    ...
    public partial class V1contactResponseContactPhoneNumbers
    {
        /// <summary>
        /// Initializes a new instance of the
        /// V1contactResponseContactPhoneNumbers class.
        /// </summary>
        public V1contactResponseContactPhoneNumbers()
        {
            CustomInit();
        }
        ...
        public V1contactResponseContactPhoneNumbers(V1contactResponseContactPhoneNumbersCode code = default(V1contactResponseContactPhoneNumbersCode), string number = default(string))
        {
            Code = code;
            Number = number;
            CustomInit();
        ...
        public V1contactResponseContactPhoneNumbersCode Code { get; set; }
