...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1contactResponseContactCountry
    {
        /// <summary>
        /// Initializes a new instance of the V1contactResponseContactCountry
        /// class.
        /// </summary>
        public V1contactResponseContactCountry()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1contactResponseContactCountry(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
