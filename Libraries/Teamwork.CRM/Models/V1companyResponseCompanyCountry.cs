...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1companyResponseCompanyCountry
    {
        /// <summary>
        /// Initializes a new instance of the V1companyResponseCompanyCountry
        /// class.
        /// </summary>
        public V1companyResponseCompanyCountry()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1companyResponseCompanyCountry(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
