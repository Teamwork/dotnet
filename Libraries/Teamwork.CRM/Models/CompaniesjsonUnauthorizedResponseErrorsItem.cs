...
namespace Teamwork.CRM.Models
{
    ...
    public partial class CompaniesjsonUnauthorizedResponseErrorsItem
    {
        /// <summary>
        /// Initializes a new instance of the
        /// CompaniesjsonUnauthorizedResponseErrorsItem class.
        /// </summary>
        public CompaniesjsonUnauthorizedResponseErrorsItem()
        {
            CustomInit();
        }
        ...
        public CompaniesjsonUnauthorizedResponseErrorsItem(string code = default(string), string detail = default(string), string id = default(string), string title = default(string))
        {
            Code = code;
            Detail = detail;
            Id = id;
