...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class ActivityTypesjsonCreatedResponseActivityTypeUpdatedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// ActivityTypesjsonCreatedResponseActivityTypeUpdatedBy class.
        /// </summary>
        public ActivityTypesjsonCreatedResponseActivityTypeUpdatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public ActivityTypesjsonCreatedResponseActivityTypeUpdatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
