...
namespace Teamwork.CRM.Models
{
    ...
    public partial class CompaniesjsonBadRequestResponseErrorsItem
    {
        /// <summary>
        /// Initializes a new instance of the
        /// CompaniesjsonBadRequestResponseErrorsItem class.
        /// </summary>
        public CompaniesjsonBadRequestResponseErrorsItem()
        {
            CustomInit();
        }
        ...
        public CompaniesjsonBadRequestResponseErrorsItem(string code = default(string), string detail = default(string), string id = default(string), string title = default(string))
        {
            Code = code;
            Detail = detail;
            Id = id;
