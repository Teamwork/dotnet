...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class ExportsjsonOKResponseExportsItemCreatedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// ExportsjsonOKResponseExportsItemCreatedBy class.
        /// </summary>
        public ExportsjsonOKResponseExportsItemCreatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public ExportsjsonOKResponseExportsItemCreatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
