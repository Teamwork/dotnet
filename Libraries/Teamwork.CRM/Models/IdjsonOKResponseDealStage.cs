...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class IdjsonOKResponseDealStage
    {
        /// <summary>
        /// Initializes a new instance of the IdjsonOKResponseDealStage class.
        /// </summary>
        public IdjsonOKResponseDealStage()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public IdjsonOKResponseDealStage(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
