...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1userResponseUserDeletedBy
    {
        /// <summary>
        /// Initializes a new instance of the V1userResponseUserDeletedBy
        /// class.
        /// </summary>
        public V1userResponseUserDeletedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1userResponseUserDeletedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
