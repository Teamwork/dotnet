...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class CustomFiltersjsonCreatedResponseCustomFilterCreatedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// CustomFiltersjsonCreatedResponseCustomFilterCreatedBy class.
        /// </summary>
        public CustomFiltersjsonCreatedResponseCustomFilterCreatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public CustomFiltersjsonCreatedResponseCustomFilterCreatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
