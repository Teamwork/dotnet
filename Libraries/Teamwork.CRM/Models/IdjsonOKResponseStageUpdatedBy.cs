...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class IdjsonOKResponseStageUpdatedBy
    {
        /// <summary>
        /// Initializes a new instance of the IdjsonOKResponseStageUpdatedBy
        /// class.
        /// </summary>
        public IdjsonOKResponseStageUpdatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public IdjsonOKResponseStageUpdatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
