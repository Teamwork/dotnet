...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class CrmcoreCompanyDeletedBy
    {
        /// <summary>
        /// Initializes a new instance of the CrmcoreCompanyDeletedBy class.
        /// </summary>
        public CrmcoreCompanyDeletedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public CrmcoreCompanyDeletedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
