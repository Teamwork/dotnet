...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1productsResponseProductsItemCreatedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// V1productsResponseProductsItemCreatedBy class.
        /// </summary>
        public V1productsResponseProductsItemCreatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1productsResponseProductsItemCreatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
