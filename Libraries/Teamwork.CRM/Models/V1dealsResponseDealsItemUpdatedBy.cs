...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1dealsResponseDealsItemUpdatedBy
    {
        /// <summary>
        /// Initializes a new instance of the V1dealsResponseDealsItemUpdatedBy
        /// class.
        /// </summary>
        public V1dealsResponseDealsItemUpdatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1dealsResponseDealsItemUpdatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
