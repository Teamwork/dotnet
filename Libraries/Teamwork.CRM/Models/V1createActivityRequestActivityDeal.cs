...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1createActivityRequestActivityDeal
    {
        /// <summary>
        /// Initializes a new instance of the
        /// V1createActivityRequestActivityDeal class.
        /// </summary>
        public V1createActivityRequestActivityDeal()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1createActivityRequestActivityDeal(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
