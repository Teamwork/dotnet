...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class IdjsonOKResponseActivityCompletedByUser
    {
        /// <summary>
        /// Initializes a new instance of the
        /// IdjsonOKResponseActivityCompletedByUser class.
        /// </summary>
        public IdjsonOKResponseActivityCompletedByUser()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public IdjsonOKResponseActivityCompletedByUser(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
