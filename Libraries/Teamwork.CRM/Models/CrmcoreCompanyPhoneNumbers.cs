...
namespace Teamwork.CRM.Models
{
    ...
    public partial class CrmcoreCompanyPhoneNumbers
    {
        /// <summary>
        /// Initializes a new instance of the CrmcoreCompanyPhoneNumbers class.
        /// </summary>
        public CrmcoreCompanyPhoneNumbers()
        {
            CustomInit();
        }
        ...
        public CrmcoreCompanyPhoneNumbers(CrmcoreCompanyPhoneNumbersCode code = default(CrmcoreCompanyPhoneNumbersCode), string number = default(string))
        {
            Code = code;
            Number = number;
            CustomInit();
        ...
        public CrmcoreCompanyPhoneNumbersCode Code { get; set; }
