...
namespace Teamwork.CRM.Models
{
    ...
    public partial class ExportsjsonBadRequestResponseErrorsItem
    {
        /// <summary>
        /// Initializes a new instance of the
        /// ExportsjsonBadRequestResponseErrorsItem class.
        /// </summary>
        public ExportsjsonBadRequestResponseErrorsItem()
        {
            CustomInit();
        }
        ...
        public ExportsjsonBadRequestResponseErrorsItem(string code = default(string), string detail = default(string), string id = default(string), string title = default(string))
        {
            Code = code;
            Detail = detail;
            Id = id;
