...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class PipelinesjsonOKResponsePipelinesItemCreatedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// PipelinesjsonOKResponsePipelinesItemCreatedBy class.
        /// </summary>
        public PipelinesjsonOKResponsePipelinesItemCreatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public PipelinesjsonOKResponsePipelinesItemCreatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
