...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class LostReasonsjsonCreatedResponseLostReasonUpdatedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// LostReasonsjsonCreatedResponseLostReasonUpdatedBy class.
        /// </summary>
        public LostReasonsjsonCreatedResponseLostReasonUpdatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public LostReasonsjsonCreatedResponseLostReasonUpdatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
