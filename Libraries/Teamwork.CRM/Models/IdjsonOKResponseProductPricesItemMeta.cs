...
namespace Teamwork.CRM.Models
{
    ...
    public partial class IdjsonOKResponseProductPricesItemMeta
    {
        /// <summary>
        /// Initializes a new instance of the
        /// IdjsonOKResponseProductPricesItemMeta class.
        /// </summary>
        public IdjsonOKResponseProductPricesItemMeta()
        {
            CustomInit();
        }
        ...
        /// cents.</param>
        public IdjsonOKResponseProductPricesItemMeta(int price)
        {
            Price = price;
            CustomInit();
        }
