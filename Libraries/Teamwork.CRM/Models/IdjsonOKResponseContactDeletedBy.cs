...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class IdjsonOKResponseContactDeletedBy
    {
        /// <summary>
        /// Initializes a new instance of the IdjsonOKResponseContactDeletedBy
        /// class.
        /// </summary>
        public IdjsonOKResponseContactDeletedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public IdjsonOKResponseContactDeletedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
