...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class DealsjsonCreatedResponseDealUpdatedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// DealsjsonCreatedResponseDealUpdatedBy class.
        /// </summary>
        public DealsjsonCreatedResponseDealUpdatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public DealsjsonCreatedResponseDealUpdatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
