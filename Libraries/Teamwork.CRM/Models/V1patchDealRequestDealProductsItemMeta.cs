...
namespace Teamwork.CRM.Models
{
    ...
    public partial class V1patchDealRequestDealProductsItemMeta
    {
        /// <summary>
        /// Initializes a new instance of the
        /// V1patchDealRequestDealProductsItemMeta class.
        /// </summary>
        public V1patchDealRequestDealProductsItemMeta()
        {
            CustomInit();
        }
        ...
        public V1patchDealRequestDealProductsItemMeta(int price, int quantity, double? discount = default(double?))
        {
            Discount = discount;
            Price = price;
            Quantity = quantity;
