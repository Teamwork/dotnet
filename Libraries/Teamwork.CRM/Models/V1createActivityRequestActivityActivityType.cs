...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1createActivityRequestActivityActivityType
    {
        /// <summary>
        /// Initializes a new instance of the
        /// V1createActivityRequestActivityActivityType class.
        /// </summary>
        public V1createActivityRequestActivityActivityType()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1createActivityRequestActivityActivityType(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
