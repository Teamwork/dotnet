...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class ProductsjsonOKResponseProductsItemCreatedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// ProductsjsonOKResponseProductsItemCreatedBy class.
        /// </summary>
        public ProductsjsonOKResponseProductsItemCreatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public ProductsjsonOKResponseProductsItemCreatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
