...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class CrmcoreCustomFieldUpdatedBy
    {
        /// <summary>
        /// Initializes a new instance of the CrmcoreCustomFieldUpdatedBy
        /// class.
        /// </summary>
        public CrmcoreCustomFieldUpdatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public CrmcoreCustomFieldUpdatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
