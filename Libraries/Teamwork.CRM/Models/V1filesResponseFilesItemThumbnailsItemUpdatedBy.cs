...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1filesResponseFilesItemThumbnailsItemUpdatedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// V1filesResponseFilesItemThumbnailsItemUpdatedBy class.
        /// </summary>
        public V1filesResponseFilesItemThumbnailsItemUpdatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1filesResponseFilesItemThumbnailsItemUpdatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
