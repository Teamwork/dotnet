...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1fileResponseFileDeletedBy
    {
        /// <summary>
        /// Initializes a new instance of the V1fileResponseFileDeletedBy
        /// class.
        /// </summary>
        public V1fileResponseFileDeletedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1fileResponseFileDeletedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
