...
namespace Teamwork.CRM.Models
{
    ...
    public partial class ActivatejsonBadRequestResponseErrorsItem
    {
        /// <summary>
        /// Initializes a new instance of the
        /// ActivatejsonBadRequestResponseErrorsItem class.
        /// </summary>
        public ActivatejsonBadRequestResponseErrorsItem()
        {
            CustomInit();
        }
        ...
        public ActivatejsonBadRequestResponseErrorsItem(string code = default(string), string detail = default(string), string id = default(string), string title = default(string))
        {
            Code = code;
            Detail = detail;
            Id = id;
