...
namespace Teamwork.CRM.Models
{
    ...
    /// system
    /// </remarks>
    public partial class V1fileResponseFileThumbnailsItem
    {
        /// <summary>
        /// Initializes a new instance of the V1fileResponseFileThumbnailsItem
        /// class.
        /// </summary>
        public V1fileResponseFileThumbnailsItem()
        {
            CustomInit();
        }
        ...
        /// object](https://crmdev-teamwork.docs.stoplight.io/documentation/general/entity-models#relationships)
        /// which describes a relationship to another entity.</param>
        public V1fileResponseFileThumbnailsItem(int? constraint = default(int?), System.DateTime? createdAt = default(System.DateTime?), V1fileResponseFileThumbnailsItemCreatedBy createdBy = default(V1fileResponseFileThumbnailsItemCreatedBy), System.DateTime? deletedAt = default(System.DateTime?), V1fileResponseFileThumbnailsItemDeletedBy deletedBy = default(V1fileResponseFileThumbnailsItemDeletedBy), V1fileResponseFileThumbnailsItemFileId fileId = default(V1fileResponseFileThumbnailsItemFileId), int? height = default(int?), int? id = default(int?), string publicPath = default(string), string s3Path = default(string), System.DateTime? updatedAt = default(System.DateTime?), V1fileResponseFileThumbnailsItemUpdatedBy updatedBy = default(V1fileResponseFileThumbnailsItemUpdatedBy), int? updatedSourceId = default(int?), int? width = default(int?))
        {
        ...
        public V1fileResponseFileThumbnailsItemCreatedBy CreatedBy { get; set; }
        ...
        public V1fileResponseFileThumbnailsItemDeletedBy DeletedBy { get; set; }
        ...
        public V1fileResponseFileThumbnailsItemFileId FileId { get; set; }
        ...
        public V1fileResponseFileThumbnailsItemUpdatedBy UpdatedBy { get; set; }
