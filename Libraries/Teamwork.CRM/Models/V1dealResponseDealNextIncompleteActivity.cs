...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1dealResponseDealNextIncompleteActivity
    {
        /// <summary>
        /// Initializes a new instance of the
        /// V1dealResponseDealNextIncompleteActivity class.
        /// </summary>
        public V1dealResponseDealNextIncompleteActivity()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1dealResponseDealNextIncompleteActivity(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
