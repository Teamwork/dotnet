...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1currenciesResponseCurrenciesItemDeletedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// V1currenciesResponseCurrenciesItemDeletedBy class.
        /// </summary>
        public V1currenciesResponseCurrenciesItemDeletedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1currenciesResponseCurrenciesItemDeletedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
