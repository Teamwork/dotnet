...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class CrmcoreDealCurrency
    {
        /// <summary>
        /// Initializes a new instance of the CrmcoreDealCurrency class.
        /// </summary>
        public CrmcoreDealCurrency()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public CrmcoreDealCurrency(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
