...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class SearchjsonOKResponseSearchResultsItemContent
    {
        /// <summary>
        /// Initializes a new instance of the
        /// SearchjsonOKResponseSearchResultsItemContent class.
        /// </summary>
        public SearchjsonOKResponseSearchResultsItemContent()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public SearchjsonOKResponseSearchResultsItemContent(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
