...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1activitiesListResponseActivitiesItemCreatedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// V1activitiesListResponseActivitiesItemCreatedBy class.
        /// </summary>
        public V1activitiesListResponseActivitiesItemCreatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1activitiesListResponseActivitiesItemCreatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
