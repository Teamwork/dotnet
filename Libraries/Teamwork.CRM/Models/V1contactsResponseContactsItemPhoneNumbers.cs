...
namespace Teamwork.CRM.Models
{
    ...
    public partial class V1contactsResponseContactsItemPhoneNumbers
    {
        /// <summary>
        /// Initializes a new instance of the
        /// V1contactsResponseContactsItemPhoneNumbers class.
        /// </summary>
        public V1contactsResponseContactsItemPhoneNumbers()
        {
            CustomInit();
        }
        ...
        public V1contactsResponseContactsItemPhoneNumbers(V1contactsResponseContactsItemPhoneNumbersCode code = default(V1contactsResponseContactsItemPhoneNumbersCode), string number = default(string))
        {
            Code = code;
            Number = number;
            CustomInit();
        ...
        public V1contactsResponseContactsItemPhoneNumbersCode Code { get; set; }
