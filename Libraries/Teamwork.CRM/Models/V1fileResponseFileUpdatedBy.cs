...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1fileResponseFileUpdatedBy
    {
        /// <summary>
        /// Initializes a new instance of the V1fileResponseFileUpdatedBy
        /// class.
        /// </summary>
        public V1fileResponseFileUpdatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1fileResponseFileUpdatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
