...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class CrmcoreNoteCreatedBy
    {
        /// <summary>
        /// Initializes a new instance of the CrmcoreNoteCreatedBy class.
        /// </summary>
        public CrmcoreNoteCreatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public CrmcoreNoteCreatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
