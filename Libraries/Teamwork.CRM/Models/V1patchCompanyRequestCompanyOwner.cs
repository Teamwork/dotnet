...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1patchCompanyRequestCompanyOwner
    {
        /// <summary>
        /// Initializes a new instance of the V1patchCompanyRequestCompanyOwner
        /// class.
        /// </summary>
        public V1patchCompanyRequestCompanyOwner()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1patchCompanyRequestCompanyOwner(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
