...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1patchDealRequestDealCurrency
    {
        /// <summary>
        /// Initializes a new instance of the V1patchDealRequestDealCurrency
        /// class.
        /// </summary>
        public V1patchDealRequestDealCurrency()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1patchDealRequestDealCurrency(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
