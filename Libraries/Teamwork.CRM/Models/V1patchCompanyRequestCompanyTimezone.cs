...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1patchCompanyRequestCompanyTimezone
    {
        /// <summary>
        /// Initializes a new instance of the
        /// V1patchCompanyRequestCompanyTimezone class.
        /// </summary>
        public V1patchCompanyRequestCompanyTimezone()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1patchCompanyRequestCompanyTimezone(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
