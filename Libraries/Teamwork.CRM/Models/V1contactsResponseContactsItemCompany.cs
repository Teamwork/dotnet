...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1contactsResponseContactsItemCompany
    {
        /// <summary>
        /// Initializes a new instance of the
        /// V1contactsResponseContactsItemCompany class.
        /// </summary>
        public V1contactsResponseContactsItemCompany()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1contactsResponseContactsItemCompany(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
