...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1companyResponseCompanyCustomItemDeletedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// V1companyResponseCompanyCustomItemDeletedBy class.
        /// </summary>
        public V1companyResponseCompanyCustomItemDeletedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1companyResponseCompanyCustomItemDeletedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
