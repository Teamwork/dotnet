...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1stageResponseStageCreatedBy
    {
        /// <summary>
        /// Initializes a new instance of the V1stageResponseStageCreatedBy
        /// class.
        /// </summary>
        public V1stageResponseStageCreatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1stageResponseStageCreatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
