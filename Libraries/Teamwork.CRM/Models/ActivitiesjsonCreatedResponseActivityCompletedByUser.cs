...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class ActivitiesjsonCreatedResponseActivityCompletedByUser
    {
        /// <summary>
        /// Initializes a new instance of the
        /// ActivitiesjsonCreatedResponseActivityCompletedByUser class.
        /// </summary>
        public ActivitiesjsonCreatedResponseActivityCompletedByUser()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public ActivitiesjsonCreatedResponseActivityCompletedByUser(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
