...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1usersResponseUsersItemCreatedBy
    {
        /// <summary>
        /// Initializes a new instance of the V1usersResponseUsersItemCreatedBy
        /// class.
        /// </summary>
        public V1usersResponseUsersItemCreatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1usersResponseUsersItemCreatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
