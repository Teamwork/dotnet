...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class LostReasonsjsonOKResponseLostReasonsItemUpdatedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// LostReasonsjsonOKResponseLostReasonsItemUpdatedBy class.
        /// </summary>
        public LostReasonsjsonOKResponseLostReasonsItemUpdatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public LostReasonsjsonOKResponseLostReasonsItemUpdatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
