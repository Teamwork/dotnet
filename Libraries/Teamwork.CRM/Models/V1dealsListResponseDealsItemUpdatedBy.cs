...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1dealsListResponseDealsItemUpdatedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// V1dealsListResponseDealsItemUpdatedBy class.
        /// </summary>
        public V1dealsListResponseDealsItemUpdatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1dealsListResponseDealsItemUpdatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
