...
namespace Teamwork.CRM.Models
{
    ...
    /// </remarks>
    public partial class V1activitiesListResponseActivitiesItem
    {
        /// <summary>
        /// Initializes a new instance of the
        /// V1activitiesListResponseActivitiesItem class.
        /// </summary>
        public V1activitiesListResponseActivitiesItem()
        {
            CustomInit();
        }
        ...
        /// object](https://crmdev-teamwork.docs.stoplight.io/documentation/general/entity-models#relationships)
        /// which describes a relationship to another entity.</param>
        public V1activitiesListResponseActivitiesItem(V1activitiesListResponseActivitiesItemActivityType activityType = default(V1activitiesListResponseActivitiesItemActivityType), IList<V1activitiesListResponseActivitiesItemAssigneesItem> assignees = default(IList<V1activitiesListResponseActivitiesItemAssigneesItem>), int? assigneesCount = default(int?), System.DateTime? completedAt = default(System.DateTime?), V1activitiesListResponseActivitiesItemCompletedByUser completedByUser = default(V1activitiesListResponseActivitiesItemCompletedByUser), IList<V1activitiesListResponseActivitiesItemContactsItem> contacts = default(IList<V1activitiesListResponseActivitiesItemContactsItem>), int? contactsCount = default(int?), System.DateTime? createdAt = default(System.DateTime?), V1activitiesListResponseActivitiesItemCreatedBy createdBy = default(V1activitiesListResponseActivitiesItemCreatedBy), object custom = default(object), V1activitiesListResponseActivitiesItemDeal deal = default(V1activitiesListResponseActivitiesItemDeal), System.DateTime? deletedAt = default(System.DateTime?), V1activitiesListResponseActivitiesItemDeletedBy deletedBy = default(V1activitiesListResponseActivitiesItemDeletedBy), string description = default(string), System.DateTime? dueDate = default(System.DateTime?), int? duration = default(int?), int? id = default(int?), bool? isComplete = default(bool?), System.DateTime? startDate = default(System.DateTime?), string title = default(string), System.DateTime? updatedAt = default(System.DateTime?), V1activitiesListResponseActivitiesItemUpdatedBy updatedBy = default(V1activitiesListResponseActivitiesItemUpdatedBy), int? updatedSourceId = default(int?))
        {
        ...
        public V1activitiesListResponseActivitiesItemActivityType ActivityType { get; set; }
        ...
        public IList<V1activitiesListResponseActivitiesItemAssigneesItem> Assignees { get; set; }
        ...
        public V1activitiesListResponseActivitiesItemCompletedByUser CompletedByUser { get; set; }
        ...
        public IList<V1activitiesListResponseActivitiesItemContactsItem> Contacts { get; set; }
        ...
        public V1activitiesListResponseActivitiesItemCreatedBy CreatedBy { get; set; }
        ...
        public V1activitiesListResponseActivitiesItemDeal Deal { get; set; }
        ...
        public V1activitiesListResponseActivitiesItemDeletedBy DeletedBy { get; set; }
        ...
        public V1activitiesListResponseActivitiesItemUpdatedBy UpdatedBy { get; set; }
