...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class IdjsonOKResponseFileDeletedBy
    {
        /// <summary>
        /// Initializes a new instance of the IdjsonOKResponseFileDeletedBy
        /// class.
        /// </summary>
        public IdjsonOKResponseFileDeletedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public IdjsonOKResponseFileDeletedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
