...
namespace Teamwork.CRM.Models
{
    ...
    public partial class PhoneCodesjsonUnauthorizedResponseErrorsItem
    {
        /// <summary>
        /// Initializes a new instance of the
        /// PhoneCodesjsonUnauthorizedResponseErrorsItem class.
        /// </summary>
        public PhoneCodesjsonUnauthorizedResponseErrorsItem()
        {
            CustomInit();
        }
        ...
        public PhoneCodesjsonUnauthorizedResponseErrorsItem(string code = default(string), string detail = default(string), string id = default(string), string title = default(string))
        {
            Code = code;
            Detail = detail;
            Id = id;
