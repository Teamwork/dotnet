...
namespace Teamwork.CRM.Models
{
    ...
    public partial class ProductsjsonUnauthorizedResponseErrorsItem
    {
        /// <summary>
        /// Initializes a new instance of the
        /// ProductsjsonUnauthorizedResponseErrorsItem class.
        /// </summary>
        public ProductsjsonUnauthorizedResponseErrorsItem()
        {
            CustomInit();
        }
        ...
        public ProductsjsonUnauthorizedResponseErrorsItem(string code = default(string), string detail = default(string), string id = default(string), string title = default(string))
        {
            Code = code;
            Detail = detail;
            Id = id;
