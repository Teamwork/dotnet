...
namespace Teamwork.CRM.Models
{
    ...
    /// </remarks>
    public partial class V1customFieldResponseCustomField
    {
        /// <summary>
        /// Initializes a new instance of the V1customFieldResponseCustomField
        /// class.
        /// </summary>
        public V1customFieldResponseCustomField()
        {
            CustomInit();
        }
        ...
        /// object](https://crmdev-teamwork.docs.stoplight.io/documentation/general/entity-models#relationships)
        /// which describes a relationship to another entity.</param>
        public V1customFieldResponseCustomField(System.DateTime? createdAt = default(System.DateTime?), V1customFieldResponseCustomFieldCreatedBy createdBy = default(V1customFieldResponseCustomFieldCreatedBy), System.DateTime? deletedAt = default(System.DateTime?), V1customFieldResponseCustomFieldDeletedBy deletedBy = default(V1customFieldResponseCustomFieldDeletedBy), string fieldType = default(string), int? id = default(int?), bool? isMandatory = default(bool?), bool? isShownWhenAdding = default(bool?), string key = default(string), string kind = default(string), string name = default(string), IList<string> options = default(IList<string>), System.DateTime? updatedAt = default(System.DateTime?), V1customFieldResponseCustomFieldUpdatedBy updatedBy = default(V1customFieldResponseCustomFieldUpdatedBy), int? updatedSourceId = default(int?))
        {
            CreatedAt = createdAt;
            CreatedBy = createdBy;
            DeletedAt = deletedAt;
        ...
        public V1customFieldResponseCustomFieldCreatedBy CreatedBy { get; set; }
        ...
        public V1customFieldResponseCustomFieldDeletedBy DeletedBy { get; set; }
        ...
        public V1customFieldResponseCustomFieldUpdatedBy UpdatedBy { get; set; }
