...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1customFieldsResponseCustomFieldsItemCreatedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// V1customFieldsResponseCustomFieldsItemCreatedBy class.
        /// </summary>
        public V1customFieldsResponseCustomFieldsItemCreatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1customFieldsResponseCustomFieldsItemCreatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
