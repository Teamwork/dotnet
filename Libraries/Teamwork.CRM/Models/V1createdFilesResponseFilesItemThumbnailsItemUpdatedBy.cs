...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1createdFilesResponseFilesItemThumbnailsItemUpdatedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// V1createdFilesResponseFilesItemThumbnailsItemUpdatedBy class.
        /// </summary>
        public V1createdFilesResponseFilesItemThumbnailsItemUpdatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1createdFilesResponseFilesItemThumbnailsItemUpdatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
