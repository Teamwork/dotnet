...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1productResponseProductUpdatedBy
    {
        /// <summary>
        /// Initializes a new instance of the V1productResponseProductUpdatedBy
        /// class.
        /// </summary>
        public V1productResponseProductUpdatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1productResponseProductUpdatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
