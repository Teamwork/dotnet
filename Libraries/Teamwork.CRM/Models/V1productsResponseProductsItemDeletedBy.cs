...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1productsResponseProductsItemDeletedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// V1productsResponseProductsItemDeletedBy class.
        /// </summary>
        public V1productsResponseProductsItemDeletedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1productsResponseProductsItemDeletedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
