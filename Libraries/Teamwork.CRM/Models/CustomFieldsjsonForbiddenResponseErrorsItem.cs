...
namespace Teamwork.CRM.Models
{
    ...
    public partial class CustomFieldsjsonForbiddenResponseErrorsItem
    {
        /// <summary>
        /// Initializes a new instance of the
        /// CustomFieldsjsonForbiddenResponseErrorsItem class.
        /// </summary>
        public CustomFieldsjsonForbiddenResponseErrorsItem()
        {
            CustomInit();
        }
        ...
        public CustomFieldsjsonForbiddenResponseErrorsItem(string code = default(string), string detail = default(string), string id = default(string), string title = default(string))
        {
            Code = code;
            Detail = detail;
            Id = id;
