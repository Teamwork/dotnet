...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1contactsResponseContactsItemDeletedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// V1contactsResponseContactsItemDeletedBy class.
        /// </summary>
        public V1contactsResponseContactsItemDeletedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1contactsResponseContactsItemDeletedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
