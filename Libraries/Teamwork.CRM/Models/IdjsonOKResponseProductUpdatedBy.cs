...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class IdjsonOKResponseProductUpdatedBy
    {
        /// <summary>
        /// Initializes a new instance of the IdjsonOKResponseProductUpdatedBy
        /// class.
        /// </summary>
        public IdjsonOKResponseProductUpdatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public IdjsonOKResponseProductUpdatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
