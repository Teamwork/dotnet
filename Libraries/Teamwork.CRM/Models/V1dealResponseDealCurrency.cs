...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1dealResponseDealCurrency
    {
        /// <summary>
        /// Initializes a new instance of the V1dealResponseDealCurrency class.
        /// </summary>
        public V1dealResponseDealCurrency()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1dealResponseDealCurrency(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
