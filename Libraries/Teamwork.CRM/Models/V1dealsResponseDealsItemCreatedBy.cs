...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1dealsResponseDealsItemCreatedBy
    {
        /// <summary>
        /// Initializes a new instance of the V1dealsResponseDealsItemCreatedBy
        /// class.
        /// </summary>
        public V1dealsResponseDealsItemCreatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1dealsResponseDealsItemCreatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
