...
namespace Teamwork.CRM.Models
{
    ...
    public partial class IdjsonNotFoundResponseErrorsItem
    {
        /// <summary>
        /// Initializes a new instance of the IdjsonNotFoundResponseErrorsItem
        /// class.
        /// </summary>
        public IdjsonNotFoundResponseErrorsItem()
        {
            CustomInit();
        }
        ...
        public IdjsonNotFoundResponseErrorsItem(string code = default(string), string detail = default(string), string id = default(string), string title = default(string))
        {
            Code = code;
            Detail = detail;
            Id = id;
