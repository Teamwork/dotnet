...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1customFilterResponseCustomFilterDeletedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// V1customFilterResponseCustomFilterDeletedBy class.
        /// </summary>
        public V1customFilterResponseCustomFilterDeletedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1customFilterResponseCustomFilterDeletedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
