...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class CrmcoreFileCreatedBy
    {
        /// <summary>
        /// Initializes a new instance of the CrmcoreFileCreatedBy class.
        /// </summary>
        public CrmcoreFileCreatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public CrmcoreFileCreatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
