...
namespace Teamwork.CRM.Models
{
    ...
    public partial class CustomFiltersjsonBadRequestResponseErrorsItem
    {
        /// <summary>
        /// Initializes a new instance of the
        /// CustomFiltersjsonBadRequestResponseErrorsItem class.
        /// </summary>
        public CustomFiltersjsonBadRequestResponseErrorsItem()
        {
            CustomInit();
        }
        ...
        public CustomFiltersjsonBadRequestResponseErrorsItem(string code = default(string), string detail = default(string), string id = default(string), string title = default(string))
        {
            Code = code;
            Detail = detail;
            Id = id;
