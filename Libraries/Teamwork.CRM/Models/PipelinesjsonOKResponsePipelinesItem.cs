...
namespace Teamwork.CRM.Models
{
    ...
    /// </remarks>
    public partial class PipelinesjsonOKResponsePipelinesItem
    {
        /// <summary>
        /// Initializes a new instance of the
        /// PipelinesjsonOKResponsePipelinesItem class.
        /// </summary>
        public PipelinesjsonOKResponsePipelinesItem()
        {
            CustomInit();
        }
        ...
        /// object](https://crmdev-teamwork.docs.stoplight.io/documentation/general/entity-models#relationships)
        /// which describes a relationship to another entity.</param>
        public PipelinesjsonOKResponsePipelinesItem(System.DateTime? createdAt = default(System.DateTime?), PipelinesjsonOKResponsePipelinesItemCreatedBy createdBy = default(PipelinesjsonOKResponsePipelinesItemCreatedBy), System.DateTime? deletedAt = default(System.DateTime?), PipelinesjsonOKResponsePipelinesItemDeletedBy deletedBy = default(PipelinesjsonOKResponsePipelinesItemDeletedBy), int? id = default(int?), bool? isQualified = default(bool?), string name = default(string), int? orderIndex = default(int?), IList<PipelinesjsonOKResponsePipelinesItemStagesItem> stages = default(IList<PipelinesjsonOKResponsePipelinesItemStagesItem>), int? stagesCount = default(int?), double? totalValue = default(double?), System.DateTime? updatedAt = default(System.DateTime?), PipelinesjsonOKResponsePipelinesItemUpdatedBy updatedBy = default(PipelinesjsonOKResponsePipelinesItemUpdatedBy), int? updatedSourceId = default(int?))
        {
            CreatedAt = createdAt;
            CreatedBy = createdBy;
            DeletedAt = deletedAt;
        ...
        public PipelinesjsonOKResponsePipelinesItemCreatedBy CreatedBy { get; set; }
        ...
        public PipelinesjsonOKResponsePipelinesItemDeletedBy DeletedBy { get; set; }
        ...
        public IList<PipelinesjsonOKResponsePipelinesItemStagesItem> Stages { get; set; }
        ...
        public PipelinesjsonOKResponsePipelinesItemUpdatedBy UpdatedBy { get; set; }
