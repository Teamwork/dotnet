...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1contactResponseContactUpdatedBy
    {
        /// <summary>
        /// Initializes a new instance of the V1contactResponseContactUpdatedBy
        /// class.
        /// </summary>
        public V1contactResponseContactUpdatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1contactResponseContactUpdatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
