...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1filesResponseFilesItemDeletedBy
    {
        /// <summary>
        /// Initializes a new instance of the V1filesResponseFilesItemDeletedBy
        /// class.
        /// </summary>
        public V1filesResponseFilesItemDeletedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1filesResponseFilesItemDeletedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
