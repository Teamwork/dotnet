...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1activitiesListResponseActivitiesItemDeletedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// V1activitiesListResponseActivitiesItemDeletedBy class.
        /// </summary>
        public V1activitiesListResponseActivitiesItemDeletedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1activitiesListResponseActivitiesItemDeletedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
