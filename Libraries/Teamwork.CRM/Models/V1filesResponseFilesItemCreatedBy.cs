...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1filesResponseFilesItemCreatedBy
    {
        /// <summary>
        /// Initializes a new instance of the V1filesResponseFilesItemCreatedBy
        /// class.
        /// </summary>
        public V1filesResponseFilesItemCreatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1filesResponseFilesItemCreatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
