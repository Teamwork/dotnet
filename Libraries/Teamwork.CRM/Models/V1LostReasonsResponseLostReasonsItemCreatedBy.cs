...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1LostReasonsResponseLostReasonsItemCreatedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// V1LostReasonsResponseLostReasonsItemCreatedBy class.
        /// </summary>
        public V1LostReasonsResponseLostReasonsItemCreatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1LostReasonsResponseLostReasonsItemCreatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
