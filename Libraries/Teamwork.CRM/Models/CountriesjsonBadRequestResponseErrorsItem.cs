...
namespace Teamwork.CRM.Models
{
    ...
    public partial class CountriesjsonBadRequestResponseErrorsItem
    {
        /// <summary>
        /// Initializes a new instance of the
        /// CountriesjsonBadRequestResponseErrorsItem class.
        /// </summary>
        public CountriesjsonBadRequestResponseErrorsItem()
        {
            CustomInit();
        }
        ...
        public CountriesjsonBadRequestResponseErrorsItem(string code = default(string), string detail = default(string), string id = default(string), string title = default(string))
        {
            Code = code;
            Detail = detail;
            Id = id;
