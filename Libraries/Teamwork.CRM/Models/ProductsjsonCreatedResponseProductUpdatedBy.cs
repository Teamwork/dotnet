...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class ProductsjsonCreatedResponseProductUpdatedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// ProductsjsonCreatedResponseProductUpdatedBy class.
        /// </summary>
        public ProductsjsonCreatedResponseProductUpdatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public ProductsjsonCreatedResponseProductUpdatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
