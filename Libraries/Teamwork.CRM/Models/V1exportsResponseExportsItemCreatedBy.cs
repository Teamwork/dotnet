...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1exportsResponseExportsItemCreatedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// V1exportsResponseExportsItemCreatedBy class.
        /// </summary>
        public V1exportsResponseExportsItemCreatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1exportsResponseExportsItemCreatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
