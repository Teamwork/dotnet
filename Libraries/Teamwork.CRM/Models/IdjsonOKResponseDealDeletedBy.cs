...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class IdjsonOKResponseDealDeletedBy
    {
        /// <summary>
        /// Initializes a new instance of the IdjsonOKResponseDealDeletedBy
        /// class.
        /// </summary>
        public IdjsonOKResponseDealDeletedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public IdjsonOKResponseDealDeletedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
