...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1companyResponseCompanyTimezone
    {
        /// <summary>
        /// Initializes a new instance of the V1companyResponseCompanyTimezone
        /// class.
        /// </summary>
        public V1companyResponseCompanyTimezone()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1companyResponseCompanyTimezone(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
