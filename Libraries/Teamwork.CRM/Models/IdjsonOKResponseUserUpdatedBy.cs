...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class IdjsonOKResponseUserUpdatedBy
    {
        /// <summary>
        /// Initializes a new instance of the IdjsonOKResponseUserUpdatedBy
        /// class.
        /// </summary>
        public IdjsonOKResponseUserUpdatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public IdjsonOKResponseUserUpdatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
