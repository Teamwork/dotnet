...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class LostReasonsjsonOKResponseLostReasonsItemCreatedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// LostReasonsjsonOKResponseLostReasonsItemCreatedBy class.
        /// </summary>
        public LostReasonsjsonOKResponseLostReasonsItemCreatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public LostReasonsjsonOKResponseLostReasonsItemCreatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
