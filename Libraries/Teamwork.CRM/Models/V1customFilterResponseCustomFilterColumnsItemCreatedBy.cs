...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1customFilterResponseCustomFilterColumnsItemCreatedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// V1customFilterResponseCustomFilterColumnsItemCreatedBy class.
        /// </summary>
        public V1customFilterResponseCustomFilterColumnsItemCreatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1customFilterResponseCustomFilterColumnsItemCreatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
