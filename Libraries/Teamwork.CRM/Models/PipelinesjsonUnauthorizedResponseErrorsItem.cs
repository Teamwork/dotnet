...
namespace Teamwork.CRM.Models
{
    ...
    public partial class PipelinesjsonUnauthorizedResponseErrorsItem
    {
        /// <summary>
        /// Initializes a new instance of the
        /// PipelinesjsonUnauthorizedResponseErrorsItem class.
        /// </summary>
        public PipelinesjsonUnauthorizedResponseErrorsItem()
        {
            CustomInit();
        }
        ...
        public PipelinesjsonUnauthorizedResponseErrorsItem(string code = default(string), string detail = default(string), string id = default(string), string title = default(string))
        {
            Code = code;
            Detail = detail;
            Id = id;
