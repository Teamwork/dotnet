...
namespace Teamwork.CRM.Models
{
    ...
    public partial class StagesjsonUnauthorizedResponseErrorsItem
    {
        /// <summary>
        /// Initializes a new instance of the
        /// StagesjsonUnauthorizedResponseErrorsItem class.
        /// </summary>
        public StagesjsonUnauthorizedResponseErrorsItem()
        {
            CustomInit();
        }
        ...
        public StagesjsonUnauthorizedResponseErrorsItem(string code = default(string), string detail = default(string), string id = default(string), string title = default(string))
        {
            Code = code;
            Detail = detail;
            Id = id;
