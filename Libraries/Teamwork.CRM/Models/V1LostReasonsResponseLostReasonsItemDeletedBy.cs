...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1LostReasonsResponseLostReasonsItemDeletedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// V1LostReasonsResponseLostReasonsItemDeletedBy class.
        /// </summary>
        public V1LostReasonsResponseLostReasonsItemDeletedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1LostReasonsResponseLostReasonsItemDeletedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
