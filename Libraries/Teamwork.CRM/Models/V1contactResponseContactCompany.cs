...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1contactResponseContactCompany
    {
        /// <summary>
        /// Initializes a new instance of the V1contactResponseContactCompany
        /// class.
        /// </summary>
        public V1contactResponseContactCompany()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1contactResponseContactCompany(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
