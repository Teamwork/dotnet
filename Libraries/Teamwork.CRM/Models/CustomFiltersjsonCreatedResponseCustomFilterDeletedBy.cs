...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class CustomFiltersjsonCreatedResponseCustomFilterDeletedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// CustomFiltersjsonCreatedResponseCustomFilterDeletedBy class.
        /// </summary>
        public CustomFiltersjsonCreatedResponseCustomFilterDeletedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public CustomFiltersjsonCreatedResponseCustomFilterDeletedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
