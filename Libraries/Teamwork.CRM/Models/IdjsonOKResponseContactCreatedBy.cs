...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class IdjsonOKResponseContactCreatedBy
    {
        /// <summary>
        /// Initializes a new instance of the IdjsonOKResponseContactCreatedBy
        /// class.
        /// </summary>
        public IdjsonOKResponseContactCreatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public IdjsonOKResponseContactCreatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
