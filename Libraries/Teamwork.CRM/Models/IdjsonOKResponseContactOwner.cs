...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class IdjsonOKResponseContactOwner
    {
        /// <summary>
        /// Initializes a new instance of the IdjsonOKResponseContactOwner
        /// class.
        /// </summary>
        public IdjsonOKResponseContactOwner()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public IdjsonOKResponseContactOwner(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
