...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class DealsjsonOKResponseDealsItemCreatedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// DealsjsonOKResponseDealsItemCreatedBy class.
        /// </summary>
        public DealsjsonOKResponseDealsItemCreatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public DealsjsonOKResponseDealsItemCreatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
