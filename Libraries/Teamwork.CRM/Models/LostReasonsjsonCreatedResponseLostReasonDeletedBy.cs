...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class LostReasonsjsonCreatedResponseLostReasonDeletedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// LostReasonsjsonCreatedResponseLostReasonDeletedBy class.
        /// </summary>
        public LostReasonsjsonCreatedResponseLostReasonDeletedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public LostReasonsjsonCreatedResponseLostReasonDeletedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
