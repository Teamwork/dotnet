...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class MejsonOKResponseUserUpdatedBy
    {
        /// <summary>
        /// Initializes a new instance of the MejsonOKResponseUserUpdatedBy
        /// class.
        /// </summary>
        public MejsonOKResponseUserUpdatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public MejsonOKResponseUserUpdatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
