...
namespace Teamwork.CRM.Models
{
    ...
    public partial class DealsjsonOKResponseDealsItemProductsItemMeta
    {
        /// <summary>
        /// Initializes a new instance of the
        /// DealsjsonOKResponseDealsItemProductsItemMeta class.
        /// </summary>
        public DealsjsonOKResponseDealsItemProductsItemMeta()
        {
            CustomInit();
        }
        ...
        public DealsjsonOKResponseDealsItemProductsItemMeta(int price, int quantity, double? discount = default(double?))
        {
            Discount = discount;
            Price = price;
            Quantity = quantity;
