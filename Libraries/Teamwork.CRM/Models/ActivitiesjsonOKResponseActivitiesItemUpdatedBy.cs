...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class ActivitiesjsonOKResponseActivitiesItemUpdatedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// ActivitiesjsonOKResponseActivitiesItemUpdatedBy class.
        /// </summary>
        public ActivitiesjsonOKResponseActivitiesItemUpdatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public ActivitiesjsonOKResponseActivitiesItemUpdatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
