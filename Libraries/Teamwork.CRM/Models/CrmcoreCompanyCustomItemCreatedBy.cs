...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class CrmcoreCompanyCustomItemCreatedBy
    {
        /// <summary>
        /// Initializes a new instance of the CrmcoreCompanyCustomItemCreatedBy
        /// class.
        /// </summary>
        public CrmcoreCompanyCustomItemCreatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public CrmcoreCompanyCustomItemCreatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
