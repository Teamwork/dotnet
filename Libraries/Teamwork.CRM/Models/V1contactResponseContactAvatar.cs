...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1contactResponseContactAvatar
    {
        /// <summary>
        /// Initializes a new instance of the V1contactResponseContactAvatar
        /// class.
        /// </summary>
        public V1contactResponseContactAvatar()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1contactResponseContactAvatar(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
