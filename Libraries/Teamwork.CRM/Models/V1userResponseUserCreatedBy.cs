...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1userResponseUserCreatedBy
    {
        /// <summary>
        /// Initializes a new instance of the V1userResponseUserCreatedBy
        /// class.
        /// </summary>
        public V1userResponseUserCreatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1userResponseUserCreatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
