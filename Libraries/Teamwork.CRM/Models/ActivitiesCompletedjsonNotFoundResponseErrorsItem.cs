...
namespace Teamwork.CRM.Models
{
    ...
    public partial class ActivitiesCompletedjsonNotFoundResponseErrorsItem
    {
        /// <summary>
        /// Initializes a new instance of the
        /// ActivitiesCompletedjsonNotFoundResponseErrorsItem class.
        /// </summary>
        public ActivitiesCompletedjsonNotFoundResponseErrorsItem()
        {
            CustomInit();
        }
        ...
        public ActivitiesCompletedjsonNotFoundResponseErrorsItem(string code = default(string), string detail = default(string), string id = default(string), string title = default(string))
        {
            Code = code;
            Detail = detail;
            Id = id;
