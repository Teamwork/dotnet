...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1customFilterResponseCustomFilterUpdatedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// V1customFilterResponseCustomFilterUpdatedBy class.
        /// </summary>
        public V1customFilterResponseCustomFilterUpdatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1customFilterResponseCustomFilterUpdatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
