...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class IdjsonOKResponseCustomFilterColumnsItemCreatedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// IdjsonOKResponseCustomFilterColumnsItemCreatedBy class.
        /// </summary>
        public IdjsonOKResponseCustomFilterColumnsItemCreatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public IdjsonOKResponseCustomFilterColumnsItemCreatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
