...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class ActivitiesjsonCreatedResponseActivityDeal
    {
        /// <summary>
        /// Initializes a new instance of the
        /// ActivitiesjsonCreatedResponseActivityDeal class.
        /// </summary>
        public ActivitiesjsonCreatedResponseActivityDeal()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public ActivitiesjsonCreatedResponseActivityDeal(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
