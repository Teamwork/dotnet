...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1userResponseUserUpdatedBy
    {
        /// <summary>
        /// Initializes a new instance of the V1userResponseUserUpdatedBy
        /// class.
        /// </summary>
        public V1userResponseUserUpdatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1userResponseUserUpdatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
