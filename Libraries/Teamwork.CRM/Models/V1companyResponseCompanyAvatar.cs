...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1companyResponseCompanyAvatar
    {
        /// <summary>
        /// Initializes a new instance of the V1companyResponseCompanyAvatar
        /// class.
        /// </summary>
        public V1companyResponseCompanyAvatar()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1companyResponseCompanyAvatar(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
