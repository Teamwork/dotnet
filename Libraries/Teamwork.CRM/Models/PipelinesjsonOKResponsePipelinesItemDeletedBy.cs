...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class PipelinesjsonOKResponsePipelinesItemDeletedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// PipelinesjsonOKResponsePipelinesItemDeletedBy class.
        /// </summary>
        public PipelinesjsonOKResponsePipelinesItemDeletedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public PipelinesjsonOKResponsePipelinesItemDeletedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
