...
namespace Teamwork.CRM.Models
{
    ...
    public partial class StagesjsonConflictResponseErrorsItem
    {
        /// <summary>
        /// Initializes a new instance of the
        /// StagesjsonConflictResponseErrorsItem class.
        /// </summary>
        public StagesjsonConflictResponseErrorsItem()
        {
            CustomInit();
        }
        ...
        public StagesjsonConflictResponseErrorsItem(string code = default(string), string detail = default(string), string id = default(string), string title = default(string))
        {
            Code = code;
            Detail = detail;
            Id = id;
