...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1activityResponseActivityCompletedByUser
    {
        /// <summary>
        /// Initializes a new instance of the
        /// V1activityResponseActivityCompletedByUser class.
        /// </summary>
        public V1activityResponseActivityCompletedByUser()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1activityResponseActivityCompletedByUser(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
