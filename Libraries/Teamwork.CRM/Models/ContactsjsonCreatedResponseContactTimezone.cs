...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class ContactsjsonCreatedResponseContactTimezone
    {
        /// <summary>
        /// Initializes a new instance of the
        /// ContactsjsonCreatedResponseContactTimezone class.
        /// </summary>
        public ContactsjsonCreatedResponseContactTimezone()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public ContactsjsonCreatedResponseContactTimezone(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
