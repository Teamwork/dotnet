...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class CompaniesjsonCreatedResponseCompanyCustomItemCreatedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// CompaniesjsonCreatedResponseCompanyCustomItemCreatedBy class.
        /// </summary>
        public CompaniesjsonCreatedResponseCompanyCustomItemCreatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public CompaniesjsonCreatedResponseCompanyCustomItemCreatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
