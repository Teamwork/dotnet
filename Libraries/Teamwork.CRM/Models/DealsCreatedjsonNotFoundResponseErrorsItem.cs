...
namespace Teamwork.CRM.Models
{
    ...
    public partial class DealsCreatedjsonNotFoundResponseErrorsItem
    {
        /// <summary>
        /// Initializes a new instance of the
        /// DealsCreatedjsonNotFoundResponseErrorsItem class.
        /// </summary>
        public DealsCreatedjsonNotFoundResponseErrorsItem()
        {
            CustomInit();
        }
        ...
        public DealsCreatedjsonNotFoundResponseErrorsItem(string code = default(string), string detail = default(string), string id = default(string), string title = default(string))
        {
            Code = code;
            Detail = detail;
            Id = id;
