...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class IdjsonOKResponseContactCountry
    {
        /// <summary>
        /// Initializes a new instance of the IdjsonOKResponseContactCountry
        /// class.
        /// </summary>
        public IdjsonOKResponseContactCountry()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public IdjsonOKResponseContactCountry(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
