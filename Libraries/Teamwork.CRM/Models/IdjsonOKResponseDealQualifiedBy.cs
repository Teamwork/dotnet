...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class IdjsonOKResponseDealQualifiedBy
    {
        /// <summary>
        /// Initializes a new instance of the IdjsonOKResponseDealQualifiedBy
        /// class.
        /// </summary>
        public IdjsonOKResponseDealQualifiedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public IdjsonOKResponseDealQualifiedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
