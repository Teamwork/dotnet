...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1exportsResponseExportsItemDeletedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// V1exportsResponseExportsItemDeletedBy class.
        /// </summary>
        public V1exportsResponseExportsItemDeletedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1exportsResponseExportsItemDeletedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
