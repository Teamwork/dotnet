...
namespace Teamwork.CRM.Models
{
    ...
    public partial class ProductsjsonConflictResponseErrorsItem
    {
        /// <summary>
        /// Initializes a new instance of the
        /// ProductsjsonConflictResponseErrorsItem class.
        /// </summary>
        public ProductsjsonConflictResponseErrorsItem()
        {
            CustomInit();
        }
        ...
        public ProductsjsonConflictResponseErrorsItem(string code = default(string), string detail = default(string), string id = default(string), string title = default(string))
        {
            Code = code;
            Detail = detail;
            Id = id;
