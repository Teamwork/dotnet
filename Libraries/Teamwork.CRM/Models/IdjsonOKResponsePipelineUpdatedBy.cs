...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class IdjsonOKResponsePipelineUpdatedBy
    {
        /// <summary>
        /// Initializes a new instance of the IdjsonOKResponsePipelineUpdatedBy
        /// class.
        /// </summary>
        public IdjsonOKResponsePipelineUpdatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public IdjsonOKResponsePipelineUpdatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
