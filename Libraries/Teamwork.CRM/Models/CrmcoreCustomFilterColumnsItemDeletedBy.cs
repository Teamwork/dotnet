...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class CrmcoreCustomFilterColumnsItemDeletedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// CrmcoreCustomFilterColumnsItemDeletedBy class.
        /// </summary>
        public CrmcoreCustomFilterColumnsItemDeletedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public CrmcoreCustomFilterColumnsItemDeletedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
