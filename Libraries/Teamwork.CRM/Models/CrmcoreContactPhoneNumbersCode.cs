...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class CrmcoreContactPhoneNumbersCode
    {
        /// <summary>
        /// Initializes a new instance of the CrmcoreContactPhoneNumbersCode
        /// class.
        /// </summary>
        public CrmcoreContactPhoneNumbersCode()
        {
            CustomInit();
        }
        ...
        public CrmcoreContactPhoneNumbersCode(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
