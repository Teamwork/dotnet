...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class CrmcoreStageUpdatedBy
    {
        /// <summary>
        /// Initializes a new instance of the CrmcoreStageUpdatedBy class.
        /// </summary>
        public CrmcoreStageUpdatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public CrmcoreStageUpdatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
