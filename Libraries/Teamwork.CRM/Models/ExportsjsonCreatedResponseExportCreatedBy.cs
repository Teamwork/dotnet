...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class ExportsjsonCreatedResponseExportCreatedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// ExportsjsonCreatedResponseExportCreatedBy class.
        /// </summary>
        public ExportsjsonCreatedResponseExportCreatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public ExportsjsonCreatedResponseExportCreatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
