...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1contactsListResponseContactsItemCreatedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// V1contactsListResponseContactsItemCreatedBy class.
        /// </summary>
        public V1contactsListResponseContactsItemCreatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1contactsListResponseContactsItemCreatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
