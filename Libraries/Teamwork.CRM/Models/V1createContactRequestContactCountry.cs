...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1createContactRequestContactCountry
    {
        /// <summary>
        /// Initializes a new instance of the
        /// V1createContactRequestContactCountry class.
        /// </summary>
        public V1createContactRequestContactCountry()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1createContactRequestContactCountry(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
