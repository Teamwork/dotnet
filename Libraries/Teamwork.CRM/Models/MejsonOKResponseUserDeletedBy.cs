...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class MejsonOKResponseUserDeletedBy
    {
        /// <summary>
        /// Initializes a new instance of the MejsonOKResponseUserDeletedBy
        /// class.
        /// </summary>
        public MejsonOKResponseUserDeletedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public MejsonOKResponseUserDeletedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
