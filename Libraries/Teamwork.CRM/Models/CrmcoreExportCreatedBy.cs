...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class CrmcoreExportCreatedBy
    {
        /// <summary>
        /// Initializes a new instance of the CrmcoreExportCreatedBy class.
        /// </summary>
        public CrmcoreExportCreatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public CrmcoreExportCreatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
