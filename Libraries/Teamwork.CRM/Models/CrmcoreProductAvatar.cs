...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class CrmcoreProductAvatar
    {
        /// <summary>
        /// Initializes a new instance of the CrmcoreProductAvatar class.
        /// </summary>
        public CrmcoreProductAvatar()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public CrmcoreProductAvatar(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
