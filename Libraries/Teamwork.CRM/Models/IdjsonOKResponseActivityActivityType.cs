...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class IdjsonOKResponseActivityActivityType
    {
        /// <summary>
        /// Initializes a new instance of the
        /// IdjsonOKResponseActivityActivityType class.
        /// </summary>
        public IdjsonOKResponseActivityActivityType()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public IdjsonOKResponseActivityActivityType(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
