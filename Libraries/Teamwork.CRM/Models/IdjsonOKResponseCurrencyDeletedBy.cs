...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class IdjsonOKResponseCurrencyDeletedBy
    {
        /// <summary>
        /// Initializes a new instance of the IdjsonOKResponseCurrencyDeletedBy
        /// class.
        /// </summary>
        public IdjsonOKResponseCurrencyDeletedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public IdjsonOKResponseCurrencyDeletedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
