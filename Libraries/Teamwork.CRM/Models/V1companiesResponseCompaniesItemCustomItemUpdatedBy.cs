...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1companiesResponseCompaniesItemCustomItemUpdatedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// V1companiesResponseCompaniesItemCustomItemUpdatedBy class.
        /// </summary>
        public V1companiesResponseCompaniesItemCustomItemUpdatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1companiesResponseCompaniesItemCustomItemUpdatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
