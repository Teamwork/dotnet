...
namespace Teamwork.CRM.Models
{
    ...
    public partial class FilesjsonBadRequestResponseErrorsItem
    {
        /// <summary>
        /// Initializes a new instance of the
        /// FilesjsonBadRequestResponseErrorsItem class.
        /// </summary>
        public FilesjsonBadRequestResponseErrorsItem()
        {
            CustomInit();
        }
        ...
        public FilesjsonBadRequestResponseErrorsItem(string code = default(string), string detail = default(string), string id = default(string), string title = default(string))
        {
            Code = code;
            Detail = detail;
            Id = id;
