...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class DealsjsonOKResponseDealsItemLostReason
    {
        /// <summary>
        /// Initializes a new instance of the
        /// DealsjsonOKResponseDealsItemLostReason class.
        /// </summary>
        public DealsjsonOKResponseDealsItemLostReason()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public DealsjsonOKResponseDealsItemLostReason(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
