...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class ExportsjsonOKResponseExportsItemDeletedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// ExportsjsonOKResponseExportsItemDeletedBy class.
        /// </summary>
        public ExportsjsonOKResponseExportsItemDeletedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public ExportsjsonOKResponseExportsItemDeletedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
