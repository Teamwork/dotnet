...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class IdjsonOKResponseCompanyOwner
    {
        /// <summary>
        /// Initializes a new instance of the IdjsonOKResponseCompanyOwner
        /// class.
        /// </summary>
        public IdjsonOKResponseCompanyOwner()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public IdjsonOKResponseCompanyOwner(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
