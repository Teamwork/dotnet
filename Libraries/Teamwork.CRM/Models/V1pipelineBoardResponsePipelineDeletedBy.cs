...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1pipelineBoardResponsePipelineDeletedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// V1pipelineBoardResponsePipelineDeletedBy class.
        /// </summary>
        public V1pipelineBoardResponsePipelineDeletedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1pipelineBoardResponsePipelineDeletedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
