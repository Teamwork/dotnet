...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class CrmcoreUserUpdatedBy
    {
        /// <summary>
        /// Initializes a new instance of the CrmcoreUserUpdatedBy class.
        /// </summary>
        public CrmcoreUserUpdatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public CrmcoreUserUpdatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
