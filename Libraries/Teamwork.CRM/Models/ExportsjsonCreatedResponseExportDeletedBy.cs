...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class ExportsjsonCreatedResponseExportDeletedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// ExportsjsonCreatedResponseExportDeletedBy class.
        /// </summary>
        public ExportsjsonCreatedResponseExportDeletedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public ExportsjsonCreatedResponseExportDeletedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
