...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class IdjsonOKResponseCustomFilterDeletedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// IdjsonOKResponseCustomFilterDeletedBy class.
        /// </summary>
        public IdjsonOKResponseCustomFilterDeletedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public IdjsonOKResponseCustomFilterDeletedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
