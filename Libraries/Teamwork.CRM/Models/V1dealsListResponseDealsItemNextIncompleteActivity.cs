...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1dealsListResponseDealsItemNextIncompleteActivity
    {
        /// <summary>
        /// Initializes a new instance of the
        /// V1dealsListResponseDealsItemNextIncompleteActivity class.
        /// </summary>
        public V1dealsListResponseDealsItemNextIncompleteActivity()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1dealsListResponseDealsItemNextIncompleteActivity(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
