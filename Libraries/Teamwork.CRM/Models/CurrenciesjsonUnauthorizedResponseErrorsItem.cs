...
namespace Teamwork.CRM.Models
{
    ...
    public partial class CurrenciesjsonUnauthorizedResponseErrorsItem
    {
        /// <summary>
        /// Initializes a new instance of the
        /// CurrenciesjsonUnauthorizedResponseErrorsItem class.
        /// </summary>
        public CurrenciesjsonUnauthorizedResponseErrorsItem()
        {
            CustomInit();
        }
        ...
        public CurrenciesjsonUnauthorizedResponseErrorsItem(string code = default(string), string detail = default(string), string id = default(string), string title = default(string))
        {
            Code = code;
            Detail = detail;
            Id = id;
