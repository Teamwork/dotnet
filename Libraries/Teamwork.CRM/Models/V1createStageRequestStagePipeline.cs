...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1createStageRequestStagePipeline
    {
        /// <summary>
        /// Initializes a new instance of the V1createStageRequestStagePipeline
        /// class.
        /// </summary>
        public V1createStageRequestStagePipeline()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1createStageRequestStagePipeline(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
