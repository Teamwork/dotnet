...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1contactResponseContactOwner
    {
        /// <summary>
        /// Initializes a new instance of the V1contactResponseContactOwner
        /// class.
        /// </summary>
        public V1contactResponseContactOwner()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1contactResponseContactOwner(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
