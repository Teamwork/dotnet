...
namespace Teamwork.CRM.Models
{
    ...
    public partial class MejsonNotFoundResponseErrorsItem
    {
        /// <summary>
        /// Initializes a new instance of the MejsonNotFoundResponseErrorsItem
        /// class.
        /// </summary>
        public MejsonNotFoundResponseErrorsItem()
        {
            CustomInit();
        }
        ...
        public MejsonNotFoundResponseErrorsItem(string code = default(string), string detail = default(string), string id = default(string), string title = default(string))
        {
            Code = code;
            Detail = detail;
            Id = id;
