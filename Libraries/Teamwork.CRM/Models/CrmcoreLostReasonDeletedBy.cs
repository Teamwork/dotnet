...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class CrmcoreLostReasonDeletedBy
    {
        /// <summary>
        /// Initializes a new instance of the CrmcoreLostReasonDeletedBy class.
        /// </summary>
        public CrmcoreLostReasonDeletedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public CrmcoreLostReasonDeletedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
