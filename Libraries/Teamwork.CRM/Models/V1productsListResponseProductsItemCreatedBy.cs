...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1productsListResponseProductsItemCreatedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// V1productsListResponseProductsItemCreatedBy class.
        /// </summary>
        public V1productsListResponseProductsItemCreatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1productsListResponseProductsItemCreatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
