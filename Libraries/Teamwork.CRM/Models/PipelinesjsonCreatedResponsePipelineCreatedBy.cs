...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class PipelinesjsonCreatedResponsePipelineCreatedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// PipelinesjsonCreatedResponsePipelineCreatedBy class.
        /// </summary>
        public PipelinesjsonCreatedResponsePipelineCreatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public PipelinesjsonCreatedResponsePipelineCreatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
