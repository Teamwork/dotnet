...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class DealsjsonCreatedResponseDealQualifiedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// DealsjsonCreatedResponseDealQualifiedBy class.
        /// </summary>
        public DealsjsonCreatedResponseDealQualifiedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public DealsjsonCreatedResponseDealQualifiedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
