...
namespace Teamwork.CRM.Models
{
    ...
    public partial class ContactsjsonConflictResponseErrorsItem
    {
        /// <summary>
        /// Initializes a new instance of the
        /// ContactsjsonConflictResponseErrorsItem class.
        /// </summary>
        public ContactsjsonConflictResponseErrorsItem()
        {
            CustomInit();
        }
        ...
        public ContactsjsonConflictResponseErrorsItem(string code = default(string), string detail = default(string), string id = default(string), string title = default(string))
        {
            Code = code;
            Detail = detail;
            Id = id;
