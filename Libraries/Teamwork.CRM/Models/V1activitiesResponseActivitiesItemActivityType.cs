...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1activitiesResponseActivitiesItemActivityType
    {
        /// <summary>
        /// Initializes a new instance of the
        /// V1activitiesResponseActivitiesItemActivityType class.
        /// </summary>
        public V1activitiesResponseActivitiesItemActivityType()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1activitiesResponseActivitiesItemActivityType(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
