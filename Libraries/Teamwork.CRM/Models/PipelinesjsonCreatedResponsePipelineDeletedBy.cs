...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class PipelinesjsonCreatedResponsePipelineDeletedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// PipelinesjsonCreatedResponsePipelineDeletedBy class.
        /// </summary>
        public PipelinesjsonCreatedResponsePipelineDeletedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public PipelinesjsonCreatedResponsePipelineDeletedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
