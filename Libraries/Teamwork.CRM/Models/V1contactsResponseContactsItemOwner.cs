...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1contactsResponseContactsItemOwner
    {
        /// <summary>
        /// Initializes a new instance of the
        /// V1contactsResponseContactsItemOwner class.
        /// </summary>
        public V1contactsResponseContactsItemOwner()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1contactsResponseContactsItemOwner(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
