...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class CrmcoreStageCreatedBy
    {
        /// <summary>
        /// Initializes a new instance of the CrmcoreStageCreatedBy class.
        /// </summary>
        public CrmcoreStageCreatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public CrmcoreStageCreatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
