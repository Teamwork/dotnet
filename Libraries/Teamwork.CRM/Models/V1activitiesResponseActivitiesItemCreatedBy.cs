...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1activitiesResponseActivitiesItemCreatedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// V1activitiesResponseActivitiesItemCreatedBy class.
        /// </summary>
        public V1activitiesResponseActivitiesItemCreatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1activitiesResponseActivitiesItemCreatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
