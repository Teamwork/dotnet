...
namespace Teamwork.CRM.Models
{
    ...
    public partial class XlsxNotFoundResponseErrorsItem
    {
        /// <summary>
        /// Initializes a new instance of the XlsxNotFoundResponseErrorsItem
        /// class.
        /// </summary>
        public XlsxNotFoundResponseErrorsItem()
        {
            CustomInit();
        }
        ...
        public XlsxNotFoundResponseErrorsItem(string code = default(string), string detail = default(string), string id = default(string), string title = default(string))
        {
            Code = code;
            Detail = detail;
            Id = id;
