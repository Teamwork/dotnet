...
namespace Teamwork.CRM.Models
{
    ...
    public partial class V1dealResponseDealProductsItemMeta
    {
        /// <summary>
        /// Initializes a new instance of the
        /// V1dealResponseDealProductsItemMeta class.
        /// </summary>
        public V1dealResponseDealProductsItemMeta()
        {
            CustomInit();
        }
        ...
        public V1dealResponseDealProductsItemMeta(int price, int quantity, double? discount = default(double?))
        {
            Discount = discount;
            Price = price;
            Quantity = quantity;
