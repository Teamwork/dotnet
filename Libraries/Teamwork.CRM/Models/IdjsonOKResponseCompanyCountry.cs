...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class IdjsonOKResponseCompanyCountry
    {
        /// <summary>
        /// Initializes a new instance of the IdjsonOKResponseCompanyCountry
        /// class.
        /// </summary>
        public IdjsonOKResponseCompanyCountry()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public IdjsonOKResponseCompanyCountry(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
