...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class IdjsonOKResponseDealLostReason
    {
        /// <summary>
        /// Initializes a new instance of the IdjsonOKResponseDealLostReason
        /// class.
        /// </summary>
        public IdjsonOKResponseDealLostReason()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public IdjsonOKResponseDealLostReason(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
