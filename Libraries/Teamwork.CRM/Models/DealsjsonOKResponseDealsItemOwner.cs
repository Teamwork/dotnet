...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class DealsjsonOKResponseDealsItemOwner
    {
        /// <summary>
        /// Initializes a new instance of the DealsjsonOKResponseDealsItemOwner
        /// class.
        /// </summary>
        public DealsjsonOKResponseDealsItemOwner()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public DealsjsonOKResponseDealsItemOwner(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
