...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class CompaniesjsonOKResponseCompaniesItemUpdatedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// CompaniesjsonOKResponseCompaniesItemUpdatedBy class.
        /// </summary>
        public CompaniesjsonOKResponseCompaniesItemUpdatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public CompaniesjsonOKResponseCompaniesItemUpdatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
