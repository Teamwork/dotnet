...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1dealResponseDealDeletedBy
    {
        /// <summary>
        /// Initializes a new instance of the V1dealResponseDealDeletedBy
        /// class.
        /// </summary>
        public V1dealResponseDealDeletedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1dealResponseDealDeletedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
