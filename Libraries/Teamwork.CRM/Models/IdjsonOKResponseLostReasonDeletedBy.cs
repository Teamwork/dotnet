...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class IdjsonOKResponseLostReasonDeletedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// IdjsonOKResponseLostReasonDeletedBy class.
        /// </summary>
        public IdjsonOKResponseLostReasonDeletedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public IdjsonOKResponseLostReasonDeletedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
