...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class StagesjsonCreatedResponseStageCreatedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// StagesjsonCreatedResponseStageCreatedBy class.
        /// </summary>
        public StagesjsonCreatedResponseStageCreatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public StagesjsonCreatedResponseStageCreatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
