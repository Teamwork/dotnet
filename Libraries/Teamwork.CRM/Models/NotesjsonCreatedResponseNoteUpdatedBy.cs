...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class NotesjsonCreatedResponseNoteUpdatedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// NotesjsonCreatedResponseNoteUpdatedBy class.
        /// </summary>
        public NotesjsonCreatedResponseNoteUpdatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public NotesjsonCreatedResponseNoteUpdatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
