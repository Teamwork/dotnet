...
namespace Teamwork.CRM.Models
{
    ...
    public partial class ActivitiesCreatedjsonNotFoundResponseErrorsItem
    {
        /// <summary>
        /// Initializes a new instance of the
        /// ActivitiesCreatedjsonNotFoundResponseErrorsItem class.
        /// </summary>
        public ActivitiesCreatedjsonNotFoundResponseErrorsItem()
        {
            CustomInit();
        }
        ...
        public ActivitiesCreatedjsonNotFoundResponseErrorsItem(string code = default(string), string detail = default(string), string id = default(string), string title = default(string))
        {
            Code = code;
            Detail = detail;
            Id = id;
