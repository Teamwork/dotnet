...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1createdFilesResponseFilesItemThumbnailsItemDeletedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// V1createdFilesResponseFilesItemThumbnailsItemDeletedBy class.
        /// </summary>
        public V1createdFilesResponseFilesItemThumbnailsItemDeletedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1createdFilesResponseFilesItemThumbnailsItemDeletedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
