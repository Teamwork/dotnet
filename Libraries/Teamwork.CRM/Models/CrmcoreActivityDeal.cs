...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class CrmcoreActivityDeal
    {
        /// <summary>
        /// Initializes a new instance of the CrmcoreActivityDeal class.
        /// </summary>
        public CrmcoreActivityDeal()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public CrmcoreActivityDeal(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
