...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1contactsResponseContactsItemAvatar
    {
        /// <summary>
        /// Initializes a new instance of the
        /// V1contactsResponseContactsItemAvatar class.
        /// </summary>
        public V1contactsResponseContactsItemAvatar()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1contactsResponseContactsItemAvatar(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
