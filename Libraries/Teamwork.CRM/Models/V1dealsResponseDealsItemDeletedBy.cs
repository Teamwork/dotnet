...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1dealsResponseDealsItemDeletedBy
    {
        /// <summary>
        /// Initializes a new instance of the V1dealsResponseDealsItemDeletedBy
        /// class.
        /// </summary>
        public V1dealsResponseDealsItemDeletedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1dealsResponseDealsItemDeletedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
