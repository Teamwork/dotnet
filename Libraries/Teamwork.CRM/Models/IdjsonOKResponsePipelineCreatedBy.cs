...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class IdjsonOKResponsePipelineCreatedBy
    {
        /// <summary>
        /// Initializes a new instance of the IdjsonOKResponsePipelineCreatedBy
        /// class.
        /// </summary>
        public IdjsonOKResponsePipelineCreatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public IdjsonOKResponsePipelineCreatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
