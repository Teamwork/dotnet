...
namespace Teamwork.CRM.Models
{
    ...
    public partial class ExportsjsonNotFoundResponseErrorsItem
    {
        /// <summary>
        /// Initializes a new instance of the
        /// ExportsjsonNotFoundResponseErrorsItem class.
        /// </summary>
        public ExportsjsonNotFoundResponseErrorsItem()
        {
            CustomInit();
        }
        ...
        public ExportsjsonNotFoundResponseErrorsItem(string code = default(string), string detail = default(string), string id = default(string), string title = default(string))
        {
            Code = code;
            Detail = detail;
            Id = id;
