...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class CrmcoreCompanyTimezone
    {
        /// <summary>
        /// Initializes a new instance of the CrmcoreCompanyTimezone class.
        /// </summary>
        public CrmcoreCompanyTimezone()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public CrmcoreCompanyTimezone(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
