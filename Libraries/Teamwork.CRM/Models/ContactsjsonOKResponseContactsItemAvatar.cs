...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class ContactsjsonOKResponseContactsItemAvatar
    {
        /// <summary>
        /// Initializes a new instance of the
        /// ContactsjsonOKResponseContactsItemAvatar class.
        /// </summary>
        public ContactsjsonOKResponseContactsItemAvatar()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public ContactsjsonOKResponseContactsItemAvatar(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
