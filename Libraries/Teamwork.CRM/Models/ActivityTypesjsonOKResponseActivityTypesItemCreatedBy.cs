...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class ActivityTypesjsonOKResponseActivityTypesItemCreatedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// ActivityTypesjsonOKResponseActivityTypesItemCreatedBy class.
        /// </summary>
        public ActivityTypesjsonOKResponseActivityTypesItemCreatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public ActivityTypesjsonOKResponseActivityTypesItemCreatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
