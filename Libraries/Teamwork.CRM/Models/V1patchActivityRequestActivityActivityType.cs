...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1patchActivityRequestActivityActivityType
    {
        /// <summary>
        /// Initializes a new instance of the
        /// V1patchActivityRequestActivityActivityType class.
        /// </summary>
        public V1patchActivityRequestActivityActivityType()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1patchActivityRequestActivityActivityType(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
