...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class V1fileResponseFileThumbnailsItemCreatedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// V1fileResponseFileThumbnailsItemCreatedBy class.
        /// </summary>
        public V1fileResponseFileThumbnailsItemCreatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public V1fileResponseFileThumbnailsItemCreatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
