...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class IdjsonOKResponseStagePipeline
    {
        /// <summary>
        /// Initializes a new instance of the IdjsonOKResponseStagePipeline
        /// class.
        /// </summary>
        public IdjsonOKResponseStagePipeline()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public IdjsonOKResponseStagePipeline(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
