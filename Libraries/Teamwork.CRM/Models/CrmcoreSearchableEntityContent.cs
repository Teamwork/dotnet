...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class CrmcoreSearchableEntityContent
    {
        /// <summary>
        /// Initializes a new instance of the CrmcoreSearchableEntityContent
        /// class.
        /// </summary>
        public CrmcoreSearchableEntityContent()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public CrmcoreSearchableEntityContent(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
