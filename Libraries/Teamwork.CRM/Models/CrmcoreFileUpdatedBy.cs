...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class CrmcoreFileUpdatedBy
    {
        /// <summary>
        /// Initializes a new instance of the CrmcoreFileUpdatedBy class.
        /// </summary>
        public CrmcoreFileUpdatedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public CrmcoreFileUpdatedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
