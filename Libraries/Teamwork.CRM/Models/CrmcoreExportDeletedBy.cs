...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class CrmcoreExportDeletedBy
    {
        /// <summary>
        /// Initializes a new instance of the CrmcoreExportDeletedBy class.
        /// </summary>
        public CrmcoreExportDeletedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public CrmcoreExportDeletedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
