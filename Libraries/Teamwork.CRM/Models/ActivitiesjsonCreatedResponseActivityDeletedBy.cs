...
namespace Teamwork.CRM.Models
{
    ...
    /// </summary>
    public partial class ActivitiesjsonCreatedResponseActivityDeletedBy
    {
        /// <summary>
        /// Initializes a new instance of the
        /// ActivitiesjsonCreatedResponseActivityDeletedBy class.
        /// </summary>
        public ActivitiesjsonCreatedResponseActivityDeletedBy()
        {
            CustomInit();
        }
        ...
        /// "users".</param>
        public ActivitiesjsonCreatedResponseActivityDeletedBy(int? id = default(int?), string type = default(string))
        {
            Id = id;
            Type = type;
            CustomInit();
